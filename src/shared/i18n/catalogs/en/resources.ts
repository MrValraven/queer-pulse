...
export const resources: Catalog = {
  ...
  "legal.workplace.dismissal.body":
    "You cannot be legally dismissed because of your sexual orientation or gender identity. Constructive dismissal, meaning making conditions intolerable, is also prohibited. Keep records of everything.",
  ...
  "legal.housing.lead":
    "Discrimination in housing rental is illegal in Portugal. In practice it still happens, so here's how to respond when it does.",
  ...
  "legal.healthcare.sns.body":
    "Since 2018, trans healthcare including hormone therapy and surgical procedures is available through the SNS. Waiting lists exist, and we have a guide to navigating them.",
  ...
  "safety.dataUse.body1":
    "We don't sell it. We don't train models on it. We don't share it with third parties. We don't run advertising. We're a small, member-supported network, and your data is not the product.",
  ...
  "safety.report.body1":
    "We take safety concerns seriously, and a person responds to them, never an automated system. If someone has made you feel unsafe, if a message crossed a line, if something doesn't sit right, tell us.",
  "safety.report.body2":
  ...
  "safety.leaving.body1":
    "You can leave at any time. When you do, your profile is removed from the directory immediately. Any messages you've sent remain with their recipients, and we can't unsend them. Board posts are removed. Your data is deleted within 30 days unless you ask us to keep it for a specific reason.",
  ...
  "queer101.faq.a6":
    "Not at all. Many people find that moving somewhere new, to a city with visible queer life, or away from the environment they grew up in, creates the space to explore things that felt impossible before. There's no correct age. Some of the most vibrant people in this community found themselves in their 40s, 50s, or later.",
  ...
  "queer101.glossary.def.queer":
    "An umbrella term for sexual and gender identities that aren't heterosexual or cisgender. Reclaimed from a slur; some older people may still find it painful, so context matters.",
  "queer101.glossary.term.lgbtq": "LGBTQ+",
  "queer101.glossary.def.lgbtq":
    "Lesbian, Gay, Bisexual, Trans, Queer/Questioning, plus many other identities. The acronym keeps expanding, and the + is intentional shorthand for everyone not explicitly listed.",
  ...
  "queer101.glossary.def.intersex":
    "Born with physical sex characteristics, including chromosomes, hormones and anatomy, that don't fit typical definitions of male or female. About 1.7% of people are intersex. Being intersex is a biological reality, and not an identity.",
  ...
  "queer101.resources.sub":
    "Books, films, and guides chosen by the community, never an algorithm. Updated regularly.",
  ...
  "queer101.resource.genderQueer.desc":
    "A graphic memoir about gender identity and sexuality, and one of the most accessible entry points for people questioning their own identity.",
  ...
  "queer101.talk.body":
    "Exploring your identity can be joyful, confusing, or both at once. Sometimes it helps to talk with someone who's been through something similar, without advice and without pressure.",
  ...
  "pronounsGuide.basics.body2":
    "If you're in the process of changing your legal name and want QueerPulse to reflect your new name before the paperwork is done, you can update your display name at any time, with no documentation required.",
  ...
  "pronounsGuide.whenUpdate.body":
    "Updating your display name is immediate across most of the platform. A few things propagate slightly later, so here's what to expect.",
  ...
  "mentalHealth.experiences.lead":
    "Being a queer expat in Lisbon comes with specific pressures. Naming them is the start of dealing with them.",
  ...
  "mentalHealth.experience.admin.text":
    "Visas, NIF, AIMA, healthcare registration, bank accounts that won't open. The bureaucratic weight of building a life in a new country is a documented source of chronic stress. It's a lot to carry, and naming it as a mental health factor is valid.",
  ...
  "mentalHealth.experience.financial.text":
    "Lisbon's rising cost of living affects queer expats acutely. Housing insecurity, visa costs, and the pressure to perform a certain kind of queer expat life are all real stressors. The community talks about money honestly, and the forum's economics thread is a good start.",

  "mentalHealth.sns.title": "Accessing mental health <em>through the SNS</em>",
  "mentalHealth.sns.lead":
    "Portugal's public health system covers mental health, including therapy and psychiatry, though access is uneven. Here's what to realistically expect.",
  ...
  "mentalHealth.sns.step2.text":
    "Your GP can refer you to a psychologist or psychiatrist through the SNS. Waiting times for the first appointment are typically 3–6 months. For urgent needs, explain severity clearly, which can speed up the referral.",
  ...
  "mentalHealth.sns.step4.text":
    "Private therapy ranges from €50–120 per session. Some therapists offer sliding scale fees, so it's always worth asking. Several therapists in our directory offer community member rates for QueerPulse members.",
  ...
  "wellbeing.outro.sub":
    "If you're not yet a member, request an invite. If you are, everything above is in the member area, with no separate login needed.",
  ...
  "wellbeing.crisis.redeExAequo.desc":
    "Support for LGBTQ+ people under 30. Online chat and phone, safe, confidential and peer-led.",
  "wellbeing.crisis.redeExAequo.hours": "Online · Weekdays 18h–22h",

  "wellbeing.harm.title": "Harm <em>reduction</em>",
  "wellbeing.harm.lead":
    "Non-judgmental information for a community that lives in the real world. This is practical care, and no one here will tell you how to live.",
  ...
  "transHub.healthcare.lead":
    "Trans healthcare in Portugal has improved significantly since 2018. The SNS now covers hormone therapy and gender-affirming surgeries. Navigating it is still complex, so here's how it works.",
  "transHub.healthcare.step1.title": "Start with your GP (Médico de Família)",
  "transHub.healthcare.step1.body":
    "Request a referral to an endocrinologist or the nearest gender clinic. Your GP may not be familiar with the process, so bring our GP referral guide to help. SNS referrals typically take 6–18 months.",
  ...
  "transHub.legal.step1.body":
    "Since 2018, you can change your legal name and gender marker at any civil registry office without medical documentation. You need only a declaration, with no psychiatric evaluation required. The fee is approximately €200.",
  ...
  "transHub.community.body":
    "The Trans & Non-Binary Hub is people as much as resources. Members share clinic reviews, celebrate milestones, and turn up for each other when the system doesn't.",
  ...
  "transHealthcare.sidebar.communityTipBody":
    "ILGA Portugal offers free legal accompaniment for trans people navigating the SNS system. You do not have to do this alone, so call them before your first appointment.",
  ...
  "harmReduction.hero.sub":
    "If you are going to use substances, at a club, at a party, or at home, this guide is for you. It exists to help you stay safe.",
  "harmReduction.hero.sos":
    "<strong>If someone stops breathing:</strong> call 112 immediately. Portugal has a good samaritan law, so you will not be prosecuted for calling for help.",
  ...
  "harmReduction.naloxone.step5":
    "<strong>Stay with them.</strong> Naloxone wears off before many opioids do, so they need monitoring.",
  ...
  "harmReduction.section.beforeNight.item.tellSomeone.body":
    "Share your location with a trusted person who is not going out. Agree on a check-in time. This is standard care for yourself.",
  ...
  "harmReduction.section.after.item.worried.body":
    "CAT (Centro de Atendimento a Toxicodependentes) offers free, confidential support, with no judgment and no obligation. You do not have to be dependent to ask for support. Call 800 20 40 60.",
  ...
  "sober.honest.p2":
    "Queer people also have significantly higher rates of harmful substance use than the general population, and that's connected to minority stress, limited safe social spaces, and a culture that sometimes makes sobriety feel like opting out.",
  "sober.honest.p3":
  ...
  "sober.recovery.peerGroup.desc":
    "A private, moderated space within QueerPulse for people in recovery. Weekly online meeting, text channel, and occasional in-person gatherings. No particular programme, and all approaches welcome.",
  ...
  "sober.recovery.oneToOne.desc":
    "Request a conversation with a community member who has offered to talk to people navigating sobriety. Not counsellors, just someone who's been through something similar.",
  ...
  "microGrants.how.03.body":
    "A rotating panel of 5 members reviews applications. Decisions published in full with reasoning. There are no appeals, but the next round is always open.",
  ...
  "microGrants.criteria.benefit":
    "The project benefits the queer community in Lisbon, beyond you personally",
  ...
  "accessibleLisbon.place.heim.detail":
    "Seated, low music, good coffee. One small step at the door, and staff bring a ramp if you ask.",
  ...
  "disabilityHealthcare.hero.lead":
    "Getting through Portuguese healthcare with a disability or chronic condition, covering accommodations, referrals, accessibility-aware GPs, and the insurance maze, without it becoming an appointment about your identity.",
  ...
  "ingredientsMap.hero.lead":
    "A living map of where to find the tastes of home in Lisbon, crowd-sourced by the group and organised by neighbourhood. Home is partly a flavour, and this is where to find it.",
  ...
  "lgbtqAgingGuide.hero.lead":
    "Navigating Portuguese healthcare as an LGBTQ+ person over 50: GPs, hospitals, care, and mental health, with the specific history you carry taken as a given.",
  ...
  "oralHistoryProject.voices.live.body":
    "The first recordings are still being gathered. Once participants have chosen how their words are shared, their voices will appear here, and nothing before they're ready.",
  ...
  "qtipocOrganisations.hero.lead":
    "Groups across Portugal working where race and queerness meet, with each treated as central. What they do, what they offer, and how to reach them.",
  ...
  "qtipocOrganisations.verify.body":
    "Before engaging with any organisation, have a look at how recent and active their channels are, and ask the group if anyone has dealt with them directly. The community's lived experience is the best vetting there is, so if you have it, share it.",
  ...
  "queerPaediatricians.how2":
    "A name here means a family in the community trusts them. It is not a review of their clinical record. Always use your own judgement, and tell us if your experience differs so the list stays honest.",
  ...
  "intersectionality.class.note.text":
    "We try to make community participation accessible regardless of income. Events have sliding-scale options; the forum is free; this platform is free for members who can't afford a contribution. If cost is a barrier to anything here, contact us directly and it will be handled discreetly.",
  ...
  "intersectionality.community.intro":
    "Queer spaces aren't automatically safe for all queer people. Racism, classism, transphobia, ableism, and other dynamics exist within LGBTQ+ communities. That's a reason to name it, and to keep working on it.",
  ...
  "suggest.success.tracked":
    "Your submissions page tracks where it got to, and a decision lands in your notifications.",
