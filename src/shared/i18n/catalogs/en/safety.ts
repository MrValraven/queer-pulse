...
export const safety: Catalog = {
  ...
  "emergency.hero.category": "Emergency Resources",
  "emergency.hero.title": "Help is here. <em>You are not alone.</em>",
  "emergency.hero.lead":
    "This page exists for moments of crisis. Everything on it is available right now — no login, no waiting. If you're in immediate danger, call 112.",
  "emergency.note":
    "<b>A note on these numbers:</b> Portugal phone lines and organisations do change. These contacts are correct as of 2026 to the best of our knowledge. If something isn't connecting, call 112 (emergency services) or 808 24 24 24 (SNS 24 health line). Both operate 24 hours a day.",
  "emergency.crisisNow.title": "If you need help right now",
  "emergency.crisis.emergencyServices.label": "Emergency services",
  "emergency.crisis.emergencyServices.note":
    "Police, ambulance, fire — 24h, free",
  "emergency.crisis.sns24.label": "SNS 24 (Health line)",
  "emergency.crisis.sns24.note": "Medical advice & referral, 24h",
  "emergency.crisis.sosVozAmiga.label": "SOS Voz Amiga",
  "emergency.crisis.sosVozAmiga.note":
    "Crisis & suicide prevention, 16:00–24:00",
  "emergency.crisis.ilga.label": "ILGA Portugal helpline",
  "emergency.crisis.ilga.note": "LGBTQ+ crisis support",
  "emergency.crisis.apav.label": "APAV (Victim support)",
  "emergency.crisis.apav.note": "Violence, DV, hate crimes — 24h, free",
  "emergency.crisis.linhaCrianca.label": "Linha Amiga da Criança",
  "emergency.crisis.linhaCrianca.note": "For people under 18, 24h, free",

  "emergency.common.viewProfileCta": "View profile →",
  "emergency.common.moreInfoCta": "More info →",
  "emergency.common.joinNetworkCta": "Join the network →",
  "emergency.common.housingResourcesCta": "Housing resources →",

  "emergency.section.mentalHealth.title": "Mental health support",
  "emergency.section.mentalHealth.intro":
    "Whether you're in acute crisis or just struggling — these organisations specifically support LGBTQ+ people in Lisbon.",
  "emergency.section.mentalHealth.item.opusDiversus.detail":
    "Peer support and mental health resources for LGBTQ+ people. Drop-in sessions and one-to-ones available.",
  "emergency.section.mentalHealth.item.clinician.detail":
    "Clinical psychologist specialising in LGBTQ+ care. Runs a monthly peer support group in Lisbon for queer professionals.",
  "emergency.section.mentalHealth.item.sns.detail":
    "You can access mental health support via the NHS (SNS) with a referral from your GP. Call 808 24 24 24 to start.",

  "emergency.section.transSupport.title": "Trans-specific support",
  "emergency.section.transSupport.intro":
    "Support specifically for trans, non-binary, and gender non-conforming people in Portugal and Lisbon.",
  "emergency.section.transSupport.item.ilga.detail":
    "Legal support, healthcare referrals, documentation help, and crisis support for trans people. Call 707 200 220.",
  "emergency.section.transSupport.item.pantherasRosa.detail":
    "Trans rights advocacy and community organising. Can connect you to trans peer support and community in Lisbon.",
  "emergency.section.transSupport.item.mutualAid.detail":
    "Peer-run mutual aid for trans people in Lisbon. Practical help, resource sharing, community connection.",

  "emergency.section.housing.title": "Unsafe at home / housing crisis",
  "emergency.section.housing.intro":
    "If your home environment is dangerous or you have no safe place to go.",
  "emergency.section.housing.item.apav.detail":
    "Support for people experiencing domestic violence, including LGBTQ+ people. 116 006, free, 24h. Can help arrange emergency accommodation.",
  "emergency.section.housing.item.queerHousing.detail":
    "Community-run network that tracks queer-safe housing and can urgently connect people in housing crisis with community members who have space.",
  "emergency.section.housing.item.santaCasa.detail":
    "Lisbon's largest social services organisation. Can refer to emergency housing.",

  "emergency.section.legal.title": "Legal emergency & discrimination",
  "emergency.section.legal.intro":
    "Facing discrimination, hate crime, family law crisis, or immigration emergency.",
  "emergency.section.legal.item.ilga.detail":
    "Free legal consultations for LGBTQ+ people facing discrimination, hate crimes, family law, or immigration issues. Call 707 200 220.",
  "emergency.section.legal.item.lawyer.detail":
    "Lawyer offering pro-bono consultations for LGBTQ+ people facing discrimination and family law challenges. Over 60 cases in three years.",
  "emergency.section.legal.item.ordemAdvogados.detail":
    "Portugal's bar association runs a legal aid (apoio judiciário) scheme for those who can't afford a lawyer.",

  "emergency.online.title": "Online resources — available right now",
  "emergency.online.ilga.sub": "Portuguese · LGBTQ+ rights",
  "emergency.online.trevor.sub": "English · Youth crisis support",
  "emergency.online.transLifeline.sub": "English · Trans peer support",
  "emergency.online.opusDiversus.sub": "Portuguese · LGBTQ+ mental health",
