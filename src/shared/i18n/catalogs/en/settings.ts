...
export const settings: Catalog = {
  ...
  // ── LinkedAccountsPage.tsx / LinkedAccountsSections.tsx — chrome only.
  // `name` (provider/app brand) and `detail` (mock account values standing
  // in for fetched fields — linked email, last-used, sync timestamps) stay
  // English per this catalog's file-header policy. ────────────────────────
  "linkedAccounts.eyebrow": "Security · Linked accounts",
  "linkedAccounts.heading": "Sign-in methods & <em>connected apps.</em>",
  "linkedAccounts.lead":
    "Two separate lists. <strong>Sign-in methods</strong> are alternative ways to sign in to QueerPulse. <strong>Connected apps</strong> are third-party services you've given limited access to. <em>You can revoke either, any time.</em>",
  "linkedAccounts.section.signInMethods": "Sign-in methods",
  "linkedAccounts.ssoNote":
    "<strong>About SSO and privacy.</strong> Linking Google or Apple means those services know you have a QueerPulse account, but not what you do here. <em>They never see your messages, posts, or community memberships.</em> If you're worried about a workplace Google linking to your queer life, use magic-link instead — it's our most private option.",
  "linkedAccounts.section.connectedApps": "Connected apps · third-party access",
  "linkedAccounts.section.connectAnother": "Connect another",
  "linkedAccounts.browseIntegrations.name": "Browse available integrations",
  "linkedAccounts.browseIntegrations.detail":
    "Stripe (Sustainer billing), Mastodon, Spotify (Audio Rooms), iCal export, and 4 more",
  "linkedAccounts.browse": "Browse",
  "linkedAccounts.ssoNoteAccent":
    "<strong>Permissions are scoped narrowly.</strong> No connected app can read your DMs, your draft posts, your billing, or your community memberships. If you ever want a full audit, request a <a>data export</a>.",
  "linkedAccounts.confirmUnlink":
    "Unlink/revoke this connection? You can re-link anytime.",
  "linkedAccounts.toast.revoked": "Connection revoked",
  "linkedAccounts.toast.calendarCopied": "Calendar URL copied",

  // ── linkedAccounts.data.ts — badge states (fixed enum, not fetched) ──────
  "linkedAccounts.badge.linked": "Linked",
  "linkedAccounts.badge.notLinked": "Not linked",
  "linkedAccounts.badge.alwaysOn": "Always on",
  "linkedAccounts.badge.unlinked": "Unlinked",
  "linkedAccounts.badge.revoked": "Revoked",
  "linkedAccounts.badge.subscribed": "Subscribed",
  "linkedAccounts.badge.devices_one": "{count} device",
  "linkedAccounts.badge.devices_other": "{count} devices",

  // ── LinkedAccountsSections.tsx — action buttons ──────────────────────────
  "linkedAccounts.action.unlink": "Unlink",
  "linkedAccounts.action.link": "Link",
  "linkedAccounts.action.default": "Default",
  "linkedAccounts.action.manage": "Manage",
  "linkedAccounts.action.revoke": "Revoke",
  "linkedAccounts.action.copyUrl": "Copy URL",
  ...
  // — newsletters, job alerts, pronoun display. JOB_ALERTS' `title` (the saved
  // search name) is user-entered content, left English; only the "Field:"
  // prefixes and status/frequency chrome are translated. PRONOUN_OPTIONS (the
  // pronoun chip set, e.g. "he/him", "elu/delu · PT") are left untranslated —
  // same stored-value/contested-term reasoning as editProfile's PRONOUN_CHIPS,
  // outside this sweep's scope. ───────────────────────────────────────────
  "subscriptions.page.backLink": "← Settings",
  "subscriptions.page.eyebrow": "Settings · subscriptions, alerts & pronouns",
  "subscriptions.page.title": "What we send · <em>how you appear.</em>",
  "subscriptions.page.lead":
    'Three small, surgical controls. <em>Each opt-in is real</em> — turning off a newsletter means we never send it, not "less of it". Pronouns are the same: visible exactly where you choose, never inferred.',
  "subscriptions.page.lastSaved":
    "Last saved <b>{date}</b> · all changes saved automatically",
  "subscriptions.page.savedToast": "Settings saved",
  ...
  "subscriptions.page.pitchStory": "Pitch a story →",
  "subscriptions.page.pitchBackRoom": "Pitch yourself for The Back Room →",
  "subscriptions.alert.removedToast": "Alert removed",

  "subscriptions.newsletter.sectionHeading":
    "Newsletter streams · {count} available",
  "subscriptions.newsletter.nl1.name": "Community <em>dispatch</em>",
  "subscriptions.newsletter.nl1.freq":
    "Fortnightly · what's happening, who's hosting, what we're reading",
  "subscriptions.newsletter.nl1.meta_one":
    "Subscribed · last edition opened {count} day ago · sent to {email}",
  "subscriptions.newsletter.nl1.meta_other":
    "Subscribed · last edition opened {count} days ago · sent to {email}",
  "subscriptions.newsletter.nl2.name": "Long reads · <em>monthly</em>",
  "subscriptions.newsletter.nl2.freq":
    "Once a month · one major piece from the magazine, delivered in full",
  "subscriptions.newsletter.nl2.meta_one":
    "Subscribed · {percent}% open rate · {count} edition sent",
  "subscriptions.newsletter.nl2.meta_other":
    "Subscribed · {percent}% open rate · {count} editions sent",
  "subscriptions.newsletter.nl3.name": "Trans Hub <em>bulletin</em>",
  "subscriptions.newsletter.nl3.freq":
    "Monthly · provider updates, hormone supply notices, anonymised case notes",
  "subscriptions.newsletter.nl3.meta":
    "Not subscribed · {percent}% open rate among {count} subscribers",

  "subscriptions.jobAlerts.sectionHeading": "Saved searches & job alerts",
  "subscriptions.jobAlerts.empty.title": "No alerts yet",
  "subscriptions.jobAlerts.empty.desc":
    "Save a search and we'll quietly let you know when something matching it comes up — no inbox noise, only what you asked for.",
  "subscriptions.jobAlerts.empty.cta": "Set one up",
  "subscriptions.jobAlerts.edit": "Edit",
  "subscriptions.jobAlerts.delete": "Delete",
  "subscriptions.jobAlerts.statusLabel": "Status",
  "subscriptions.jobAlerts.matchesLabel": "Matches in last week",
  "subscriptions.jobAlerts.lastSentLabel": "Last sent",
  "subscriptions.jobAlerts.lastSentNotSentYet": "Not sent yet",
  "subscriptions.jobAlerts.createCta": "+ Create a new alert",
  "subscriptions.jobAlerts.statusLive": "Live · {frequency}",
  "subscriptions.jobAlerts.matchesNew_one": "{count} new",
  "subscriptions.jobAlerts.matchesNew_other": "{count} new",
  "subscriptions.jobAlerts.criteria.title": "Title: <b>{value}</b>",
  "subscriptions.jobAlerts.criteria.location": "Location: <b>{value}</b>",
  "subscriptions.jobAlerts.criteria.minSalary": "Min salary: <b>{value}</b>",
  "subscriptions.jobAlerts.criteria.hours": "Hours: <b>{value}</b>",
  "subscriptions.jobAlerts.criteria.multiLocation":
    "Location: <b>{first}</b> or <b>{second}</b>",
  ...
  "subscriptions.pronouns.currentlyUsing":
    "Currently using <b>{pronoun}</b> on your profile · shown next to your name in all member-facing surfaces",
  "subscriptions.pronouns.pickOneOrMore": "Pick one or more",
  "subscriptions.pronouns.customPlaceholder":
    "Or write your own · e.g. xe/xem · zie/hir",
  "subscriptions.pronouns.customHint":
    "Use commas to add multiple, separated by season or context if you'd like. <em>e.g. he/him (formal), they/them (close friends)</em>.",
  "subscriptions.pronouns.whereTheyShow": "Where they show",
  "subscriptions.pronouns.vis.p1.label": "On my profile",
  "subscriptions.pronouns.vis.p1.desc": "Always visible · QueerPulse standard",
  "subscriptions.pronouns.vis.p2.label": "Next to my name in posts & comments",
  "subscriptions.pronouns.vis.p2.desc": 'Compact form · "{example}"',
  "subscriptions.pronouns.vis.p3.label":
    "On my RSVP tickets & gathering badges",
  "subscriptions.pronouns.vis.p3.desc":
    "Visible to host & other RSVPed members",
  "subscriptions.pronouns.vis.p4.label": "On the public version of my profile",
  "subscriptions.pronouns.vis.p4.desc":
    "Off by default · for members not signed in",
  "subscriptions.pronouns.vis.p5.label": "In auto-translation",
  "subscriptions.pronouns.vis.p5.desc":
    "We use them when our text-walker translates PT↔EN",

  // ── AlertBuilderModal.tsx ─────────────────────────────────────────────────
  "subscriptions.alertBuilder.ariaLabel.edit": "Edit alert",
  "subscriptions.alertBuilder.ariaLabel.new": "New saved search",
  "subscriptions.alertBuilder.title.edit": "Tune your <em>job alert.</em>",
  "subscriptions.alertBuilder.title.new": "Build a <em>job alert.</em>",
  "subscriptions.alertBuilder.desc":
    "We'll match new listings against your criteria and send them on your chosen cadence.",
  "subscriptions.alertBuilder.field.alertName.label": "Alert name",
  "subscriptions.alertBuilder.field.alertName.placeholder":
    "e.g. Designer roles · Lisbon",
  "subscriptions.alertBuilder.field.titleKeywords.label": "Title keywords",
  "subscriptions.alertBuilder.field.titleKeywords.placeholder":
    "e.g. Designer · senior · mid",
  "subscriptions.alertBuilder.field.titleKeywords.hint":
    "Comma-separated. Matches any of these.",
  "subscriptions.alertBuilder.field.location.label": "Location",
  "subscriptions.alertBuilder.field.minSalary.label": "Min salary",
  "subscriptions.alertBuilder.field.minSalary.placeholder": "e.g. €32k",
  "subscriptions.alertBuilder.field.frequency.label": "How often",
  "subscriptions.alertBuilder.frequency.instant": "Instant alerts",
  "subscriptions.alertBuilder.frequency.daily": "Daily digest",
  "subscriptions.alertBuilder.frequency.weekly": "Weekly digest",
  "subscriptions.alertBuilder.location.lisbon": "Lisbon",
  "subscriptions.alertBuilder.location.remotePt": "Remote (PT)",
  "subscriptions.alertBuilder.location.anywhere": "Anywhere",
  "subscriptions.alertBuilder.location.porto": "Porto",
  "subscriptions.alertBuilder.location.berlin": "Berlin",
  "subscriptions.alertBuilder.action.createAlert": "Create alert",
  "subscriptions.alertBuilder.action.saveChanges": "Save changes",
  "subscriptions.alertBuilder.action.cancel": "Cancel",
  "subscriptions.alertBuilder.success.updatedTitle": "Alert <em>updated.</em>",
  "subscriptions.alertBuilder.success.createdTitle": "Alert <em>created.</em>",
  "subscriptions.alertBuilder.success.sub":
    '"{title}" is live on a {frequency}. We\'ll let you know the moment a matching role appears.',
  "subscriptions.alertBuilder.success.done": "Done",
  ...
  // ── integrations.data.ts — provider/app brand names stay untranslated
  // (proper nouns); only their descriptions & scope lines are chrome. ──────
  "integrations.apple.desc":
    "Use Sign in with Apple as an alternative way into QueerPulse.",
  ...
  "integrations.stripe.desc":
    "Sustainer billing and payouts for paid gatherings you host.",
  "integrations.mastodon.desc":
    "Cross-post your public articles to your fediverse account. Posts only.",
  "integrations.spotify.desc":
    "Power Audio Rooms with shared listening. No library access.",
  "integrations.ical.desc":
    "Subscribe to your RSVP'd gatherings from any calendar app.",
  "integrations.notion.desc":
    "Save articles and resources straight to a Notion database.",
  "integrations.readwise.desc":
    "Send your highlights from long-read editions to Readwise.",
  "integrations.matrix.desc":
    "Bridge community chat to an encrypted Matrix room.",
  "integrations.pinboard.desc":
    "Bookmark resources and articles to your Pinboard account.",
};
