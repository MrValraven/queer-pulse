...
export const admin: Catalog = {
  ...
  "adminListings.history.event.coManagerRemoved":
    "{actor} terminou um lugar na equipa de cogestão.",
  "adminListings.history.event.staffCreated":
    "{actor} criou esta listagem em nome do negócio.",
  "adminListings.history.event.suggestionApplied":
    "{actor} aplicou uma correção sugerida.",
  "adminListings.history.event.directoryPaused":
    "{actor} pausou a listagem no diretório.",
  "adminListings.history.event.directoryResumed":
    "{actor} voltou a mostrar a listagem no diretório.",
  ...
  "guideWorkspace.untitled": "Guia sem título",
  "guideWorkspace.newGuideCta": "Novo guia",
  "guideWorkspace.leaveConfirm":
    "Tens alterações por guardar neste guia. Sair mesmo assim?",
  "guideWorkspace.notFound.title": "Guia não encontrado",
  "guideWorkspace.notFound.body":
    "Este guia pode ter sido apagado, ou a ligação está errada.",
  "guideWorkspace.backToGuidesCta": "Voltar aos guias",
  "guideWorkspace.loadError": "Não foi possível carregar este guia.",
  "guideWorkspace.retryCta": "Tentar outra vez",
  "guideWorkspace.undo": "Desfazer",
  "guideWorkspace.header.languageLabel": "Idioma",
  "guideWorkspace.header.language.en": "Inglês",
  "guideWorkspace.header.language.pt": "Português",
  "guideWorkspace.header.viewLabel": "Vista",
  "guideWorkspace.header.view.edit": "Editar",
  "guideWorkspace.header.view.split": "Lado a lado",
  "guideWorkspace.header.view.preview": "Pré-visualizar",
  "guideWorkspace.header.status.dirty": "Alterações por guardar",
  "guideWorkspace.header.status.saving": "A guardar...",
  "guideWorkspace.header.status.saved": "Guardado às {time}",
  "guideWorkspace.header.issues": "Problemas a corrigir: {count}",
  "guideWorkspace.header.saveCta": "Guardar",
  "guideWorkspace.links.label": "Onde aparece",
  "guideWorkspace.links.live": "Página pública",
  "guideWorkspace.links.library": "Biblioteca",
  "guideWorkspace.links.index": "Índice de guias",
  "guideWorkspace.links.notPublic":
    "Por agora, quem lê vê a página de guia em revisão.",
  "guideWorkspace.recovery.body": "Tens alterações por guardar de {time}.",
  "guideWorkspace.recovery.olderBase":
    "Este guia foi guardado entretanto, por isso restaurar substitui essas alterações mais recentes quando guardares.",
  "guideWorkspace.recovery.restoreCta": "Restaurar",
  "guideWorkspace.recovery.discardCta": "Descartar",
  "guideWorkspace.conflict.body": "Alguém guardou este guia às {time}.",
  "guideWorkspace.conflict.loadTheirsCta": "Carregar a versão dessa pessoa",
  "guideWorkspace.conflict.saveMineCta": "Guardar a minha mesmo assim",
  "guideWorkspace.toast.demoNotSaved":
    "Modo de demonstração, nada foi guardado.",
  "guideWorkspace.toast.published": "{title} está publicado.",
  "guideWorkspace.toast.unpublished": "{title} deixou de estar publicado.",
  "guideWorkspace.error.publish":
    "Não foi possível mudar o estado de publicação",
  "guideWorkspace.status.title": "Estado",
  "guideWorkspace.status.published": "Publicado",
  "guideWorkspace.status.unpublished": "Não publicado",
  "guideWorkspace.status.hiddenUntilReviewed":
    "Publicado, mas escondido de quem lê até ser revisto.",
  "guideWorkspace.status.reviewDue": "Próxima revisão a {date}",
  "guideWorkspace.status.reviewOverdue": "Revisão em atraso desde {date}",
  "guideWorkspace.status.saveBeforeReview":
    "Guarda primeiro, para que a revisão cubra o que quem lê vê.",
  "guideWorkspace.status.publishCta": "Publicar",
  "guideWorkspace.status.unpublishCta": "Despublicar",
  "guideWorkspace.status.newGuide":
    "Os guias novos começam sem publicação e sem revisão.",
  "guideWorkspace.details.title": "Detalhes",
  "guideWorkspace.details.categoryPlaceholder": "Escolhe uma categoria",
  "guideWorkspace.details.currentCategory": "{category} (atual)",
  "guideWorkspace.details.slug": "Identificador (slug)",
  "guideWorkspace.details.slugHint":
    "Palavras em minúsculas e hífenes. Fica fixo depois de guardares pela primeira vez.",
  "guideWorkspace.details.routePathHint":
    "Opcional, por exemplo /resources/sober",
  "guideWorkspace.chip.format.guide": "Guia",
  "guideWorkspace.chip.format.checklist": "Lista de verificação",
  "guideWorkspace.chip.format.template": "Modelo",
  "guideWorkspace.chip.format.directory": "Diretório",
  "guideWorkspace.chip.format.toolkit": "Kit de ferramentas",
  "guideWorkspace.chip.keep": "Manter a etiqueta atual: {chip}",
  "guideWorkspace.chip.none": "nenhuma",
  "guideWorkspace.chip.result": "Quem lê vê: {chip}",
  "guideWorkspace.chip.hint":
    "O tempo de leitura e os idiomas atualizam-se a partir do texto.",
  "guideWorkspace.cards.title": "Pré-visualização dos cartões",
  "guideWorkspace.cards.library": "Biblioteca de recursos",
  "guideWorkspace.cards.index": "Índice de guias",
  "guideWorkspace.cards.englishOnly":
    "Os cartões mostram o título e a descrição em inglês.",
  "guideWorkspace.outline.title": "Estrutura",
  "guideWorkspace.outline.untitledSection": "Secção sem título",
  "guideWorkspace.outline.words_one": "{count} palavra",
  "guideWorkspace.outline.words_other": "{count} palavras",
  "guideWorkspace.outline.jump": "Ir para {section}",
  "guideWorkspace.outline.moveUp": "Mover {section} para cima",
  "guideWorkspace.outline.moveDown": "Mover {section} para baixo",
  "guideWorkspace.outline.moved":
    "{section} passou para a posição {position} de {total}.",
  "guideWorkspace.outline.flag.empty": "Por traduzir",
  "guideWorkspace.outline.flag.noEnglishMatch": "Sem secção em inglês",
  "guideWorkspace.outline.missing": "Só em inglês: {sections}",
  "guideWorkspace.outline.empty": "Ainda sem secções.",
  "guideWorkspace.document.label": "Texto do guia",
  "guideWorkspace.document.headingPlaceholder": "Título da secção",
  "guideWorkspace.document.headingLabel": "Título da secção {position}",
  "guideWorkspace.document.addBarLabel": "Adicionar no fim",
  "guideWorkspace.document.addSectionCta": "Nova secção",
  "guideWorkspace.document.addBlockCta": "Adicionar parágrafo",
  "guideWorkspace.document.hint":
    "Escreve / num bloco vazio para mais opções. Enter começa um bloco novo.",
  "guideWorkspace.document.copyEnglishCta": "Copiar a estrutura em inglês",
  "guideWorkspace.document.copyEnglishHint":
    "Secções em inglês sem versão em português: {count}",
  "guideWorkspace.document.empty": "Este guia ainda não tem secções.",
  "guideWorkspace.block.placeholder.paragraph": "Escreve, ou usa / para blocos",
  "guideWorkspace.block.placeholder.subheading": "Subtítulo",
  "guideWorkspace.block.placeholder.listItem": "Item de lista",
  "guideWorkspace.block.placeholder.note": "Texto do destaque",
  "guideWorkspace.block.ariaLabel": "{kind}, bloco {position}",
  "guideWorkspace.block.moveUp": "Mover bloco para cima",
  "guideWorkspace.block.moveDown": "Mover bloco para baixo",
  "guideWorkspace.block.remove": "Remover bloco",
  "guideWorkspace.block.removedToast": "Bloco removido.",
  "guideWorkspace.section.menuLabel": "Opções da secção",
  "guideWorkspace.section.anchorLabel": "Âncora",
  "guideWorkspace.section.anchorHint":
    "As ligações para esta secção usam #{anchor}.",
  "guideWorkspace.section.moveUp": "Mover secção para cima",
  ...
  "guideWorkspace.translation.noEnglishMatch":
    "Nenhuma secção em inglês usa esta âncora.",
  "guideWorkspace.preview.label": "Pré-visualização",
  "guideWorkspace.preview.englishFallback":
  ...
  "guideWorkspace.issue.descriptionRequired": "Adiciona uma descrição.",
  "guideWorkspace.issue.descriptionTooLong":
    "Mantém a descrição abaixo de 2000 caracteres.",
  "guideWorkspace.issue.categoryRequired": "Escolhe uma categoria.",
  "guideWorkspace.issue.slugRequired": "Adiciona um identificador.",
  "guideWorkspace.issue.slugInvalid":
    "Usa palavras em minúsculas separadas por um hífen.",
  "guideWorkspace.issue.slugTaken": "Outro guia já usa este identificador.",
  "guideWorkspace.issue.routePathInvalid":
    "Começa com / e usa só letras, números, hífenes e barras.",
  "guideWorkspace.issue.chipTooLong":
    "A etiqueta do cartão tem mais de 120 caracteres.",
  "guideWorkspace.issue.tooManySections": "Um guia pode ter até 40 secções.",
  "guideWorkspace.issue.headingTooLong":
    "Mantém os títulos das secções abaixo de 300 caracteres.",
  "guideWorkspace.issue.anchorInvalid":
    "A âncora precisa de palavras em minúsculas separadas por hífenes.",
  "guideWorkspace.issue.anchorDuplicate": "Outra secção já usa esta âncora.",
  ...
  "emailTemplates.navLabel": "Modelos de email",
  "emailTemplates.eyebrow": "Biblioteca de emails",
  "emailTemplates.title": "Modelos de <em>email</em>",
  "emailTemplates.sub":
    "Os emails que a equipa envia à mão, escritos uma vez e guardados num só sítio. Copia um, cola-o na tua caixa de correio e envia-o tu.",
  "emailTemplates.newCta": "Novo modelo",
  "emailTemplates.loadError":
    "Os modelos de email não carregaram. Tenta outra vez daqui a pouco.",
  "emailTemplates.empty": "Ainda não há modelos de email. Escreve o primeiro.",
  "emailTemplates.purpose.invite_approved": "Convite aprovado",
  "emailTemplates.purpose.general": "Geral",
  "emailTemplates.list.editCta": "Editar",
  "emailTemplates.list.previewCta": "Pré-visualizar",
  "emailTemplates.list.deleteLabel": "Eliminar {label}",
  "emailTemplates.list.activeToggleLabel": "Ativo: {label}",
  "emailTemplates.list.inactive": "Inativo",
  "emailTemplates.delete.title": "Eliminar {label}?",
  "emailTemplates.delete.body":
    "Isto remove o modelo para toda a gente. Os emails já enviados ficam como estão, nas caixas de correio de onde saíram.",
  "emailTemplates.delete.confirmCta": "Eliminar modelo",
  "emailTemplates.toast.removed": "{label} removido.",
  "emailTemplates.toast.saved": "Modelo guardado.",
  "emailTemplates.removeError": "O modelo não foi eliminado.",
  "emailTemplates.saveError": "O modelo não foi guardado.",
  "emailTemplates.editor.newTitle": "Novo modelo de <em>email</em>",
  "emailTemplates.editor.editTitle": "Editar <em>{label}</em>",
  "emailTemplates.editor.backToList": "Todos os modelos de email",
  "emailTemplates.editor.allTemplates": "todos os modelos de email",
  "emailTemplates.editor.backCta": "Voltar",
  "emailTemplates.editor.labelField": "Nome (só para a equipa)",
  "emailTemplates.editor.purposeField": "Usado para",
  "emailTemplates.editor.purposeHint":
    "Define que marcadores o modelo pode usar.",
  "emailTemplates.editor.activeField": "Ativo",
  "emailTemplates.editor.subjectField": "Assunto",
  "emailTemplates.editor.languageLabel": "Idioma",
  "emailTemplates.editor.localeTab.en": "Inglês",
  "emailTemplates.editor.localeTab.pt": "Português",
  "emailTemplates.editor.localeUnsaved": "{language} (por guardar)",
  "emailTemplates.editor.ptMissing":
    "Este modelo ainda não tem versão em português.",
  "emailTemplates.editor.ptStart": "Começar a partir da versão em inglês",
  "emailTemplates.editor.ptRemove": "Remover a versão em português",
  "emailTemplates.editor.saveCta": "Guardar modelo",
  "emailTemplates.editor.saving": "A guardar…",
  "emailTemplates.editor.saveAsNewCta": "Guardar como novo modelo",
  "emailTemplates.editor.deletedWhileEditing":
    "Este modelo foi eliminado enquanto o editavas.",
  "emailTemplates.editor.labelTaken": "Já existe outro modelo com este nome.",
  "emailTemplates.editor.validationTitle": "Corrige isto antes de guardar:",
  "emailTemplates.editor.leaveConfirm":
    "Sair sem guardar? As alterações a este modelo perdem-se.",
  "emailTemplates.editor.notFound": "Este modelo já não existe.",
  "emailTemplates.editor.unknownPlaceholder":
    "{token} não é um marcador que este modelo possa usar.",
  "emailTemplates.placeholders.label": "Inserir um marcador",
  "emailTemplates.placeholders.shortLabel": "Inserir",
  "emailTemplates.placeholders.none": "Este uso não tem marcadores.",
  "emailTemplates.placeholders.name": "Primeiro nome",
  "emailTemplates.placeholders.inviteLink": "Link de convite",
  "emailTemplates.placeholders.expiresOn": "Data de expiração do link",
  "emailTemplates.mode.viewHtml": "Ver HTML",
  "emailTemplates.mode.viewHtmlTitle": "HTML gerado",
  "emailTemplates.mode.copyHtml": "Copiar HTML",
  "emailTemplates.mode.editAsHtml": "Editar como HTML",
  "emailTemplates.mode.editAsHtmlTitle": "Passar este idioma para HTML?",
  "emailTemplates.mode.editAsHtmlBody":
    "O editor de código passa a tratar deste idioma. Os teus blocos ficam guardados, e Voltar aos blocos regressa a eles, descartando o HTML.",
  "emailTemplates.mode.backToBlocks": "Voltar aos blocos",
  "emailTemplates.mode.backToBlocksTitle": "Descartar o HTML personalizado?",
  "emailTemplates.mode.backToBlocksBody":
    "Este idioma volta aos blocos tal como estavam antes da mudança. O HTML que escreveste perde-se.",
  "emailTemplates.mode.backToBlocksConfirm": "Descartar HTML",
  "emailTemplates.mode.htmlField": "HTML do email",
  "emailTemplates.mode.copySample": "Copiar com valores de exemplo",
  "emailTemplates.mode.copySampleShort": "Copiar",
  "emailTemplates.blocks.addLabel": "Adicionar um bloco",
  "emailTemplates.blocks.empty":
    "Ainda não há blocos. Adiciona um título ou um parágrafo para começar.",
  "emailTemplates.blocks.type.heading": "Título",
  "emailTemplates.blocks.type.paragraph": "Parágrafo",
  "emailTemplates.blocks.type.button": "Botão",
  "emailTemplates.blocks.type.image": "Imagem",
  "emailTemplates.blocks.type.divider": "Divisória",
  "emailTemplates.blocks.type.spacer": "Espaço",
  "emailTemplates.blocks.type.html": "HTML",
  "emailTemplates.blocks.moveUp": "Subir {type}",
  "emailTemplates.blocks.moveDown": "Descer {type}",
  "emailTemplates.blocks.remove": "Remover {type}",
  "emailTemplates.blocks.field.text": "Texto",
  "emailTemplates.blocks.field.level": "Tamanho",
  "emailTemplates.blocks.field.levelLarge": "Grande",
  "emailTemplates.blocks.field.levelSmall": "Pequeno",
  "emailTemplates.blocks.field.paragraphHint":
    "Aqui funcionam **negrito**, *itálico* e [link](https://…).",
  "emailTemplates.blocks.field.buttonLabel": "Texto do botão",
  "emailTemplates.blocks.field.buttonHref": "Link do botão",
  "emailTemplates.blocks.field.buttonHrefHint":
    "Um endereço https://, ou um marcador dos botões acima.",
  "emailTemplates.blocks.field.imageSrc": "Endereço da imagem (https://)",
  "emailTemplates.blocks.field.imageAlt": "Descrição para leitores de ecrã",
  "emailTemplates.blocks.field.imageWidth": "Largura em píxeis, até 600",
  "emailTemplates.blocks.field.spacerSize": "Espaço",
  "emailTemplates.blocks.field.sizeSm": "Pequeno",
  "emailTemplates.blocks.field.sizeMd": "Médio",
  "emailTemplates.blocks.field.sizeLg": "Grande",
  "emailTemplates.blocks.field.html": "HTML",
  "emailTemplates.preview.label": "Pré-visualização",
  "emailTemplates.preview.frameTitle":
    "Pré-visualização do email com valores de exemplo",
  "emailTemplates.preview.desktop": "Computador",
  "emailTemplates.preview.mobile": "Telemóvel",
  "emailTemplates.preview.sampleNote":
    "Os marcadores mostram valores de exemplo.",
  "emailTemplates.preview.inbox": "Caixa de entrada",
  "emailTemplates.preview.toRecipient": "para {name}",
  "emailTemplates.preview.noSubject": "(sem assunto)",
  "emailTemplates.editor.preheaderField":
    "Texto de pré-visualização (opcional)",
  "emailTemplates.editor.preheaderHint":
    "A linha cinzenta que as caixas de entrada mostram depois do assunto.",
  "emailTemplates.designSwitch.label": "Design do email (temporário)",
  "emailTemplates.designSwitch.shortLabel": "Design",
  "emailTemplates.designSwitch.current": "Atual",
  "emailTemplates.designSwitch.stage": "Palco",
  "emailTemplates.designSwitch.letter": "Carta",
  "emailTemplates.blocks.type.hero": "Abertura",
  "emailTemplates.blocks.type.ticket": "Bilhete",
  "emailTemplates.blocks.type.featureList": "Lista de destaques",
  "emailTemplates.blocks.type.signature": "Assinatura",
  "emailTemplates.blocks.featureRow": "Linha {number}",
  "emailTemplates.blocks.featureMoveUp": "Subir a linha {number}",
  "emailTemplates.blocks.featureMoveDown": "Descer a linha {number}",
  "emailTemplates.blocks.featureRemove": "Remover a linha {number}",
  "emailTemplates.blocks.featureAdd": "Adicionar uma linha",
  "emailTemplates.blocks.featureIcon.communities": "Comunidades",
  "emailTemplates.blocks.featureIcon.gatherings": "Encontros",
  "emailTemplates.blocks.featureIcon.directory": "Diretório",
  "emailTemplates.blocks.featureIcon.messages": "Mensagens",
  "emailTemplates.blocks.featureIcon.magazine": "Revista",
  "emailTemplates.blocks.featureIcon.safety": "Segurança",
  "emailTemplates.blocks.field.heroEyebrow":
    "Linha pequena por cima do título (opcional)",
  "emailTemplates.blocks.field.heroHeadline": "Título",
  "emailTemplates.blocks.field.headlineHint":
    "Põe uma palavra entre *asteriscos* para a escrever em itálico.",
  "emailTemplates.blocks.field.heroText":
    "Texto por baixo do título (opcional)",
  "emailTemplates.blocks.field.ticketLabel": "Etiqueta pequena",
  "emailTemplates.blocks.field.ticketTitle": "Título",
  "emailTemplates.blocks.field.ticketText": "Texto (opcional)",
  "emailTemplates.blocks.field.featureIcon": "Ícone",
  "emailTemplates.blocks.field.featureTitle": "Título",
  "emailTemplates.blocks.field.featureText": "Texto",
  "emailTemplates.blocks.field.signatureName": "Nome",
  "emailTemplates.blocks.field.signatureRole": "Função (opcional)",
  "emailTemplates.blocks.field.signatureNote": "Nota (opcional)",
  "emailTemplates.blocks.field.signaturePhoto": "Endereço da foto (opcional)",
  "emailTemplates.blocks.field.signaturePhotoHint":
    "Um endereço https:// de uma foto quadrada. Deixa em branco para mostrar a marca do QueerPulse.",
  "emailTemplates.blocks.field.heroHint":
    "Põe-no em primeiro lugar para abrir o email com ele.",
  ...
  "emailTemplates.copy.copiedToast":
    "Email de boas-vindas copiado. Cola-o num email para {email}.",
  "emailTemplates.copy.copiedPlainToast":
    "Copiado como texto simples, porque este navegador não conseguiu manter a formatação. Cola-o num email para {email}.",
  "emailTemplates.copy.subjectCopiedToast": "Assunto copiado.",
  "emailTemplates.copy.htmlCopiedToast": "HTML copiado.",
