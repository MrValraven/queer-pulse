...
export const members: Catalog = {
  ...
  // WCAG 2.5.3 Label in Name. Ver a nota no catálogo EN.
  "content.now.updateAction": "Atualizar o teu Agora",
  "content.now.stats.hellos_one": "olá",
  "content.now.stats.hellos_other": "olás",
  "content.now.stats.replies_one": "resposta",
  "content.now.stats.replies_other": "respostas",
  "content.now.stats.window": "{days} dias",
  "content.now.visibility.open": "Toda a gente",
  "content.now.visibility.network": "A tua rede",
  "content.now.visibility.private": "Só tu",
  "content.now.history.label": "Antes disto",
  "content.now.history.count_one": "{count} estado",
  "content.now.history.count_other": "{count} estados",
  "content.now.history.ran": "{started} a {ended}",
  "content.now.chip.helloCount_one": "{count} olá",
  "content.now.chip.helloCount_other": "{count} olás",
  "content.now.chip.staleMonths": "Sem olás há {months} meses, queres trocar?",
  "content.now.chip.staleNever": "Ainda sem olás, queres trocar?",
  "content.now.explainer":
    "São estas as portas que as pessoas podem tocar para chegar até ti, com o motivo já preenchido.",
  "content.now.respondsWithin.day": "Costuma responder num dia",
  "content.now.respondsWithin.fewDays": "Costuma responder em poucos dias",
  "content.now.respondsWithin.week":
    "Costuma responder numa semana, mais ou menos",
  "content.now.edit.title": "Atualiza o teu Agora",
  "content.now.edit.statusLabel": "O que tens entre mãos",
  "content.now.edit.statusPlaceholder":
    "Uma frase ou duas sobre o que te anda a ocupar a cabeça",
  "content.now.edit.notHereForLabel": "Não estou aqui para",
  "content.now.edit.notHereForPlaceholder":
    "Alguma coisa que preferias que não te perguntassem",
  "content.now.edit.openToLabel": "Disponível para",
  "content.now.edit.save": "Guardar",
  "content.now.edit.cancel": "Cancelar",
  ...
  "directory.discipline.beauty": "Beleza",
  "directory.discipline.trades": "Ofícios",
  "directory.discipline.care": "Cuidados",
  "directory.discipline.wellness": "Bem-estar",
  "directory.discipline.retail": "Comércio e serviços",
  "directory.discipline.transport": "Transportes",
  ...
  "directory.profession.bartender": "Serviço de bar",
  "directory.profession.waiter": "Serviço de mesa",
  ...
  "directory.profession.barber": "Barbearia",
  "directory.profession.hairdresser": "Cabeleireiro",
  "directory.profession.makeupArtist": "Maquilhagem",
  "directory.profession.nailTechnician": "Manicure e unhas",
  "directory.profession.beautician": "Estética",
  "directory.profession.tattooArtist": "Tatuagem",
  "directory.profession.piercer": "Piercing",
  "directory.profession.electrician": "Eletricidade",
  "directory.profession.plumber": "Canalização",
  "directory.profession.carpenter": "Carpintaria",
  "directory.profession.mechanic": "Mecânica",
  "directory.profession.painterDecorator": "Pintura e decoração",
  "directory.profession.constructionWorker": "Construção civil",
  "directory.profession.gardener": "Jardinagem",
  "directory.profession.homeCareWorker": "Apoio domiciliário",
  "directory.profession.childcareWorker": "Cuidados infantis",
  "directory.profession.disabilitySupportWorker": "Assistência pessoal",
  "directory.profession.personalTrainer": "Treino pessoal",
  "directory.profession.yogaTeacher": "Ensino de ioga",
  "directory.profession.massageTherapist": "Massagem",
  "directory.profession.shopAssistant": "Atendimento em loja",
  "directory.profession.receptionist": "Receção",
  "directory.profession.cleaner": "Limpeza",
  "directory.profession.securityGuard": "Segurança",
  "directory.profession.customerSupport": "Apoio ao cliente",
  "directory.profession.driver": "Condução",
  "directory.profession.deliveryRider": "Estafeta",
  "directory.profession.warehouseWorker": "Logística de armazém",
  ...
  "places.deletedNamed": "Anúncio eliminado: {name}.",
  ...
  "profile.hello.sendErrorToast":
    "Não foi possível enviar a tua mensagem. Verifica a ligação e tenta outra vez.",
  "profile.hello.openThreadCta": "Abrir a conversa",
  "profile.hello.sending": "A enviar…",
};
