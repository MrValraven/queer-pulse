...
export const safety: Catalog = {
  ...
  "emergency.hero.category": "Recursos de Emergência",
  "emergency.hero.title": "A ajuda está aqui. <em>Não estás sozinhe.</em>",
  "emergency.hero.lead":
    "Esta página existe para momentos de crise. Tudo o que está aqui está disponível agora mesmo — sem início de sessão, sem espera. Se estás em perigo imediato, liga para o 112.",
  "emergency.note":
    "<b>Uma nota sobre estes números:</b> as linhas telefónicas e organizações em Portugal mudam. Estes contactos estão corretos em 2026, tanto quanto sabemos. Se algo não estiver a funcionar, liga para o 112 (serviços de emergência) ou para o 808 24 24 24 (linha de saúde SNS 24). Ambas funcionam 24 horas por dia.",
  "emergency.crisisNow.title": "Se precisas de ajuda agora mesmo",
  "emergency.crisis.emergencyServices.label": "Serviços de emergência",
  ...
  "emergency.crisis.apav.note":
    "Violência, violência doméstica, crimes de ódio — 24h, gratuito",
  "emergency.crisis.linhaCrianca.label": "Linha Amiga da Criança",
  "emergency.crisis.linhaCrianca.note":
    "Para pessoas com menos de 18 anos, 24h, gratuito",
  ...
  "emergency.section.mentalHealth.intro":
    "Quer estejas numa crise aguda ou só a ter dificuldades — estas organizações apoiam especificamente pessoas LGBTQ+ em Lisboa.",
  "emergency.section.mentalHealth.item.opusDiversus.detail":
    "Apoio entre pares e recursos de saúde mental para pessoas LGBTQ+. Sessões sem marcação e acompanhamento individual disponíveis.",
  "emergency.section.mentalHealth.item.clinician.detail":
    "Profissional de psicologia clínica especializade em cuidados LGBTQ+. Dinamiza um grupo mensal de apoio entre pares em Lisboa para profissionais queer.",
  "emergency.section.mentalHealth.item.sns.detail":
    "Podes aceder a apoio de saúde mental através do SNS com uma referenciação do teu médico de família. Liga para o 808 24 24 24 para começar.",

  "emergency.section.transSupport.title": "Apoio específico para pessoas trans",
  "emergency.section.transSupport.intro":
    "Apoio específico para pessoas trans, não-bináries e com expressão de género não-normativa em Portugal e em Lisboa.",
  "emergency.section.transSupport.item.ilga.detail":
    "Apoio jurídico, referenciação para cuidados de saúde, ajuda com documentação, e apoio de crise para pessoas trans. Liga para o 707 200 220.",
  "emergency.section.transSupport.item.pantherasRosa.detail":
    "Defesa de direitos trans e organização comunitária. Pode ligar-te a apoio entre pares trans e à comunidade em Lisboa.",
  "emergency.section.transSupport.item.mutualAid.detail":
    "Entreajuda gerida por pares para pessoas trans em Lisboa. Ajuda prática, partilha de recursos, ligação à comunidade.",

  "emergency.section.housing.title": "Insegurança em casa / crise habitacional",
  "emergency.section.housing.intro":
    "Se o teu ambiente doméstico é perigoso ou não tens um lugar seguro para onde ir.",
  "emergency.section.housing.item.apav.detail":
    "Apoio para pessoas a viver violência doméstica, incluindo pessoas LGBTQ+. 116 006, gratuito, 24h. Pode ajudar a organizar alojamento de emergência.",
  "emergency.section.housing.item.queerHousing.detail":
    "Rede gerida pela comunidade que regista habitação queer-segura e pode ligar com urgência pessoas em crise habitacional a pessoas da comunidade com espaço disponível.",
  "emergency.section.housing.item.santaCasa.detail":
    "A maior organização de serviços sociais de Lisboa. Pode referenciar para habitação de emergência.",

  "emergency.section.legal.title": "Emergência jurídica e discriminação",
  "emergency.section.legal.intro":
    "A enfrentar discriminação, crime de ódio, uma crise de direito de família, ou uma emergência de imigração.",
  "emergency.section.legal.item.ilga.detail":
    "Consultas jurídicas gratuitas para pessoas LGBTQ+ a enfrentar discriminação, crimes de ódio, direito de família, ou questões de imigração. Liga para o 707 200 220.",
  "emergency.section.legal.item.lawyer.detail":
    "Profissional do direito que oferece consultas pro bono para pessoas LGBTQ+ a enfrentar discriminação e desafios de direito de família. Mais de 60 casos em três anos.",
  "emergency.section.legal.item.ordemAdvogados.detail":
    "A Ordem dos Advogados portuguesa gere um sistema de apoio judiciário para quem não consegue pagar representação jurídica.",

  "emergency.online.title": "Recursos online — disponíveis agora mesmo",
  "emergency.online.ilga.sub": "Português · Direitos LGBTQ+",
  "emergency.online.trevor.sub": "Inglês · Apoio de crise para jovens",
  "emergency.online.transLifeline.sub": "Inglês · Apoio entre pares trans",
  "emergency.online.opusDiversus.sub": "Português · Saúde mental LGBTQ+",
