...
export const help: Catalog = {
  ...
  "admin.hub.title": "Painel de administração",
  "admin.hub.intro":
  ...
  "auth.onboarding.title": "Boas-vindas",
  ...
  "communities.hub.title": "Comunidades",
  ...
  "community.detail.title": "Comunidade",
  ...
  "community.events.title": "Eventos",
  ...
  "community.forum.title": "Discussão",
  ...
  "economy.grants.title": "Financiamentos",
  ...
  "governance.hub.title": "Governação",
  ...
  "housing.listing.title": "Anúncio de habitação",
  ...
  "local.directory.title": "Diretório de negócios locais",
  ...
  "local.directoryDetail.title": "Detalhes do espaço",
  ...
  "members.profile.title": "Perfil público",
  ...
  "messages.conversation.title": "Conversa",
  ...
  "messages.inbox.title": "Mensagens",
  ...
  "myevents.hub.title": "Os teus eventos",
  "myevents.hub.intro":
  ...
  "notifications.hub.title": "Notificações",
  ...
  "safety.hub.title": "Espaços seguros",
  "safety.hub.intro":
  ...
  "settings.privacy.title": "Preferências de notificações",
