...
export const community: Catalog = {
  ...
  "caregivers.lesson.pronouns.body":
    "O que fazer, o que não fazer, o que fazer quando te enganas. <em>Um texto prático, sobre o que fazer na verdade.</em> Escrito por Yara R.",
  ...
  "caregivers.faq.childCameOut.a":
    '<strong>Respira fundo. Diz "obrigade por me teres contado." Depois pergunta "há alguma coisa de que precises de mim agora?"</strong> É só isso. Não precisas de saber a linguagem certa. Não precisas de ter um plano. <em>Esta é uma conversa longa, que continua no tempo.</em> Volta mais tarde com perguntas. Vão estar prontas para as ouvir, e este espaço também está aqui.',
  ...
  "caregivers.dontDoSay.lead":
    "Algumas das coisas que gostaríamos que nos tivessem dito. Só alguns primeiros passos que ajudam, oferecidos com leveza.",
  ...
  "changemakers.admin.navLabel": "Agentes de Mudança",
  "changemakers.admin.title": "Diretório de Agentes de Mudança",
  "changemakers.admin.newProfileCta": "Novo perfil",
  "changemakers.admin.empty.title": "Ainda não há perfis de agentes de mudança",
  "changemakers.admin.empty.description":
    "Cria o primeiro perfil para começar a preencher o diretório público.",
  "changemakers.admin.statsTitle": "Estatísticas de destaque",
  "changemakers.admin.statsHint":
    "Estes dois valores não são calculados a partir dos perfis. Define-os manualmente.",
  "changemakers.admin.peopleHelpedLabel": "Pessoas ajudadas",
  "changemakers.admin.activeCampaignsLabel": "Campanhas ativas",
  "changemakers.admin.statsSaveCta": "Guardar estatísticas",
  "changemakers.admin.statsSavedToast": "Estatísticas do diretório guardadas.",
  "changemakers.admin.editCta": "Editar",
  "changemakers.admin.publishCta": "Publicar",
  "changemakers.admin.unpublishCta": "Despublicar",
  "changemakers.admin.deleteCta": "Eliminar",
  "changemakers.admin.statusPublished": "Publicado",
  "changemakers.admin.statusDraft": "Rascunho",
  "changemakers.admin.featuredBadge": "Em destaque",
  "changemakers.admin.cancelCta": "Cancelar",
  "changemakers.admin.deleteConfirmTitle": "Eliminar este perfil?",
  "changemakers.admin.deleteConfirmBody":
    "Isto remove {name} do diretório definitivamente. Não é possível desfazer.",
  "changemakers.admin.deleteConfirmCta": "Eliminar perfil",
  "changemakers.admin.deletedToast": "Perfil eliminado.",
  "changemakers.admin.publishedToast": "Perfil publicado.",
  "changemakers.admin.unpublishedToast": "Perfil despublicado.",
  "changemakers.admin.editor.createTitle": "Novo perfil de agente de mudança",
  "changemakers.admin.editor.editTitle": "Editar perfil de agente de mudança",
  "changemakers.admin.editor.nameLabel": "Nome",
  "changemakers.admin.editor.initialsLabel": "Iniciais",
  "changemakers.admin.editor.causeLabel": "Causa",
  "changemakers.admin.editor.tintLabel": "Cor",
  "changemakers.admin.editor.tintCoral": "Coral",
  "changemakers.admin.editor.tintJade": "Jade",
  "changemakers.admin.editor.tintPlum": "Ameixa",
  "changemakers.admin.editor.tagsLabel": "Etiquetas",
  "changemakers.admin.editor.tagsHint":
    "Separadas por vírgula, por ex. Advocacia, Entreajuda",
  "changemakers.admin.editor.summaryLabel": "Resumo",
  "changemakers.admin.editor.imageUrlLabel": "URL da imagem",
  "changemakers.admin.editor.impactLabel": "Impacto",
  "changemakers.admin.editor.impactHint": "Uma linha de impacto por linha.",
  "changemakers.admin.editor.bylineLabel": "Assinatura",
  "changemakers.admin.editor.heroNoteLabel": "Nota do destaque",
  "changemakers.admin.editor.leadLabel": "Introdução",
  "changemakers.admin.editor.bodyLabel": "Corpo do texto",
  "changemakers.admin.editor.bodyHint":
    "Separa os parágrafos com uma linha em branco.",
  "changemakers.admin.editor.pullQuoteTextLabel": "Texto da citação",
  "changemakers.admin.editor.pullQuoteCiteLabel": "Autoria da citação",
  "changemakers.admin.editor.isFeaturedLabel": "Em destaque no diretório",
  "changemakers.admin.editor.sortOrderLabel": "Ordem",
  "changemakers.admin.editor.saveCta": "Guardar perfil",
  "changemakers.admin.editor.nameRequiredToast":
    "Dá um nome a este perfil primeiro.",
  "changemakers.admin.editor.createdToast": "Perfil criado.",
  "changemakers.admin.editor.updatedToast": "Perfil atualizado.",
  ...
  "dating.apps.lead":
    "O que a comunidade realmente usa: opiniões honestas de quem cá está.",
  ...
  "dating.culture.slowerPace.text":
    "A cultura social e de namoro portuguesa é, em geral, mais lenta do que as normas do norte da Europa ou da América do Norte. Conta com períodos de aquecimento mais longos, mais ênfase na química presencial e menos pressão para definir tudo depressa. Isto faz parte do encanto.",
  ...
  "dating.structure.monogamy.text":
    "Completamente válida e comum. A comunidade não assume que a não-monogamia seja mais progressista. É apenas uma preferência. As proteções legais em Portugal são mais fortes para casais monógamos casados, o que vale a pena saber se o reconhecimento legal for importante para ti.",
  ...
  "family.hero.legalNote":
    "Informação da comunidade para começar. As leis mudam, por isso confirma sempre com um ou uma especialista.",
  ...
  "family.tab.coparenting.card.findingCoparent.body":
    "A QueerPulse tem um mural de Ligações para Coparentalidade para quem quer encontrar um coparente dentro da comunidade. É um mural de anúncios. Publica as tuas intenções, conhece pessoas com o tempo, tem conversas honestas antes de decidires seja o que for.",
  ...
  "readingGroups.why.small.desc":
    "Os grupos têm um limite de 6 a 8 pessoas. Conversas a sério, num grupo pequeno.",
