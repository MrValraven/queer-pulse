...
export function datePartOf(mode: FieldMode, value: string | null): string | null {
...
export function combineDatetimeValue(datePart: string, previousValue: string | null): string {
