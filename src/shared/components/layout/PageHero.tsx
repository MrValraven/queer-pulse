 ...
 */
export function PageHero({ eyebrow, title, sub, plum = true, children, className }: PageHeroProps) {
  return (
    <header className={[styles.hero, plum && styles.plum, className].filter(Boolean).join(' ')}>
      <div className="wrap">
