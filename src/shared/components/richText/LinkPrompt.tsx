      ...
      <form className={styles.linkPrompt} onSubmit={handleSubmit}>
        <div className={styles.linkRow}>
          <input
            ...
            aria-label={t("shared:richText.linkFieldLabel")}
          ...
          <Button
            ...
            size="sm"
            disabled={href === null}
            aria-label={t("shared:richText.linkApply")}
          >
            <FiCheck aria-hidden />
          </Button>
          <Button
            ...
            size="sm"
            onClick={onCancel}
            aria-label={t("shared:richText.linkCancel")}
          >
            <FiX aria-hidden />
          </Button>
        </div>
