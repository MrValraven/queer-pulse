...
export interface RichTextProps {
  ...
  /** Runs before the built-in key handling. Calling `preventDefault` on the
   * event skips it (the "/" menu and the plain-text Enter guard), which is
   * how a caller takes over Enter, Backspace or formatting shortcuts. */
