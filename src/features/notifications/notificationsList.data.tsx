...
export const notifications: Notification[] = [
    ...
    actions: [
      {
        ...
        resolve: { toast: "Joined Queer Classics reading group" },
      },
      {
        label: "Decline",
        variant: "ghost",
        href: "#",
        resolve: { toast: "Invitation declined" },
      },
    ],
  },
  {
    ...
    text: (
      <>
        <strong>{memberName("sofia")}</strong> mentioned you in the Forum
        thread: "What are we reading in July?"
      </>
    ),
    meta: "Forum · Mention",
    time: "3 hr ago",
  ...
  },
  {
    ...
    time: "Yesterday",
    actions: [
      { label: "See details", variant: "ghost", href: routes.readingGroups },
    ],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    time: "3 days ago",
    actions: [
      { label: "See barter board", variant: "ghost", href: routes.barter },
    ],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    time: "5 days ago",
    actions: [
      { label: "Read message", variant: "ghost", href: routes.messages },
    ],
  },
  {
    id: 11,
  ...
  },
  {
    ...
    time: "1 week ago",
    actions: [
      { label: "Read report", variant: "ghost", href: routes.governance },
    ],
  },
];
