...
import { ModalShell, SuccessPanel, Sending, useSubmitFlow } from './CultureModalKit'
  ...
  return (
    <ModalShell onClose={onClose} success={done}>
      {done ? (
        ...
        >
          We'll connect you with {commission.who.name} if they'd like to take it further.
        </SuccessPanel>
      ) : (
        <>
          ...
          <div className={styles.panel}>
            <Avatar initials={commission.who.initials} tint={commission.who.tint} size={40} />
            <div>
          ...
          <div className={styles.foot}>
            ...
            <Button variant="primary" disabled={sending} onClick={() => submit()}>
