...
export const THREADS: Thread[] = [
  { initials: 'ML', tint: 'jade', q: "Baldwin's Paris as escape vs. prison — does that tension still resonate in Lisbon today?", meta: 'Mariana Loução · 2h ago · Book Club', replies: 14 },
  { initials: 'SA', tint: 'coral', q: 'The look vs. the gaze — how Sciamma plays with who has the power to see in Portrait', meta: 'Sofia Andrade · 5h ago · Film Club', replies: 9 },
  { initials: 'RP', tint: 'plum', q: "July nominations — I'm pushing hard for Detransition, Baby. Who else has a strong case?", meta: 'Rafael Pinto · 1d ago · Nominations', replies: 21 },
  { initials: 'BN', tint: 'jade', q: 'Kehlani and vulnerability as armour — production choices that shape the emotional arc', meta: 'Beatriz Noronha · 2d ago · Music Club', replies: 7 },
]
...
export const COMMISSIONS: Commission[] = [
  {
    ...
    tags: ['Documentary', 'Long-form', 'Book proposal in progress', 'Revenue share if published'],
    who: { initials: 'IT', tint: 'coral', name: 'Inês Tavares', role: 'Graphic Designer' },
  },
  {
    cat: 'Music',
    catLabel: 'Music',
  ...
  },
  {
    ...
    who: { initials: 'MP', tint: 'plum', name: 'Marta Pereira', role: 'Writer' },
  },
  {
    cat: 'Design',
    catLabel: 'Design',
    ...
    who: { initials: 'CF', tint: 'jade', name: 'Catarina Faria', role: 'Architect' },
  },
]
...
export const RADIO: RadioData = {
  ...
  now: { track: 'Cais do Sodré', artist: 'Surma · Uó (2022)', progress: 38, time: '2:14 / 3:47' },
  queue: [
