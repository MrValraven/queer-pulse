...
export const EMPTIES: Record<string, EmptyConfig> = {
  upcoming: {
    icon: <><rect x="3" y="5" width="22" height="20" rx="4" /><line x1="3" y1="11" x2="25" y2="11" /><line x1="9" y1="2" x2="9" y2="7" /><line x1="19" y1="2" x2="19" y2="7" /></>,
    title: <>Nothing on the calendar <em>yet</em></>,
    ...
    actions: [{ label: 'Browse gatherings', variant: 'primary', to: GATHERING }, { label: 'Host your own', variant: 'ghost', to: HOST }],
  },
  going: {
    tone: 'jade',
    icon: <path d="M5 14l6 6 12-13" />,
    title: <>No RSVPs <em>right now</em></>,
  ...
  hosting: {
    icon: <><circle cx="14" cy="9" r="5" /><path d="M4 24c0-5 4.5-8 10-8s10 3 10 8" /></>,
    title: <>You're not hosting <em>anything</em></>,
  ...
  waitlisted: {
    icon: <><circle cx="14" cy="14" r="11" /><path d="M14 8v6l4 2" /></>,
    title: <>No waitlists <em>right now</em></>,
    sub: "When a gathering you want is full, join its waitlist and we'll keep your place — we'll let you know if a spot opens.",
    actions: [{ label: 'Browse gatherings', variant: 'primary', to: GATHERING }],
  },
  past: {
    tone: 'plum',
    icon: <><circle cx="14" cy="14" r="11" /><path d="M14 7v7l4 3" /></>,
    title: <>No history <em>here</em> — but you're early</>,
    sub: "Once you've been to your first gathering, it'll live here as a quiet record of where you've been and who you met.",
    actions: [{ label: 'Find your first one', variant: 'primary', to: GATHERING }],
  },
  saved: {
    icon: <path d="M7 4h14a1 1 0 0 1 1 1v19l-8-4.5L6 24V5a1 1 0 0 1 1-1Z" />,
    title: <>Nothing saved or <em>pending</em></>,
  ...
  day: {
    tone: 'plum',
    icon: <><rect x="3" y="5" width="22" height="20" rx="4" /><line x1="3" y1="11" x2="25" y2="11" /><line x1="9" y1="2" x2="9" y2="7" /><line x1="19" y1="2" x2="19" y2="7" /></>,
    title: <>Nothing on <em>this day</em></>,
  ...
  search: {
    tone: 'plum',
    icon: <><circle cx="12" cy="12" r="8" /><path d="M18 18l6 6" /></>,
    title: <>No events <em>match</em></>,
    sub: 'Nothing here fits your search and filters right now. Try a different word, or loosen a filter.',
    actions: [{ label: 'Clear search & filters', variant: 'ghost', reset: 'secondary' }],
  },
}
