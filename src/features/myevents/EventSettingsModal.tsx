...
const visForLabel = (label: string) =>
  VIS.find((o) => o.label === label)?.v ?? "public";
    ...
    <>
      ...
      <div className={sx("modal-body")}>
        ...
        <div className={sx("field")}>
          ...
          <button
            ...
            onClick={() =>
              toast("Connecting your calendar — two-way sync on", "success")
            }
          >
          ...
          <button
            type="button"
            className={sx("set-link-row")}
            onClick={() => toast("Opening your tickets & receipts…")}
          >
            <span className={sx("slr-t")}>
              Tickets &amp; receipts
      ...
      <div className={sx("modal-foot")}>
        ...
        <Button
          variant="jade"
          onClick={() =>
            saveSettings({ reminderLead: lead, visibility: vis, email, push })
          }
        >
          Save
        </Button>
