    ...
    <div className={styles.root}>
      ...
      <div className={styles.wrap}>
        ...
        <p className={styles.lead}>
          We're shipping the <b>2.5 release</b> — better moderation tools, an
          upgraded crisis chat, and faster image uploads. Should be back in
          about <em>20 minutes</em>.
        </p>
        ...
        <p className={styles.meta}>
          Follow along on{" "}
          <a href="https://status.queerpulse.app">status.queerpulse.app</a> · we
          post a public retrospective every time. <br />
          Built by humans in Lisbon, who'd rather we ship slowly than break
          crisis chat.
        </p>
      </div>
    </div>
