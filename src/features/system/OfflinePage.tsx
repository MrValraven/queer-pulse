  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.card}>
        ...
        <h1 className={styles.h1}>You're <em>offline.</em></h1>
        <p className={styles.lead}>
          No signal, or our servers can't be reached. <b>Don't worry</b> — your gathering RSVPs,
          your saved safe-spaces map, and your QR ticket are still here on this device.
        </p>

        <div className={styles.cached}>
          <h3 className={styles.cachedTitle}>Available offline · cached on your device</h3>
