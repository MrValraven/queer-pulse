  ...
  '52': {
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          { label: 'July gatherings calendar', meta: '11 events · Lisbon & Porto' },
          { label: 'Café Beirão back-room schedule', meta: 'Thursdays · 19:00' },
        ],
      },
      {
        kicker: 'Trans Hub',
        ...
        links: [{ label: 'The updated vetted-providers list', meta: '47 names · re-checked' }],
      },
      {
        ...
        links: [{ label: 'Read the cover story', meta: 'Issue 09 · ~ 18 min full' }],
      },
    ],
    signoff: {
    ...
    sections: [
      {
        ...
        links: [{ label: 'March schedule & meeting points', meta: 'Sat · 16:00 start' }],
      },
      {
        kicker: 'We need you',
        heading: (
        ...
        links: [{ label: 'Sign up as a legal observer', meta: '12 spots · training Wed' }],
      },
      {
        kicker: 'Open call',
        ...
        links: [{ label: 'Apply for a 2026 micro-grant', meta: 'Up to €1,500 · closes Jul' }],
      },
    ],
    signoff: {
      from: 'The QueerPulse team',
    ...
    sections: [
      {
        ...
        links: [{ label: 'The two-year retrospective', meta: '60 → 8,400 subscribers' }],
      },
      {
    ...
    sections: [
      {
        ...
        links: [{ label: 'Open the vetted-providers list', meta: '47 names · members only' }],
      },
      {
