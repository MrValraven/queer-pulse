...
export const YEARS: Year[] = [
  ...
  },
  {
    ...
    rows: [
      { stream: 'dispatch', num: '12', numLabel: 'Dispatch', title: <>One year in. <em>What we got wrong.</em></>, dek: 'An honest accounting of the missteps, the rooms we got right, and a budget breakdown nobody asked for.', date: '20 Dec 2024', streamMeta: 'Community', opens: '5.1k', rate: 'opens · 66%' },
      { stream: 'long', num: '06', numLabel: 'Long', title: <>The Lisbon we built <em>by accident.</em></>, dek: 'How a WhatsApp group of nine became a network of thousands, told by the people who were there on night one.', date: '14 Dec 2024', streamMeta: 'Long reads', opens: '1.3k', rate: 'opens · 70%' },
      { stream: 'dispatch', num: '11', numLabel: 'Dispatch', title: <>Winter mutual aid <em>is open.</em></>, dek: 'The warm-clothing drive, the emergency fund, and how to ask without shame.', date: '1 Dec 2024', streamMeta: 'Community', opens: '4.9k', rate: 'opens · 61%' },
      { stream: 'trans', num: '02', numLabel: 'Trans Hub', title: <>Starting the bulletin.</>, dek: 'Why we split the Trans Hub into its own monthly, and what it will (and will not) carry.', date: '18 Nov 2024', streamMeta: 'Trans Hub', opens: '0.9k', rate: 'opens · 81%' },
      { stream: 'dispatch', num: '08', numLabel: 'Dispatch', title: <>The first hundred members.</>, dek: 'A welcome to everyone vouched in this autumn, plus the gatherings that filled up fastest.', date: '6 Oct 2024', streamMeta: 'Community', opens: '3.2k', rate: 'opens · 64%' },
      { stream: 'dispatch', num: '01', numLabel: 'Dispatch', title: <>Hello. <em>This is the first one.</em></>, dek: 'What this newsletter is for, who it is by, and a promise to keep it human.', date: '12 Jul 2024', streamMeta: 'Community', opens: '0.4k', rate: 'opens · 88%' },
    ],
  },
]
...
export const LATEST: Record<Stream | 'all', LatestIssue> = {
  all: {
    ...
    title: <>The summer slowdown <em>edition.</em></>,
  ...
  long: {
    ...
    title: <>Five things I learned <em>navigating Lisbon's trans health system.</em></>,
  ...
  trans: {
    ...
    title: <>The 2026 vetted-providers list — <em>refreshed.</em></>,
