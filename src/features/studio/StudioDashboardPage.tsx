...
const BARS = [32, 42, 38, 55, 48, 62, 58, 68, 72, 65, 78, 60, 54, 96]
        ...
        <div className={s.col}>
          <div className={s.card}>
            ...
            <div className={s.quickList}>
              <Link to="/studio/upload" className={s.quickItem}>
              ...
              <Link to="/studio" className={s.quickItem}>
                <span className={s.quickIc}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
              ...
              <Link to="/studio/payouts" className={s.quickItem}>
                <span className={s.quickIc}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
