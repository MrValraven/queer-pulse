...
export const coverImage = 'https://images.unsplash.com/photo-1527261834078-9b37d35a4a32?q=80&w=600&auto=format&fit=crop'
...
export const SET: LiveSetRow[] = [
  ...
  { n: '5', pre: 'Cantiga para a ', em: 'vizinha', who: 'Coro de Outubro · played 21:16 → 21:22', pay: '€0.05 to Coro', tm: '6:08', state: 'played', tint: 'plum', image: 'https://images.unsplash.com/photo-1496698161505-d1703dbcab63?q=80&w=800&auto=format&fit=crop' },
  { n: '6', pre: 'Carta para a ', em: 'santa', who: 'Mariana Sol · playing now · 1:42 / 4:18', payNote: 'paying now', pay: '€0.05 to Mariana', tm: '4:18', state: 'now', tint: 'coral', image: 'https://images.unsplash.com/photo-1516280440614-37939bbacd81?q=80&w=600&auto=format&fit=crop' },
  { n: '7', pre: 'Pedro on the ', em: '25', who: 'Pedro Limão · up next · starts in 2:36', payEm: 'queued by Sara', tm: '4:20', state: 'upnext', tint: 'jade', image: 'https://images.unsplash.com/photo-1499364615650-ec38552f4f34?q=80&w=800&auto=format&fit=crop' },
  { n: '8', pre: 'Mother, ', em: 'weather', who: 'Yuki Tanaka · planned, may rotate', pay: '€0.05 / play', tm: '7:14', state: 'queued', tint: 'plum', image: 'https://images.unsplash.com/photo-1502056618377-f15b18d813b7?q=80&w=800&auto=format&fit=crop' },
]
