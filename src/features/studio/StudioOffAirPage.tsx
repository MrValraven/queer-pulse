      ...
      <section className={styles.offairHero}>
        <div className={styles.offairInner}>
          ...
          <p className={styles.signoff}>
            "We played fourteen songs and paid fourteen people. Go to sleep —
            the catalogue stays open, and we'll be back when the kettle's on."
          ...
          <div className={studioStyles.rowGrid}>
            {OFF_AIR_LIBRARY.map((item, i) => (
              ...
              >
                ...
                {item.curator && (
                  <div style={{ fontSize: 12, color: "rgba(247,243,238,.5)" }}>
                    {item.curator}
                  </div>
                )}
                <h4
                ...
                <div style={{ fontSize: 12, color: "rgba(247,243,238,.4)" }}>
                  {item.meta}
                </div>
                {item.pay && (
                  <div style={{ fontSize: 12, color: "rgba(247,243,238,.4)" }}>
