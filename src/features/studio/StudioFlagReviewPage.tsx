                        ...
                        {f.unclaimed ? (
                          <>
                            ...
                            <button
                              ...
                              onClick={() =>
                                resolve(f.id, "corrected", "Lineup corrected")
                              }
                            >
                              Correct lineup
                            </button>
                          ...
                          <>
                            ...
                            <button
                              className={`${s.bt} ${s.btUphold}`}
                              onClick={() =>
                                resolve(f.id, "held", "Held until corrected")
                              }
                            >
                              Hold until fixed
                            </button>
