      ...
      <div className={s.callTop}>
        <div className={s.callCur}>
          ...
          <div>
            ...
            <div
              className={`${s.skel}`}
              style={{ width: 64, height: 10, marginTop: 7 }}
            />
          </div>
        </div>
        <div className={s.callMain}>
          <div
            className={`${s.skel}`}
            style={{ width: 110, height: 18, borderRadius: 999 }}
          />
          <div
            className={`${s.skel}`}
            style={{ width: "70%", height: 20, marginTop: 12 }}
          />
          <div
            className={`${s.skel}`}
            style={{ width: "95%", height: 13, marginTop: 12 }}
          />
          <div
            className={`${s.skel}`}
            style={{ width: "85%", height: 13, marginTop: 7 }}
          />
        </div>
        <div className={s.callAmt}>
          ...
          <div
            className={`${s.skel}`}
            style={{ width: 32, height: 10, marginTop: 7 }}
          />
        </div>
      </div>
    </div>
