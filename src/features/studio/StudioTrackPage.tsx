      ...
      <section className={ss.hero} style={{ padding: "24px 0 32px" }}>
        <div className={ss.heroInner}>
          ...
          <div className={ss.heroInfo}>
            <div className={ss.eb}>
              <span className={ss.live} /> Track 6 of 11 · playing now in the
              set
            </div>
            <h1>
            ...
            <div className={ss.heroActions}>
              ...
              <button className={ss.tip} onClick={() => setTipOpen(true)}>
                <FiHeart /> Tip €2
              </button>
            </div>
      ...
      <div className={t.body}>
        <div className={t.lyrCard}>
          ...
          <div className={t.lyrFoot}>
            <span>
              Translated by Helena P. · approved by the artist · Apr 2026
            </span>
