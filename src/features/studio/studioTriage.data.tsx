...
export const SUBS: Sub[] = [
  {
    ...
    who: (
      <>
        Renato V. · Porto · <em>first submission</em>
      </>
    ),
    badges: [
      { label: "First submission", cls: "first" },
      { label: "1 track" },
      { label: "Lead sheet attached" },
      { label: "PT lyrics" },
      { label: "Claimed · you", cls: "claimed" },
    ],
    day: "Day 9",
    of: true,
    ...
    meta: [
      ...
      "FLAC · 24/48 · 38.4 MB",
      "−14.1 LUFS · ready",
      "Lyric translation requested · EN",
    ],
    image:
  ...
  },
  {
    ...
    titlePre: "Coro de ",
    titleEm: "Porto",
    who: "Eight voices · Porto · cover artists from the choir collective",
    badges: [
      { label: "First submission", cls: "first" },
      { label: "4 tracks · EP" },
      { label: "SATB scores" },
    ...
    meta: [
      ...
      "FLAC · 24/96 · 412 MB",
      "−15.2 LUFS · ready",
      "Translations attached: PT, EN",
    ],
    image:
      "https://images.unsplash.com/photo-1732719674511-e94d37e7d1c5?q=80&w=800&auto=format&fit=crop",
  },
  {
    tint: "jade",
    titlePre: "Tomboy · ",
    ...
    badges: [
      { label: "Mix · 38m" },
      { label: "Sapatão-sci-fi" },
      { label: "Cue sheet attached" },
      { label: "BR house" },
    ],
    day: "Day 4",
    of: true,
    ...
    image:
      "https://images.unsplash.com/photo-1736882178500-f99bbe22d77d?q=80&w=800&auto=format&fit=crop",
  },
  {
    tint: "coral",
    titlePre: "Ainda",
    who: (
      <>
        Helena P. · Aveiro · <em>first single, also our translator</em>
      </>
    ),
    badges: [
      { label: "First submission", cls: "first" },
    ...
    meta: [
      ...
      "WAV · 24/48 · 23.4 MB",
      "−13.8 LUFS · ready",
      "Note from Mariana: vouches",
    ],
    image:
      "https://images.unsplash.com/photo-1740508905511-bccff9d04f7d?q=80&w=800&auto=format&fit=crop",
  },
];
...
export const WF = [
  40, 65, 55, 80, 60, 50, 72, 58, 46, 88, 62, 54, 80, 42, 68, 75, 48, 60, 84,
  50, 62, 38, 72, 55, 48, 62, 38, 55,
];
