            ...
            <div key={mem.em + mem.seat} className={s.cur}>
              <div className={s.curHead}>
                <div className={s.curAv}>
                  <ImageSlot tint={mem.tint} width={54} height={54} radius={9999} shape="circle" placeholder="" initials={mem.pre[0] + mem.em[0]} />
                </div>
                <div>
              ...
              <div className={s.curFoot}>
                ...
                <Link to="/studio/album" className={s.bt}>
                  Their slate →
                </Link>
              </div>
            </div>
