...
export const RESULTS: Result[] = [
  {
    pre: "Mariana ",
    em: "Sol",
    meta: "Artist · 11 tracks · Lisbon",
    kind: "Artists",
    to: "/studio/artist",
    tint: "coral",
    image:
      "https://images.unsplash.com/photo-1635169852185-37f90ac07189?q=80&w=400&auto=format&fit=crop",
  },
  {
    pre: "Cidade dos ",
    em: "santos",
