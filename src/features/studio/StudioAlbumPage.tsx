        ...
        <div>
          ...
          {tab === "Liner notes" && (
            <div className={styles.prose}>
              <p>
                This is a record I have been writing in pieces since I was
                nineteen. In Sintra, mostly. Some of it in Beja, where my mother
                is from and where the saint of the title lived, briefly, before
                she went to Lisbon to be martyred.
              </p>
              <p>
                I wrote eleven songs and recorded ten in a kitchen in Anjos with
                one cellist, one engineer, and an upright piano that belonged to
                my landlady. Track nine has my grandmother in it — a field
                recording I made of her humming, before she knew I was
                recording.
              </p>
              <p>
                If you can pay, buy the record at €8 and{" "}
                <em>€6.40 of that comes to me directly.</em> If you can't, play
                it as many times as you like and €0.05 still finds me each time.
          ...
          {tab === "Credits" && (
            <div className={styles.prose}>
              ...
              <p>
                João Anjos — cello (2, 7, 11) · Coro de Outubro — choir (4) ·
                Inês T. — percussion (7)
              </p>
              <p>
        ...
        <div className={styles.sideCol}>
          <div className={styles.buyCard}>
            ...
            <div className={styles.splitHint}>
              If you buy at €8 — <em>€6.40 to Mariana</em>, €0.80 to the
              solidarity fund, €0.80 to the platform, processing absorbed.
            </div>
          </div>
