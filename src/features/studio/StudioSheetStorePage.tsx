...
const SPECS = ['Voice + piano', 'Key · D minor', 'PT lyrics', '4 pages', 'PDF · A4']
const SPLIT = [
...
const ALSO = [
  { pre: 'A ', em: 'Beja', who: 'Mariana Sol · piano', tag: '€1', tint: 'plum' as const },
  { pre: 'Cantiga para a ', em: 'vizinha', who: 'Coro de Outubro · SATB', tag: '€1', tint: 'jade' as const },
  { pre: 'The first ', em: 'Sunday', who: 'Helena P. · lead sheet', tag: 'Free read', tint: 'coral' as const },
  { pre: 'Salt water, ', em: 'slowly', who: 'Akin Diallo · guitar tab', tag: '€1', tint: 'plum' as const },
]
