      ...
      <div className={s.wrap}>
        ...
        <div className={s.bal}>
          <div className={s.balMain}>
            ...
            >
              Healthy: roughly four months of current disbursement. Anything
              above six months' runway rolls into the next quarterly grant round
              by council vote.
            </div>
          </div>
        ...
        <section className={s.sec}>
          ...
          <div className={s.flow2}>
            ...
            <div className={s.flowCol}>
              <h3>
                <span style={{ color: "var(--accent)" }}>▲</span> Money out ·
                this quarter
              </h3>
              {OUT.map((f, i) => (
                <div key={i} className={s.flowItem}>
        ...
        <section className={s.sec}>
          ...
          <div className={s.secDek}>
            Every payment from the fund is logged here with a name (where
            consent is given) and a reason. <em>No black box.</em>
          </div>
          {loading
