  ...
  return (
    <div className={s.payRow}>
      <div className={s.payDate}>
        <div className={s.skel} style={{ width: 36, height: 26, margin: '0 auto' }} />
        <div className={s.skel} style={{ width: 26, height: 9, margin: '7px auto 0' }} />
      </div>
      <div>
        <div className={s.skel} style={{ width: '55%', height: 14 }} />
        <div className={s.skel} style={{ width: '38%', height: 11, marginTop: 7 }} />
      </div>
      <div className={s.skel} style={{ width: 64, height: 18 }} />
      <div className={s.skel} style={{ width: 52, height: 20, borderRadius: 999 }} />
    </div>
  )
}
