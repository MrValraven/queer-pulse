...
function RadioCards({
  ...
  opts: { key: RadioKey; label: string; badge?: string; sub: string }[];
  active: RadioKey;
  onChange: (k: RadioKey) => void;
}) {
  return (
    ...
    <StudioShell>
      ...
      <div className={s.wrap}>
        <section className={s.sec}>
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                What we cache when you save a track for offline (sustainers
                only).
              </p>
            </div>
            <Seg opts={["AAC", "FLAC"]} active={dlQ} onChange={setDlQ} />
          </div>
          <div className={s.opt}>
            <div className={s.ot}>
              <h4>Normalise loudness</h4>
              <p>
                Even out volume across tracks and sets. <em>Off</em> if you want
                the artist's intended dynamics.
              </p>
            </div>
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                Only applies inside DJ sets and live rooms, never on album
                playback.
              </p>
            </div>
        ...
        <section className={s.sec}>
          ...
          <p className={s.secDek}>
            The short version: almost nothing, by default. We never sell, share,
            or train on what you play. Aggregate plays feed the public ledger —
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                Off by default — nothing about what you played leaves your
                browser. Turn on for a private, deletable record only you can
                see.
              </p>
            </div>
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                Saves and follows move between devices. Without this they live
                on this device only.
              </p>
            </div>
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                Each tip mints a receipt showing the split — no personal data.
                On, it can be shared as a "look what the room paid this artist"
                card.
              </p>
            </div>
        ...
        <section className={s.sec}>
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                Show lyrics in the original, or a community translation where
                one exists.
              </p>
            </div>
        ...
        <section className={s.sec}>
          ...
          <p className={s.secDek}>
            What the one-tap tip pill sends. 100% reaches the artist — there is
            no platform cut on tips, ever.
          </p>
          <div className={s.opt}>
            <div className={s.ot}>
          ...
          <div className={s.opt}>
            <div className={s.ot}>
              ...
              <p>
                A €3.40 album becomes €4, the €0.60 going to the artist as a
                tip.
              </p>
            </div>
        ...
        <section className={s.sec}>
          ...
          <p className={s.secDek}>
            These don't ask twice and don't show a modal. We mean it: leaving
            should be as easy as arriving.
          </p>
          <div className={s.danger}>
            ...
            <div className={s.opt}>
              <div className={s.ot}>
                ...
                <p className={s.eraseNote}>
                  A JSON of your saves, tips, receipts and settings — emailed
                  within the hour.
                </p>
              </div>
              <button
