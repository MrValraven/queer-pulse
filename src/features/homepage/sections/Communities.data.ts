...
export const spotlightCommunities: SpotlightCommunity[] = [
  ...
  },
  {
    ...
    railName: "Coming-Out Support",
    sub: "Private & moderated",
    desc: "A quiet, private space. No member counts, no faces on show, no rituals posted in public — just a steady, moderated room that opens gently, at your own pace, when you're ready. Safety and discretion come first here.",
    access: "private",
    founded: 2020,
    members: 0,
    activity: 0,
