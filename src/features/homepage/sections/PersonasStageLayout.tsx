...
/** The personas section as one composition: the pitch and its action share
 * a header row, then a single stage panel lets a visitor pick a side of
...
export function PersonasStageLayout({
  ...
  return (
    <div className={`wrap ${styles.layout}`}>
      ...
      <Reveal as="p" className={styles.elsewhere} delay={200}>
