...
export const AUDIT_ENTRIES: AuditEntry[] = [
  ...
  },
  {
    ...
    type: "Restricted",
    subject: "@p.costa",
    reason: "Second misgendering after a warning. Restricted, pointed to the pronoun guide.",
    when: "11 Jun",
    range: "This quarter",
  ...
  },
  {
    ...
    type: "Appeal",
    subject: "@studio.vera",
    reason: "\"Spam\" link was a mutual-aid fund. Warning removed, member thanked.",
    when: "10 Jun",
    range: "This quarter",
  ...
  },
  {
    ...
    type: "Dismissed",
    subject: "report #4360",
    reason: "Heated but not abusive. No code-of-care breach. Both parties messaged.",
    when: "2 Jun",
    range: "This quarter",
...
export const AUDIT_RANGE_OPTIONS = ["All time", "Today", "This week", "This quarter"]
...
export const CARE_DIFF: DiffLine[] = [
  { kind: "ctx", text: "We act quickly on harassment, threats and hate speech." },
  {
    kind: "removed",
