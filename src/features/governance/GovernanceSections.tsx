  ...
  return (
    <Reveal as="section" className={styles.section} id="health">
      ...
      <div className={styles.prose}>
        <p>
          Twelve reports were filed this quarter. All were reviewed within 48
          hours. Three resulted in member removal (repeated Code of Care
          violations after warning). Eight were resolved with direct
          communication and no formal action.
        </p>
        <p>
          Two moderation appeals were filed. One was upheld — we had made the
          wrong call and reversed it. We publish this because transparency is
...
export function ModerationSection() {
  return (
    <Reveal as="section" className={styles.section} id="moderation">
      ...
      <div className={styles.prose}>
        <p>
          QueerPulse is moderated by a small team of members who agreed to take
          on this role. They are accountable to the advisory council, and their
      ...
      <div className={styles.prose} style={{ marginTop: 16 }}>
        <p>
          <strong>What we won't tolerate:</strong> Any behaviour that makes a
          member feel unsafe or unwelcome on the basis of their identity, body,
          or background. Harassment of any form. Commercial solicitation without
          permission. Violation of another member's privacy.
        </p>
      </div>
    </Reveal>
  );
...
export function CouncilSection() {
  return (
    <Reveal as="section" className={styles.section} id="council">
      ...
      <div className={styles.prose}>
        <p>
          The advisory council reviews moderation appeals, proposes platform
          changes, and serves as an accountability layer. Members serve one-year
          terms and can be removed by a two-thirds community vote.
        </p>
      </div>
...
export function FinancesSection() {
  return (
    <Reveal as="section" className={styles.section} id="finances">
      ...
      <div className={styles.prose}>
        <p>
          We publish our finances every quarter. QueerPulse is funded by the
          people who use it, and those people deserve to know exactly how money
          is raised and spent. No investor interests. No growth targets. No exit
          plan.
        </p>
      </div>
      <div
      ...
      <div className={styles.prose} style={{ marginTop: 28 }}>
        <p>
          <strong>What we do with the surplus.</strong> Quarterly surpluses go
          into an operational reserve. Our target is three months of running
          costs — ~€12,450.
        </p>
        ...
        <p className={styles.reserveCap}>
          Operational reserve: €4,380 of €12,450 target
        </p>
        <p>
          Once we reach the target, additional surplus is redirected in full to
          the community micro-grants fund. We do not accumulate capital. We
          redistribute it.
        </p>
      </div>
      <div className={styles.partnerRow}>
        ...
        <div className={styles.partnerBody}>
          €400 · Restricted to the Mental Health Fund. No editorial, governance,
          or platform influence.
        </div>
      </div>
      <div className={styles.partnerRow}>
        <div className={styles.partnerName}>ILGA Portugal</div>
        <div className={styles.partnerBody}>
          €200 · Restricted to community events. No editorial, governance, or
          platform influence.
        </div>
      </div>
      <div className={styles.prose}>
        <p>
          We do not accept funding from corporations, brands, or government
          bodies whose interests could conflict with community autonomy. If that
          ever changes, we'll say so here first — and the community will vote on
          it.
        </p>
      </div>
    </Reveal>
...
export function RaiseSection() {
  ...
  return (
    <Reveal as="section" className={styles.section} id="raise">
      ...
      <div className={styles.prose}>
        <p>
          Use this form to report a member, a piece of content, a platform
          decision, or a concern about how QueerPulse is run. All submissions
          are confidential and reviewed within 48 hours.
        </p>
      </div>
      <div className={styles.raiseCard}>
        <div className={styles.rcTitle}>Submit a concern</div>
        <p className={styles.rcText}>
          Your identity is kept confidential. You'll receive a confirmation
          within 48 hours and an update when the matter is resolved.
        </p>
        <form
        ...
        >
          ...
          <textarea
            ...
            placeholder="Describe what happened, or what's wrong, in as much detail as you're comfortable with…"
          />
          <input
            className={styles.rcInput}
            type="email"
            placeholder="Your email (so we can update you)"
          />
