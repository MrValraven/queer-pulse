...
export const ORG_TIERS_DEMO: OrgTier[] = [
  {
    ...
    dek: "For workplaces that want to back the community materially, beyond a logo.",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      "A sustained, year-long build",
      "Illustrative tier: terms are sample values",
    ],
    footnote: "Proposed and mutually agreed. We say no often.",
    featured: true,
