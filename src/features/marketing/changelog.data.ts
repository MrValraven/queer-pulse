...
export const CHANGELOG_DATA: ChangelogYear[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        category: "improvement",
        date: "1 Sep 2026",
        ...entryKeys("tag-filters-show-how-many-communities-are-behind-them"),
        tag: {
          labelKey: "marketing:changelog.tag.communities",
          to: routes.communities,
        },
      ...
      {
        id: "housing-filters-fold-away-until-you-need-them",
        category: "improvement",
        date: "1 Sep 2026",
        ...entryKeys("housing-filters-fold-away-until-you-need-them"),
        tag: {
      ...
      {
        id: "empty-category-filters-can-no-longer-be-picked",
        category: "improvement",
        date: "1 Sep 2026",
        ...entryKeys("empty-category-filters-can-no-longer-be-picked"),
      },
      {
        id: "the-app-follows-your-browsers-text-size",
        category: "improvement",
        date: "1 Sep 2026",
        ...entryKeys("the-app-follows-your-browsers-text-size"),
      },
      {
        id: "faint-outlines-are-visible-again-in-dark-mode",
        category: "fix",
        date: "1 Sep 2026",
        ...entryKeys("faint-outlines-are-visible-again-in-dark-mode"),
      },
      {
        id: "deep-links-no-longer-flash-the-homepage",
        category: "fix",
        date: "1 Sep 2026",
        ...entryKeys("deep-links-no-longer-flash-the-homepage"),
      },
      {
        id: "report-one-photo-not-the-whole-gathering",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("report-one-photo-not-the-whole-gathering"),
      },
      {
        id: "report-one-landlord-warning",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("report-one-landlord-warning"),
      },
      {
        id: "your-landlord-warning-outlives-your-account",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("your-landlord-warning-outlives-your-account"),
      },
      {
        id: "correct-a-review-until-it-goes-public",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("correct-a-review-until-it-goes-public"),
      },
      {
        id: "take-down-your-flatmate-profile",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("take-down-your-flatmate-profile"),
      },
      {
        id: "message-a-business-without-leaving",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("message-a-business-without-leaving"),
      },
      {
        id: "remove-a-photo-from-a-gathering-album",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("remove-a-photo-from-a-gathering-album"),
      },
      {
        id: "your-own-jobs-and-a-way-to-correct-them",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("your-own-jobs-and-a-way-to-correct-them"),
      },
      {
        id: "your-own-swap-board",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("your-own-swap-board"),
      },
      {
        id: "one-place-for-everything-you-have-sent",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("one-place-for-everything-you-have-sent"),
      },
      {
        id: "employers-and-listers-can-answer-a-review",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("employers-and-listers-can-answer-a-review"),
      },
      {
        id: "register-interest-in-a-commission",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("register-interest-in-a-commission"),
      },
      {
        id: "the-nav-says-what-is-still-being-built",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("the-nav-says-what-is-still-being-built"),
      },
      {
        id: "search-stops-offering-what-it-cannot-find",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("search-stops-offering-what-it-cannot-find"),
      },
      {
        id: "a-hidden-review-stays-hidden",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("a-hidden-review-stays-hidden"),
      },
      {
        id: "erasing-your-account-keeps-what-others-rely-on",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("erasing-your-account-keeps-what-others-rely-on"),
      },
      {
        id: "an-anonymous-owner-stays-anonymous",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("an-anonymous-owner-stays-anonymous"),
      },
      {
        id: "an-outage-no-longer-looks-like-an-empty-page",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("an-outage-no-longer-looks-like-an-empty-page"),
      },
      {
        id: "onboarding-never-guesses-your-visibility",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("onboarding-never-guesses-your-visibility"),
      },
      {
        id: "reporting-a-person-says-what-actually-happens",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("reporting-a-person-says-what-actually-happens"),
      },
      {
        id: "mod-tools-bans-read-in-words-again",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("mod-tools-bans-read-in-words-again"),
      },
      {
        id: "offline-no-longer-clears-what-youre-typing",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("offline-no-longer-clears-what-youre-typing"),
      },
      {
        id: "back-button-leaves-an-editor-cleanly",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("back-button-leaves-an-editor-cleanly"),
      },
      {
        id: "signed-out-tab-bar-is-whole-again",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("signed-out-tab-bar-is-whole-again"),
      },
      {
        id: "installing-the-app-takes-one-tap-again",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("installing-the-app-takes-one-tap-again"),
      },
      {
        id: "notification-taps-land-on-the-right-screen",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("notification-taps-land-on-the-right-screen"),
      },
      {
        id: "the-installed-app-keeps-itself-current",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("the-installed-app-keeps-itself-current"),
      },
      {
        id: "pausing-your-account-now-pauses-it",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("pausing-your-account-now-pauses-it"),
      },
      {
        id: "pause-and-delete-live-in-one-place",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("pause-and-delete-live-in-one-place"),
        tag: {
      ...
      {
        id: "content-settings-actually-filter-your-feed",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("content-settings-actually-filter-your-feed"),
        tag: {
          labelKey: "marketing:changelog.tag.settings",
          to: routes.settings,
        },
      ...
      {
        id: "you-can-stop-being-suggested-to-strangers",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("you-can-stop-being-suggested-to-strangers"),
        tag: {
          labelKey: "marketing:changelog.tag.settings",
          to: routes.settings,
        },
      ...
      {
        id: "the-activity-switch-is-one-switch",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("the-activity-switch-is-one-switch"),
      },
      {
        id: "answer-a-connection-request-where-you-read-it",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("answer-a-connection-request-where-you-read-it"),
      },
      {
        id: "a-gathering-tells-you-when-it-is-nearly-full",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("a-gathering-tells-you-when-it-is-nearly-full"),
        tag: {
          labelKey: "marketing:changelog.tag.settings",
          to: routes.settings,
        },
      ...
      {
        id: "blocked-and-muted-in-one-place",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("blocked-and-muted-in-one-place"),
      },
      {
        id: "your-join-request-shows-its-deadline",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("your-join-request-shows-its-deadline"),
      },
      {
        id: "losing-your-google-account-is-no-longer-final",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("losing-your-google-account-is-no-longer-final"),
      },
      {
        id: "vouching-has-a-front-door",
        category: "improvement",
        date: "31 Aug 2026",
      ...
      },
      {
        ...
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("recognition-counts-people-not-volume"),
      },
      {
        id: "declining-a-connection-request-now-holds",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("declining-a-connection-request-now-holds"),
      },
      {
        id: "you-can-report-a-whole-community",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("you-can-report-a-whole-community"),
        tag: { labelKey: "marketing:changelog.tag.report", to: routes.report },
      },
      {
        id: "housing-reports-can-reach-the-urgent-queue",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("housing-reports-can-reach-the-urgent-queue"),
      },
      {
        id: "hiding-a-housing-profile-now-hides-it",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("hiding-a-housing-profile-now-hides-it"),
      },
      {
        id: "you-choose-whether-a-report-is-anonymous",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("you-choose-whether-a-report-is-anonymous"),
      },
      {
        id: "barring-someone-forever-needs-two-people",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("barring-someone-forever-needs-two-people"),
      },
      {
        id: "a-community-can-read-its-own-history",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("a-community-can-read-its-own-history"),
      },
      {
        id: "we-now-publish-government-data-requests",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("we-now-publish-government-data-requests"),
        tag: {
      ...
      {
        id: "dark-mode-gives-feedback-again",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("dark-mode-gives-feedback-again"),
      },
      {
        id: "persona-pages-had-text-you-could-barely-read",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("persona-pages-had-text-you-could-barely-read"),
      },
      {
        id: "things-that-were-meant-to-move-now-move",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("things-that-were-meant-to-move-now-move"),
      },
      {
        id: "your-identity-details-now-reach-only-real-matches",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("your-identity-details-now-reach-only-real-matches"),
        tag: {
          labelKey: "marketing:changelog.tag.housing",
          to: routes.housing,
        },
      ...
      {
        id: "review-queues-no-longer-hide-people-who-are-waiting",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("review-queues-no-longer-hide-people-who-are-waiting"),
        tag: {
          labelKey: "marketing:changelog.tag.communities",
          to: routes.communities,
        },
      ...
      {
        id: "press-kit-photos-can-be-uploaded-again",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("press-kit-photos-can-be-uploaded-again"),
        tag: {
          labelKey: "marketing:changelog.tag.pressKit",
          to: routes.pressKit,
        },
      ...
      {
        id: "a-mistyped-address-says-not-found",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("a-mistyped-address-says-not-found"),
      },
      {
        id: "signing-a-device-out-now-signs-it-out",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("signing-a-device-out-now-signs-it-out"),
        tag: {
      ...
      {
        id: "names-that-speak-for-queerpulse-are-reserved",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("names-that-speak-for-queerpulse-are-reserved"),
      },
      {
        id: "badges-for-the-people-who-run-each-part",
        category: "feature",
        date: "31 Aug 2026",
        ...entryKeys("badges-for-the-people-who-run-each-part"),
      },
      {
        id: "staying-signed-in-on-shared-wifi",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("staying-signed-in-on-shared-wifi"),
      },
      {
        id: "clearer-keyboard-focus-across-the-platform",
        category: "improvement",
        date: "31 Aug 2026",
        ...entryKeys("clearer-keyboard-focus-across-the-platform"),
      },
      {
        id: "screen-readers-follow-along-in-more-places",
        category: "fix",
        date: "31 Aug 2026",
        ...entryKeys("screen-readers-follow-along-in-more-places"),
      },
      {
      ...
      },
      {
        ...
        category: "improvement",
        date: "30 Aug 2026",
        ...entryKeys("every-neighbourhood-says-how-many-people-are-there"),
        tag: {
          labelKey: "marketing:changelog.tag.directory",
          to: routes.directory,
        },
      ...
      {
        id: "a-persona-leads-with-its-name",
        category: "improvement",
        date: "29 Aug 2026",
        ...entryKeys("a-persona-leads-with-its-name"),
        tag: {
          labelKey: "marketing:changelog.tag.personas",
          to: routes.subprofiles,
        },
      ...
      {
        id: "pages-open-the-moment-you-click-them",
        category: "improvement",
        date: "29 Aug 2026",
        ...entryKeys("pages-open-the-moment-you-click-them"),
      },
      {
        id: "people-you-might-know-swipes-sideways-on-a-phone",
        category: "improvement",
        date: "29 Aug 2026",
        ...entryKeys("people-you-might-know-swipes-sideways-on-a-phone"),
        tag: {
      ...
      {
        id: "card-art-counted-as-in-use",
        category: "fix",
        date: "23 Aug 2026",
        ...entryKeys("card-art-counted-as-in-use"),
      },
      {
