...
/**
 * The basics field body: name, categories, neighbourhood, ownership badge,
 * price band and the one-line blurb.
 *
...
export function BasicsFields({
  ...
  const coords =
    draft.latitude !== null && draft.longitude !== null
      ...
      : null;
  const duplicates = useSimilarListings(draft.name, coords, editRef);
