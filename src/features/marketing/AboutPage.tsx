  ...
  return (
    <PageShell>
      <PageHero
        ...
        title={<>Built in Lisbon. <em>Owned by us.</em></>}
      ...
      <section className={m.section}>
        <div className="wrap">
          <Reveal as="div" className={m.sectionEyebrow}>Why this exists</Reveal>
          <div className={s.originGrid}>
            ...
            <Reveal className={s.pull} delay={80}>{PULL_QUOTE}</Reveal>
          </div>
        </div>
      </section>
      ...
      <section className={m.section} style={{ paddingTop: 0 }}>
        <div className="wrap">
          <Reveal as="div" className={m.sectionEyebrow}>The difference</Reveal>
          <Reveal as="h2" className={m.sectionTitle} delay={60}>
      ...
      <section className={m.section} style={{ paddingTop: 0 }}>
        <div className="wrap">
          <Reveal as="div" className={m.sectionEyebrow}>What we believe</Reveal>
          <Reveal as="h2" className={m.sectionTitle} delay={60}>
            Not principles. <em>Commitments.</em>
          </Reveal>
          <div className={s.valuesGrid}>
            {VALUES.map((v, i) => (
              <Reveal key={v.title} className={s.valCard} delay={Math.min(i, 8) * 60}>
      ...
      <section className={m.section} style={{ paddingTop: 0 }}>
        <div className="wrap">
          <Reveal as="div" className={m.sectionEyebrow}>Who's behind this</Reveal>
          <div className={s.originGrid}>
            <div>
              <Reveal as="h2" className={m.sectionTitle} delay={60}>
            ...
            <Reveal className={s.pull} delay={80}>{WHO_PULL}</Reveal>
          </div>
      ...
      <Outro
        title={<>Build the alternative <em>with us.</em></>}
