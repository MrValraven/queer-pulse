    ...
    <article className={styles.body}>
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          ...
          <em>the right ones</em>. We will grow at the pace at which the
          community can absorb new arrivals — vouched-for, welcomed, integrated.
          If that means we are smaller than we could be, we will be smaller than
          we could be.
        </p>
        <p className={styles.p}>
          The other platforms are engineered to keep you scrolling; your
          attention is the product they measure and sell. We sell nothing. There
          are no follower counts, no algorithm choosing what you see, no "for
          you" feed competing for your evening.{" "}
          <strong>
      ...
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          "Verified" is a corporate word. It assumes a centre that can decide
          who you are. We don't. The community decides — together, slowly, and
          with the receipts of in-person time.
        </p>
      </div>
      ...
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          ...
          <strong>
            If we cannot operationally protect each other, we are not a network.
          </strong>
        </p>
        <p className={styles.p}>
          Quick-exit lives in the nav. Crisis chat is one tap. Mercearia Rosa's
          back door opens to Penha de França. None of these are features. They
          are the floor.
        </p>
      </div>
      ...
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          Work moves sideways too. The professional network that was supposed to
          connect us only ever sold us back to recruiters. Here, members hire,
          mentor, commission, and rent from each other — and the value{" "}
          <em>stays with us</em> instead of being skimmed off the top.
        </p>
        <p className={styles.p}>
      ...
      <p className={styles.pull}>
        If you cannot pay, that is information about <em>the world</em>, not
        about you.
      </p>
      ...
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          ...
          — in a city you can walk across in an hour, with venues and chapters
          and a Câmara Municipal — is a network.
        </p>
        <p className={styles.p}>
      ...
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          ...
          speak for every queer person, and no one speaks for us. The forum
          hosts arguments that we expect to remain unresolved. The Assembly
          votes on what cannot be left unresolved.
        </p>
        <p className={styles.p}>
          Moderation is not neutrality. We will remove cruelty. We will not
      ...
      <div className={styles.stanza}>
        ...
        <p className={styles.p}>
          ...
          Manifestos that don't update are gravestones.{" "}
          <em>This one updates.</em>
        </p>
        <p className={styles.p}>
          If you are reading this and something feels off, write to{" "}
          <a href="mailto:manifesto@queerpulse.app">manifesto@queerpulse.app</a>
          . A real person reads every one. We discuss them at the assembly.
        </p>
      </div>
    </article>
  );
    ...
    <section className={styles.sigs}>
      <div className={styles.sigsInner}>
        ...
        <p className={styles.sub}>
          Members sign by clicking once. There's no obligation — many haven't,
          and that's also fine. These are some of the people who have.
        </p>
        ...
        <p className={styles.sigCount}>
          Plus <b>1,836 more</b> · last signed by <b>Filipa Lopes</b>, 14
          minutes ago.
        </p>
      </div>
    </section>
