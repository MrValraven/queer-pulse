...
export type HoursType = 'cafe' | 'restaurant' | 'bar' | 'clinic' | 'shop' | 'gym' | 'gallery' | 'appointment' | 'studio'
...
export interface DirectoryPlace {
  ...
  hoursNote: string
  owner: Owner
  social: { instagram?: string; website?: string; email?: string; phone?: string }
  address: string
...
export const DIRECTORY_PLACES: DirectoryPlace[] = [
  {
    slug: 'atelier-pulso', name: 'Atelier Pulso', cat: 'design', hood: 'Príncipe Real', owned: true, member: 'ines', av: 'AP', tint: C,
    ...
    owner: { name: 'Inês Tavares', initials: 'IT', tint: C, role: 'Founder · designer', bio: 'Designer for cultural institutions and small presses. Believes good design is a form of care.', inQueerPulse: true, first: 'Inês' },
    ...
    reviews: [
      { initials: 'AQ', name: 'André Quintela', tint: J, byline: 'he/him · client', stars: 5, text: 'Inês rebuilt my studio identity and somehow made it feel more like me than my old one did. Patient, fast, honest about what wasn\'t working.', helpful: 12 },
  ...
  {
    slug: 'queer-supper-club', name: 'Queer Supper Club', cat: 'food', hood: 'Mouraria', owned: true, member: 'tomas', av: 'QS', tint: C,
    ...
    tagline: 'Twelve seats, one long table, and the best night out you can have sitting down.',
    ...
    owner: { name: 'Tomás Beto', initials: 'TB', tint: C, role: 'Chef · host', bio: 'Chef and supper-club host. Cooks the way his avó did, for people who need a table.', inQueerPulse: true, first: 'Tomás' },
    social: { instagram: '@queersupperclub', email: 'table@queersupper.pt' },
    address: 'Address shared with ticket · Mouraria',
    upcoming: [
      { when: 'Sat 21 Jun · 20:00', title: 'June dinner — early summer, the market decides' },
      { when: 'Sat 19 Jul · 20:00', title: 'July dinner — stone fruit & the grill' },
    ],
    reviews: [
      { initials: 'CN', name: 'Carla Nogueira', tint: C, byline: 'she/her · regular', stars: 5, text: 'I came alone to my first one terrified and left with three numbers and a full heart. Tomás seats you like he\'s been thinking about it all week.', helpful: 28 },
      { initials: 'KL', name: 'Kai Larsson', tint: J, byline: 'they/them · 2 visits', stars: 5, text: 'The food is genuinely excellent and the room is the point. Best twelve euros-an-hour my social life has ever spent.', helpful: 15 },
    ],
  },
  {
    slug: 'estudio-beatriz-pinto', name: 'Estúdio Beatriz Pinto', cat: 'design', hood: 'Graça', owned: true, member: 'beatriz', av: 'BP', tint: P,
    desc: 'Ceramics studio producing functional pieces with a slow aesthetic. Workshop sessions monthly. Spare desks to share.',
    tagline: 'A slow ceramics studio in Graça — and a couple of spare wheels for the right people.',
    pills: ['Ceramics studio', 'Workshops monthly', '€€', 'Step-free'],
    rating: { score: '4.8', count: 19 },
    gallery: ['The wheels', 'Drying shelves', 'Graça window light', 'Glaze tests'],
    whatItIs: [
    ...
    owner: { name: 'Beatriz Pinto', initials: 'BP', tint: P, role: 'Ceramicist', bio: 'Ceramicist in Graça. Runs the Disabled Queers access list on the side and builds access into everything.', inQueerPulse: true, first: 'Beatriz' },
    ...
    reviews: [
      { initials: 'RV', name: 'Rita Varela', tint: J, byline: 'she/her · workshop', stars: 5, text: 'Did her beginners\' day having never touched clay. Came home with two wonky bowls I use every day and a standing invitation to come back.', helpful: 9 },
  ...
  {
    slug: 'opus-diversus', name: 'Opus Diversus', cat: 'health', hood: 'Intendente', owned: false, av: 'OD', tint: J,
    desc: 'LGBTQ+-affirming mental health support — therapy, peer groups, crisis support. Sliding scale fees. Portuguese and English.',
    tagline: 'Mental health support that doesn\'t make you explain yourself first.',
    pills: ['Mental health', 'Sliding scale', 'PT / EN', 'Wheelchair-accessible'],
    ...
    hoursType: 'clinic', hoursNote: 'Mon–Sat by appointment. Crisis line outside hours.',
    owner: { name: 'The Opus Diversus team', initials: 'OD', tint: J, role: 'Partner organisation', bio: 'A collective practice and a QueerPulse health partner — they also train our peer-support volunteers.', inQueerPulse: false, first: 'the team' },
    social: { instagram: '@opusdiversus', website: 'opusdiversus.pt', email: 'ola@opusdiversus.pt', phone: '+351 21 888 0000' },
    address: 'R. do Benformoso 140 · Intendente',
    upcoming: [{ when: 'Thu 12 Jun · 19:00', title: 'Peer-support drop-in (open)' }],
    reviews: [
      { initials: 'AK', name: 'Anika Kovač', tint: C, byline: 'she/her · client', stars: 5, text: 'First therapist I haven\'t had to educate. We started at the actual problem in session one. Sliding scale made it possible at all.', helpful: 33 },
      { initials: 'JF', name: 'Jonas Ferreira', tint: J, byline: 'he/him · group member', stars: 5, text: 'The Thursday group got me through a hard winter. Held, never rushed, real clinical backup in the room.', helpful: 21 },
    ],
  },
  {
    slug: 'livraria-bertha', name: 'Livraria Bertha', cat: 'culture', hood: 'Príncipe Real', owned: true, av: 'LB', tint: P,
    ...
    tagline: 'The bookshop that keeps the section you came for at the front, not the back.',
    ...
    hoursType: 'shop', hoursNote: 'Open Tue–Sun. Event nights run later.',
    owner: { name: 'Bertha collective', initials: 'LB', tint: P, role: 'Worker co-op', bio: 'Run as a small worker co-operative. Several of the booksellers are QueerPulse members.', inQueerPulse: true, first: 'the booksellers' },
    social: { instagram: '@livrariabertha', website: 'livrariabertha.pt', email: 'ola@livrariabertha.pt' },
    address: 'R. da Imprensa Nacional 48 · Príncipe Real',
    upcoming: [
      { when: 'Fri 13 Jun · 19:00', title: 'Reading — new queer poetry in translation' },
      { when: 'Sun 22 Jun · 17:00', title: 'Book club · "Stone Butch Blues"' },
    ],
    reviews: [
      { initials: 'SC', name: 'Sofia Castaño', tint: P, byline: 'she/her · regular', stars: 5, text: 'I have never left empty-handed and never left poorer in spirit. The recommendations card by the till is a hazard.', helpful: 17 },
      { initials: 'NA', name: 'Nuno Alves', tint: J, byline: 'he/him · 4 visits', stars: 5, text: 'Came for one book, stayed for a launch I didn\'t know was happening, met half a reading group. That\'s Bertha.', helpful: 11 },
    ],
  },
  {
    slug: 'cafe-mouraria-velha', name: 'Café Mouraria Velha', cat: 'food', hood: 'Mouraria', owned: false, av: 'CM', tint: J,
    ...
    gallery: ['The counter', 'Tiled interior', 'Pastéis tray', 'Mouraria street tables'],
    whatItIs: [
    ...
    hoursType: 'cafe', hoursNote: 'Open daily, early. Closes by evening.',
    owner: { name: 'The Sousa family', initials: 'CM', tint: J, role: 'Family-run', bio: 'A family business, community-vouched rather than queer-owned. Allies in the quiet, daily way that counts.', inQueerPulse: false, first: 'the family' },
    social: { phone: '+351 21 886 1234' },
    address: 'R. do Capelão 18 · Mouraria',
    reviews: [
      { initials: 'RV', name: 'Rita Varela', tint: J, byline: 'she/her · local', stars: 5, text: 'Dona Fátima calls me "menina" and means it the way I need it meant. The pastéis are the best in Mouraria, fight me.', helpful: 14 },
      { initials: 'TB', name: 'Tomás Beto', tint: C, byline: 'he/him · neighbour', stars: 4, text: 'Not a queer spot, just a kind one. That\'s worth a lot. Half a star off only because they close before I\'m hungry.', helpful: 6 },
    ],
  },
  {
    slug: 'bairro-alto-studio', name: 'Bairro Alto Studio', cat: 'tech', hood: 'Bairro Alto', owned: true, member: 'diogo', av: 'BA', tint: J,
    ...
    owner: { name: 'Diogo Vasques', initials: 'DV', tint: J, role: 'Producer · engineer', bio: 'Music producer and Queer Runners regular. Specialises in electronic and experimental work.', inQueerPulse: true, first: 'Diogo' },
    ...
    reviews: [
      { initials: 'KL', name: 'Kai Larsson', tint: J, byline: 'they/them · artist', stars: 5, text: 'Diogo got a sound out of my demos I\'d been chasing for two years. The modular wall alone is worth the trip.', helpful: 10 },
      { initials: 'RV', name: 'Rita Varela', tint: C, byline: 'she/her · client', stars: 5, text: 'First-record sliding scale meant I could actually afford to make the thing properly. Patient with a total beginner.', helpful: 8 },
    ],
  },
  {
    slug: 'espaco-intendente', name: 'Espaço Intendente', cat: 'space', hood: 'Intendente', owned: false, av: 'EI', tint: P,
    desc: 'Community coworking space, explicitly LGBTQ+-friendly. Day passes and monthly desks at accessible prices.',
    tagline: 'A coworking space that put "LGBTQ+-friendly" in writing and meant it.',
    ...
    hoursType: 'gym', hoursNote: 'Open Mon–Sat, generous hours.',
    owner: { name: 'Espaço Intendente', initials: 'EI', tint: P, role: 'Community space', bio: 'An allied coworking space, community-vouched. Hosts several QueerPulse meetups.', inQueerPulse: false, first: 'the space' },
    ...
    reviews: [
      { initials: 'NA', name: 'Nuno Alves', tint: J, byline: 'he/him · member', stars: 5, text: 'Wrote the inclusion policy on the wall and actually live by it. Bathrooms de-gendered, staff trained, prices human.', helpful: 13 },
      { initials: 'CN', name: 'Carla Nogueira', tint: C, byline: 'she/her · day-pass', stars: 4, text: 'Great for a focused day. Docked one star for the afternoon coffee situation, which is a crime against deadlines.', helpful: 5 },
    ],
  },
  {
    slug: 'a-farinha', name: 'A Farinha', cat: 'food', hood: 'Arroios', owned: true, av: 'AF', tint: C,
    desc: 'Queer-owned natural wine bar and small plates restaurant. Natural wine list, seasonal kitchen, generous hospitality.',
    tagline: 'Natural wine, small plates, and a room that wants you to stay one more glass.',
    ...
    hoursType: 'bar', hoursNote: 'Evenings, Tue–Sun. Closed Mondays.',
    owner: { name: 'Marco & Renato', initials: 'AF', tint: C, role: 'Owners', bio: 'A couple who left restaurant kitchens to open the room they wanted to drink in. One of them is a QueerPulse member.', inQueerPulse: true, first: 'Marco' },
    ...
    reviews: [
      { initials: 'AK', name: 'Anika Kovač', tint: C, byline: 'she/her · regular', stars: 5, text: 'Told Renato "something orange and a bit weird" and he changed my whole opinion of wine. The plates kept coming and I let them.', helpful: 16 },
      { initials: 'SC', name: 'Sofia Castaño', tint: P, byline: 'she/her · 3 visits', stars: 5, text: 'Brought a date, then brought my friends, then brought my mother. Passed every test. Hospitality you can feel.', helpful: 9 },
    ],
  },
  {
    slug: 'studio-andre-quintela', name: 'Studio André Quintela', cat: 'design', hood: 'Cais do Sodré', owned: true, member: 'andre', av: 'AQ', tint: J,
    desc: 'Portrait photography studio. Analog film, medium format, darkroom on site. Priority allocation for community members.',
    ...
    gallery: ['Shooting space', 'Darkroom', 'Print wall', 'Cais do Sodré light'],
    whatItIs: [
      'André shoots portraits on analog film — medium format, real grain, a darkroom on site — and is unusually good at the thing portrait photographers claim and rarely deliver: making people feel safe enough to look like themselves.',
    ...
    owner: { name: 'André Quintela', initials: 'AQ', tint: J, role: 'Photographer', bio: 'Portrait photographer, all analog. Keeps a standing offer of free portraits for transition milestones.', inQueerPulse: true, first: 'André' },
    ...
    reviews: [
      { initials: 'KL', name: 'Kai Larsson', tint: J, byline: 'they/them · sitter', stars: 5, text: 'I hate being photographed. André made an hour feel like a conversation and the prints made me cry, in the good way.', helpful: 19 },
      { initials: 'RV', name: 'Rita Varela', tint: C, byline: 'she/her · milestone shoot', stars: 5, text: 'Did my one-year portraits for free, no fuss, total grace. The darkroom prints are on my wall and staying there.', helpful: 14 },
    ],
  },
  {
    slug: 'clinica-da-estrela', name: 'Clínica da Estrela', cat: 'health', hood: 'Estrela', owned: false, av: 'CE', tint: P,
    desc: 'General practice with two LGBTQ+-affirming GPs and a trans-competent endocrinologist. Accepts SNS referrals.',
    tagline: 'A regular GP practice where you don\'t have to brace before the appointment.',
    pills: ['GP · endocrinology', 'SNS referrals', '€€', 'Wheelchair-accessible'],
    rating: { score: '4.7', count: 63 },
    gallery: ['Reception', 'Consulting room', 'Waiting area', 'Estrela entrance'],
    whatItIs: [
    ...
    hoursType: 'clinic', hoursNote: 'Mon–Sat by appointment. Closed Sundays.',
    owner: { name: 'Clínica da Estrela', initials: 'CE', tint: P, role: 'Medical practice', bio: 'An allied practice, community-vouched. The Trans Hub keeps it on the vetted-provider list.', inQueerPulse: false, first: 'the practice' },
    ...
    reviews: [
      { initials: 'JF', name: 'Jonas Ferreira', tint: J, byline: 'he/him · patient', stars: 5, text: 'Dr. Pereira treats me like an adult and the endocrinologist actually knows the protocols. Booked under the right name first try.', helpful: 24 },
      { initials: 'AK', name: 'Anika Kovač', tint: C, byline: 'she/her · patient', stars: 4, text: 'Genuinely affirming care. The wait for the endo can be a few weeks, hence four stars, but worth it.', helpful: 10 },
    ],
  },
  {
    slug: 'galeria-lume', name: 'Galeria Lume', cat: 'culture', hood: 'Marvila', owned: true, av: 'GL', tint: C,
    ...
    hoursType: 'gallery', hoursNote: 'Open Wed–Sun afternoons. Openings run late.',
    owner: { name: 'Lume collective', initials: 'GL', tint: C, role: 'Artist-run', bio: 'Run by an artist collective; several members are on QueerPulse and overlap with Rainbow Arts.', inQueerPulse: true, first: 'the collective' },
    social: { instagram: '@galerialume', website: 'galerialume.pt', email: 'ola@galerialume.pt' },
    address: 'R. do Açúcar 76 · Marvila',
    upcoming: [{ when: 'Sat 28 Jun · 18:00', title: 'Opening — group show, eight emerging artists' }],
    reviews: [
      { initials: 'LG', name: 'Luísa Gomes', tint: J, byline: 'she/her · curator', stars: 5, text: 'Lume shows the work the big institutions will be claiming to have discovered in five years. Go now and be smug later.', helpful: 12 },
      { initials: 'BP', name: 'Beatriz Pinto', tint: P, byline: 'she/her · artist', stars: 5, text: 'They gave me my first solo room and treated it like it mattered. Openings feel like a community, not a market.', helpful: 8 },
    ],
  },
  {
    slug: 'navalha', name: 'Navalha', cat: 'grooming', hood: 'Príncipe Real', owned: true, av: 'NV', tint: C,
    desc: 'Queer-owned barbershop known for trans haircuts done right. No awkward questions. No gendered pricing.',
    tagline: 'A barbershop where the cut you ask for is the cut you get — no negotiation.',
    ...
    hoursType: 'shop', hoursNote: 'Tue–Sat, walk-ins welcome, booking advised.',
    owner: { name: 'Vasco Lima', initials: 'NV', tint: C, role: 'Owner · barber', bio: 'Opened Navalha after years of sending friends across town for a safe cut. QueerPulse member from day one.', inQueerPulse: true, first: 'Vasco' },
    social: { instagram: '@navalha.barbearia', email: 'ola@navalha.pt', phone: '+351 21 347 2200' },
    address: 'R. do Século 120 · Príncipe Real',
    reviews: [
      { initials: 'KL', name: 'Kai Larsson', tint: J, byline: 'they/them · regular', stars: 5, text: 'Asked for a cut I\'d been too scared to ask for anywhere. Vasco just nodded and did it perfectly. I cried a little in the chair.', helpful: 41 },
      { initials: 'NA', name: 'Nuno Alves', tint: P, byline: 'he/him · monthly', stars: 5, text: 'Same price as my old place, none of the awkwardness, twice the skill. Never going anywhere else.', helpful: 13 },
    ],
  },
  {
    slug: 'salao-mouraria', name: 'Salão Mouraria', cat: 'grooming', hood: 'Mouraria', owned: false, av: 'SM', tint: J,
    desc: 'Neighbourhood salon adopted by the queer community. Bilingual, trans-welcoming, affordable.',
    tagline: 'A neighbourhood salon that learned our names and never made it weird.',
    pills: ['Hair salon', 'Affordable', 'PT / EN', 'Ground floor'],
    rating: { score: '4.6', count: 33 },
    gallery: ['Salon floor', 'Wash station', 'Mouraria street', 'Waiting bench'],
    whatItIs: [
    ...
    hoursType: 'shop', hoursNote: 'Tue–Sat. Booking by phone.',
    owner: { name: 'Dona Lúcia', initials: 'SM', tint: J, role: 'Owner', bio: 'Has run the salon for decades. Community-vouched ally rather than a member — and entirely lovely.', inQueerPulse: false, first: 'Dona Lúcia' },
    social: { phone: '+351 21 885 6677' },
    address: 'R. dos Lagares 9 · Mouraria',
    reviews: [
      { initials: 'RV', name: 'Rita Varela', tint: J, byline: 'she/her · regular', stars: 5, text: 'Lúcia remembers exactly how I like it and never once made me feel like a question mark. Cheap, kind, close. Perfect.', helpful: 9 },
      { initials: 'SC', name: 'Sofia Castaño', tint: C, byline: 'she/her · 2 visits', stars: 4, text: 'Lovely and affordable. Not the place for anything dramatic, but for a good honest cut from a kind person, ideal.', helpful: 4 },
    ],
  },
  {
    slug: 'studio-cabelo', name: 'Studio Cabelo', cat: 'grooming', hood: 'Intendente', owned: true, av: 'SC', tint: P,
    desc: 'Gender-neutral pricing on every service — never more based on hair length or gender. Clean space, good music.',
    tagline: 'One price list, no gender column. Revolutionary how rare that still is.',
    pills: ['Hair studio', 'Gender-neutral pricing', '€€', 'Step-free'],
    rating: { score: '4.9', count: 38 },
    gallery: ['The chair', 'Colour bar', 'Intendente window', 'Plants & playlist'],
    whatItIs: [
    ...
    hoursType: 'shop', hoursNote: 'Tue–Sat. Booking advised.',
    owner: { name: 'Sara Coelho', initials: 'SC', tint: P, role: 'Owner · stylist', bio: 'Left a salon that wouldn\'t drop gendered pricing and opened one that never had it. QueerPulse member.', inQueerPulse: true, first: 'Sara' },
    ...
    reviews: [
      { initials: 'AK', name: 'Anika Kovač', tint: C, byline: 'she/her · regular', stars: 5, text: 'Paid the same as my partner for the first time in my life and the cut was better than either of us usually get. Sold forever.', helpful: 18 },
      { initials: 'KL', name: 'Kai Larsson', tint: J, byline: 'they/them · client', stars: 5, text: 'No "which side of the price list are you" energy. Just good hair and good music. The bar, frankly.', helpful: 11 },
    ],
  },
  {
    slug: 'academia-livre', name: 'Academia Livre', cat: 'fitness', hood: 'Cais do Sodré', owned: false, av: 'AL', tint: J,
    desc: 'The most trans-inclusive gym in the city. Gender-neutral changing rooms on every floor, no body-shaming culture.',
    tagline: 'A gym you can actually change in, designed by people who\'d been driven out of others.',
    pills: ['Gym', 'Memberships', '€€', 'Wheelchair-accessible'],
    rating: { score: '4.7', count: 52 },
    gallery: ['Weights floor', 'Gender-neutral changing', 'Studio room', 'Cais do Sodré entrance'],
    whatItIs: [
    ...
    hoursType: 'gym', hoursNote: 'Open daily, early to late.',
    owner: { name: 'Academia Livre', initials: 'AL', tint: J, role: 'Fitness club', bio: 'An allied gym, community-vouched. Consulted trans members on its refit and listened.', inQueerPulse: false, first: 'the gym' },
    ...
    reviews: [
      { initials: 'JF', name: 'Jonas Ferreira', tint: J, byline: 'he/him · member', stars: 5, text: 'First gym in years I haven\'t had a panic about the changing room. Private stalls everywhere, staff who get it. Life-changing, genuinely.', helpful: 27 },
      { initials: 'NA', name: 'Nuno Alves', tint: P, byline: 'he/him · member', stars: 4, text: 'Solid kit, good policy, gets busy at 18:00 like every gym on earth. Four stars only for the queue at peak.', helpful: 7 },
    ],
  },
  {
    slug: 'corpo-livre', name: 'Corpo Livre', cat: 'fitness', hood: 'Bairro Alto', owned: true, av: 'CL', tint: P,
    desc: 'Feminist and queer-centred fitness studio. Small classes, no mirrors, no scales. Body-neutral by design.',
    tagline: 'Fitness without the mirror, the scale, or the voice in your head.',
    pills: ['Fitness studio', 'Class packs', '€€', 'Step-free'],
    rating: { score: '4.9', count: 44 },
    gallery: ['Studio (no mirrors)', 'Mat area', 'Bairro Alto room', 'Tea after class'],
    whatItIs: [
    ...
    hoursType: 'gym', hoursNote: 'Class times Mon–Sat — book a spot.',
    owner: { name: 'Mariana & Júlia', initials: 'CL', tint: P, role: 'Founders', bio: 'Two trainers who quit body-shaming studios to build the opposite. Both QueerPulse members.', inQueerPulse: true, first: 'Mariana' },
    social: { instagram: '@corpolivre.studio', website: 'corpolivre.pt', email: 'ola@corpolivre.pt' },
    address: 'R. da Rosa 200 · Bairro Alto',
    reviews: [
      { initials: 'RV', name: 'Rita Varela', tint: C, byline: 'she/her · regular', stars: 5, text: 'No mirrors changed my entire relationship to exercise. I show up for how it feels now. The after-class tea is non-negotiable.', helpful: 20 },
      { initials: 'SC', name: 'Sofia Castaño', tint: J, byline: 'she/her · class pack', stars: 5, text: 'Small enough that Júlia corrects my form by name. Strong, calm, zero shame. Wish I\'d found it years ago.', helpful: 12 },
    ],
  },
  {
    slug: 'movimento', name: 'Movimento', cat: 'fitness', hood: 'Alfama', owned: true, av: 'MV', tint: C,
    ...
    hoursType: 'gym', hoursNote: 'Class schedule Mon–Sat; weights room open daily.',
    owner: { name: 'Rui & Pedro', initials: 'MV', tint: C, role: 'Co-founders', bio: 'Two friends who wanted one room for all the ways they move. Queer-run, sliding-scale on principle.', inQueerPulse: true, first: 'Rui' },
    social: { instagram: '@movimento.alfama', website: 'movimento.pt', email: 'ola@movimento.pt' },
    address: 'Beco do Mexias 4 · Alfama',
    upcoming: [{ when: 'Sun 15 Jun · 10:00', title: 'Open capoeira roda — all levels, free' }],
    reviews: [
      { initials: 'KL', name: 'Kai Larsson', tint: J, byline: 'they/them · member', stars: 5, text: 'Where else can you do sun salutations and then deadlift in the same hour for whatever you can pay? Alfama\'s best-kept secret.', helpful: 15 },
      { initials: 'TB', name: 'Tomás Beto', tint: C, byline: 'he/him · capoeira', stars: 5, text: 'The roda on Sundays is pure joy and properly mixed — ages, bodies, levels. Sliding scale means everyone\'s actually there.', helpful: 8 },
    ],
  },
]
...
export function hoursRows(type: HoursType): { day: string; val: string; closed: boolean }[] {
  const days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']
  const t: Record<HoursType, (string | null)[]> = {
    cafe: [null, '08:00 — 20:00', '08:00 — 20:00', '08:00 — 20:00', '08:00 — 23:00', '09:00 — 23:00', '09:00 — 18:00'],
    restaurant: [null, '19:00 — 23:30', '19:00 — 23:30', '19:00 — 23:30', '19:00 — 24:00', '19:00 — 24:00', '13:00 — 16:00'],
    bar: [null, '17:00 — 00:00', '17:00 — 00:00', '17:00 — 01:00', '17:00 — 02:00', '17:00 — 02:00', '16:00 — 23:00'],
    clinic: ['09:00 — 18:00', '09:00 — 18:00', '09:00 — 18:00', '09:00 — 18:00', '09:00 — 18:00', '09:00 — 13:00', null],
    shop: [null, '11:00 — 19:00', '11:00 — 19:00', '11:00 — 19:00', '11:00 — 19:00', '11:00 — 19:00', null],
    gym: ['07:00 — 22:00', '07:00 — 22:00', '07:00 — 22:00', '07:00 — 22:00', '07:00 — 22:00', '09:00 — 19:00', '09:00 — 19:00'],
    gallery: [null, null, '14:00 — 20:00', '14:00 — 20:00', '14:00 — 20:00', '12:00 — 20:00', '12:00 — 19:00'],
    appointment: [null, null, null, null, null, null, null],
    studio: [null, '10:00 — 19:00', '10:00 — 19:00', '10:00 — 19:00', '10:00 — 19:00', '11:00 — 17:00', null],
  }
