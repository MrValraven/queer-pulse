...
export const VOLUNTEER_OPPORTUNITIES_A: VolunteerOpportunity[] = [
    ...
    tasks: [
      {
        ...
        desc: "Set up, greet people, hand out materials, keep the space warm.",
      },
      {
        title: "Answer the common questions",
        desc: "Name changes, where to get tested, how to report — the FAQs, with a script.",
      },
      {
      ...
      },
      {
        ...
        desc: "A quick tally at the end — anonymised counts, never names.",
      },
    ],
    commitments: [
      {
    ...
    tasks: [
      {
        ...
        desc: "Listen, reflect, don't fix. The training gives you the frame.",
      },
      {
        title: "Keep confidentiality, always",
        desc: "What's said in the room stays there — with clear, taught exceptions.",
      },
      {
        title: "Recognise when to escalate",
        desc: "You'll learn the signs. A clinician is on call every session.",
      },
      {
        title: "Attend the monthly debrief",
        desc: "Supervised group reflection — for the people you saw, and for you.",
      },
    ],
    commitments: [
    ...
    tasks: [
      {
        ...
        desc: "Same evening each week. You and the lead facilitator share it.",
      },
      {
        title: "Hold the group agreement",
        desc: "Confidentiality, respect, no outing. You model it before you enforce it.",
      },
      {
        title: "Notice the quiet ones",
        desc: "Half of youth work is catching who's drifting and gently including them.",
      },
      {
        title: "Debrief after each session",
        desc: "15 minutes with your co-facilitator — what happened, what's next.",
      },
      {
        title: "Flag safeguarding concerns",
        desc: "You'll be trained on exactly what, when, and to whom.",
      },
    ],
    commitments: [
      {
...

  {
    ...
    stats: [
      {
        value: <b style={{ color: "var(--jade)" }}>Remote</b>,
        label: "Mostly async",
      },
    ...
    why: [
      <>
        Rights campaigns are won and lost on attention. A clear graphic shared
        widely the morning a vote is announced can shift a news cycle.{" "}
        <b>
      ...
      <>
        This is the most flexible role on the board.{" "}
        <em>Do a poster when you have an hour, or take a whole campaign.</em> No
        standing meetings, no minimum.
      </>,
    ],
    tasks: [
      {
        title: "Turn briefs into posts",
        desc: "A one-line ask becomes a caption, a graphic, a thread.",
      },
      {
        title: "Design quick assets",
        desc: "Stories, posters, banners — templates exist, bring taste.",
      },
      {
        title: "Draft and tighten copy",
        desc: "Plain, sharp, on-message. Editing others counts too.",
      },
      {
        title: "Move fast when it matters",
        desc: "Some weeks are quiet; a few are same-day. You opt into those.",
      },
    ],
    commitments: [
      {
        b: "Light onboarding chat",
        s: "30 min to meet the team and see the toolkit",
      },
      {
        b: "2–3 hours a week",
      ...
      {
        b: "No fixed term",
        s: "Contribute when you can; pause when you can't",
      },
      {
        b: "Async by default",
        s: "Group chat + a shared drive · meetings are rare",
      },
    ],
    goodFor: [
      <>
    ...
    spots: [
      ...
      {
        label: "Format",
        value: <b style={{ color: "var(--jade)" }}>Async-first</b>,
      },
    ],
    applyConfirm: (
      <>
        Application submitted for{" "}
        <strong>Campaign Comms · Panteras Rosa</strong>. Someone from the crew
        will add you to the group chat and share the toolkit.
      </>
    ),
    partner: null,
  },
