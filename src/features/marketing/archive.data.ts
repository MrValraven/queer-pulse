...
export const ARCHIVE_CARDS: ArchiveCard[] = [
  {
    ...
    desc: "Arriving from Kinshasa in 2019, navigating a new country and a new language while also figuring out who she was — Amara's story of building a life in Lisbon.",
    initials: "AM",
  ...
  },
  {
    ...
    desc: "A product manager's account of coming out at a Lisbon startup, the backlash, and how she rebuilt her career on her own terms.",
    initials: "LM",
  ...
  },
  {
    ...
    desc: "A 62-year-old retired teacher traces queer Lisbon's nightlife history from the 1980s to today — what was lost, what survived, and why it mattered.",
    initials: "JA",
    avBg: "rgba(45,27,61,.1)",
    avColor: "var(--plum)",
    name: "José Abreu",
  ...
  },
  {
    ...
    desc: "Jonas documents his transition in Portugal in the era before the Gender Identity Law — the bureaucracy, the indignities, and the people who made it bearable.",
    initials: "JF",
