...
const COLORS = [
  { bg: "#2D1B3D", name: "Plum", hex: "#2D1B3D", v: "--plum · brand anchor" },
  { bg: "#E8775A", name: "Coral", hex: "#E8775A", v: "--accent · CTA & emphasis" },
  { bg: "#F7F3EE", name: "Cream", hex: "#F7F3EE", v: "--cream · page bg", border: true },
  { bg: "#4A8C6F", name: "Jade", hex: "#4A8C6F", v: "--jade · success" },
  { bg: "#1A1A1F", name: "Ink", hex: "#1A1A1F", v: "--ink · text base" },
];
      ...
      <div className={styles.page}>
        <header className={styles.head}>
          ...
          <p className={styles.sub}>
            The 24 components every QueerPulse page is made of. Live (uses the production
            CSS). <em>For internal handoff &amp; press use only</em> — not a public design
            system.
          </p>
        </header>
        ...
        <section className={styles.sec} id="type">
          ...
          <div className={styles.typeRow}>
            <div className={styles.typeSample} style={{ fontFamily: "var(--sans)", fontSize: 16, lineHeight: 1.65, color: "var(--ink)", maxWidth: "50ch" }}>
              Body copy. This is what most paragraphs look like. <em>Italic em uses the
              serif</em>, but inline lookups stay sans.
            </div>
            <div className={styles.typeMeta}>
        ...
        <section className={styles.sec} id="cards">
          <h2>Cards</h2>
          <p className={styles.secSub}>
            22px border-radius. White paper on cream. <em>Hover lifts 4px + heavier
            shadow.</em>
          </p>
          <div className={styles.spec}>
            <div className={styles.specHead}>
            ...
            <div className={styles.specBody}>
              <div className={styles.demoCard}>
                ...
                <p>
                  One or two sentences of supporting text. Hover lifts the whole card by
                  4px.
                </p>
              </div>
            </div>
        ...
        <section className={styles.sec} id="nav">
          <h2>Navigation</h2>
          <p className={styles.secSub}>
            Floating glass-pill nav · fixed 18px from top · backdrop-filter blur(18px)
            saturate(1.5) · cream bg at 66% opacity.
          </p>
          <div className={styles.spec}>
            <div className={styles.specHead}>
              <div className={styles.specName}>
        ...
        <p className={styles.footerNote}>
          For everything else · type pairs, motion easing tokens, dark-mode swap, full
          radii scale, and the foundation cards · see{" "}
          <a onClick={() => showToast("Opening Guidelines…", "info")}>Guidelines</a> · or
          the <a onClick={() => showToast("Downloading Figma kit…", "success")}>Figma kit</a>.
        </p>
      </div>
    </PageShell>
  );
