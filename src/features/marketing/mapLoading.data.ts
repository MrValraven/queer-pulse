...
export const MAP_LOADING_DOTS: MapLoadingDot[] = [
  { top: "18%", left: "14%", size: 10, color: "var(--text-strong)", delay: 0, duration: 2.8 },
  { top: "30%", left: "76%", size: 8, color: "var(--accent)", delay: 0.5, duration: 3.1 },
  { top: "13%", left: "52%", size: 7, color: "var(--jade)", delay: 0.9, duration: 2.6 },
  { top: "58%", left: "22%", size: 9, color: "var(--accent)", delay: 0.3, duration: 3.0 },
  { top: "45%", left: "87%", size: 11, color: "var(--text-strong)", delay: 0.7, duration: 2.9 },
  { top: "72%", left: "58%", size: 8, color: "var(--jade)", delay: 1.1, duration: 3.2 },
  { top: "36%", left: "38%", size: 6, color: "var(--accent-ink)", delay: 0.2, duration: 2.5 },
  { top: "80%", left: "30%", size: 9, color: "var(--text-strong)", delay: 0.6, duration: 3.0 },
  { top: "63%", left: "83%", size: 7, color: "var(--jade)", delay: 1.0, duration: 2.7 },
  { top: "24%", left: "33%", size: 8, color: "var(--accent)", delay: 0.4, duration: 2.9 },
];
