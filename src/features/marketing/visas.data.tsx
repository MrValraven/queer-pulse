...
export const LAWYERS: { initials: string; bg: string; color: string; name: string; context: string; stars: number; quote: string }[] = [
  { initials: 'SM', bg: 'rgba(74,140,111,.15)', color: 'var(--jade)', name: 'Sofia Mendes', context: 'Immigration law · Chiado', stars: 5, quote: '"Handled our same-sex couple application with complete ease. Knew the Coman ruling and how to apply it. Clear pricing, no surprises. Two members have used her this year."' },
  { initials: 'JF', bg: 'rgba(232,119,90,.15)', color: 'var(--accent-ink)', name: 'João Figueiredo', context: 'Immigration & tax law · Marquês de Pombal', stars: 5, quote: '"Specialises in D7 and D8 applications. Also handles the IFICI tax regime. Efficient, English-speaking, and experienced with international LGBTQ+ clients."' },
  { initials: 'CL', bg: 'rgba(45,27,61,.12)', color: 'var(--plum)', name: 'Carla Lima Advogados', context: 'Firm · Arroios', stars: 4, quote: '"Good firm for complex situations — non-EU couples, prior visa refusals, cross-border family cases. More expensive than solo practitioners but thorough."' },
]
