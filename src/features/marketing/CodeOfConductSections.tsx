  ...
  return (
    <>
      <section className={styles.sec} id="scope">
        ...
        <h2>Where this <em>applies.</em></h2>
        <p>
      ...
      <section className={styles.sec} id="pact">
        ...
        <h2>The six things you <em>must not do.</em></h2>
        <p>
...
export function CocHarmSection() {
  return (
    <section className={styles.sec} id="harm">
      ...
      <h2>What we mean by <em>harm</em>, and what we don't.</h2>
...
export function CocEnforceSection() {
  return (
    <section className={styles.sec} id="enforce">
      ...
      <h2>What happens if you <em>break this.</em></h2>
      <p>
...
export function CocReportCta({ reportPath, emergencyPath, onCrisisChat }: CocReportCtaProps) {
  return (
    <div className={styles.reportCta}>
      <h3>Something happened. <em>What do I do?</em></h3>
      <p>
      ...
      <div className={styles.reportActions}>
        <Button to={reportPath} variant="primary">File a report</Button>
        <Button type="button" variant="ghost-dark" onClick={onCrisisChat}>
          Or talk to crisis chat first
        </Button>
        <Button to={emergencyPath} variant="ghost-dark">Emergency · 112</Button>
      </div>
    </div>
  );
}
...
export function CocChangesSection({ changelogPath, onDownload }: CocChangesProps) {
  return (
    <>
      <section className={styles.sec} id="appeal">
        <div className={styles.secNum}>§<em>05</em></div>
        <h2>Appeals — <em>how to push back.</em></h2>
        <p>
      ...
      <section className={styles.sec} id="offplatform">
        ...
        <h2>Off-platform <em>conduct.</em></h2>
        <p>
      ...
      <section className={styles.sec} id="changes">
        ...
        <h2>Changes &amp; <em>versioning.</em></h2>
        <p>
      ...
      <div className={styles.version}>
        ...
        · <a onClick={onDownload}>Download PDF</a> · Read the Manifesto
      </div>
    </>
  );
}
