    ...
    tasks: [
      {
        ...
        description: "A one-line ask becomes a caption, a graphic, a thread.",
      },
      {
      ...
      },
      {
        ...
        description: "Plain, sharp, on-message. Editing others counts too.",
      },
      {
        title: "Move fast when it matters",
        description: "Some weeks are quiet; a few are same-day. You opt into those.",
      },
    ],
    commitments: [
      {
