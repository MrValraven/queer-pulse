  ...
  return (
    <section className={styles.sec} id="colors">
      ...
      <p className={styles.secSub}>
        Plus a 5-step ink scale.{" "}
        <em>No additional accent colours are introduced anywhere.</em>
      </p>
      <div className={styles.colRow}>
        {COLORS.map((c) => (
          <div className={styles.colChip} key={c.name}>
            <div
              className={styles.colChipBar}
              style={{
                background: c.bg,
                border: c.border ? "1px solid rgba(45,27,61,.10)" : undefined,
              }}
            />
            <b>{c.name}</b>
            <span>{c.hex}</span>
...
export function TypeSection() {
  return (
    <section className={styles.sec} id="type">
      ...
      <p className={styles.secSub}>
        Display in Fraunces (variable optical-size serif). UI &amp; body in DM
        Sans. <em>Italic em is the primary emphasis device — never bold.</em>
      </p>
      ...
      <div className={styles.typeRow}>
        ...
        >
          Body copy. This is what most paragraphs look like.{" "}
          <em>Italic em uses the serif</em>, but inline lookups stay sans.
        </div>
        <div className={styles.typeMeta}>
...
export function ButtonsSection() {
  return (
    <section className={styles.sec} id="buttons">
      <h2>Buttons</h2>
      <p className={styles.secSub}>
        Three variants. <em>Pill always · 999px border-radius.</em> Lift on
        hover.
      </p>
      <div className={styles.spec}>
        ...
        <div className={styles.codeSnippet}>
          ...
          <span className={styles.com}>
            // fills coral · CTA only · once per screen
          </span>
        </div>
      </div>
      <div className={styles.spec}>
      ...
      <div className={styles.spec}>
        <div className={styles.specHead}>
          ...
          <div className={styles.specClass}>
            .btn .btn-ghost-d · for plum sections
          </div>
        </div>
  ...
  return (
    <section className={styles.sec} id="chips">
      ...
      <div className={styles.spec}>
        ...
        <div className={styles.specBody}>
          <span className={`${styles.demoPill} ${styles.demoPillActive}`}>
            Active · 184
          </span>
      ...
      <div className={styles.spec}>
        ...
        <div className={styles.specBody}>
          <span className={`${styles.tagSample} ${styles.tagJade}`}>
            ● Verified
          </span>
          <span className={`${styles.tagSample} ${styles.tagAccent}`}>
            ● In review
          </span>
          <span className={`${styles.tagSample} ${styles.tagPlum}`}>
            Member
          </span>
        </div>
      </div>
...
export function AvatarsSection() {
  return (
    <section className={styles.sec} id="avatars">
      <h2>Avatars</h2>
      <p className={styles.secSub}>
        Never photos for static demos · initials on tinted circles. Three tints
        · three sizes.
      </p>
      <div className={styles.spec}>
        <div className={styles.specHead}>
          <div className={styles.specName}>
            Coral · jade · plum · three sizes
          </div>
...
export function CardsSection() {
  return (
    <section className={styles.sec} id="cards">
      <h2>Cards</h2>
      <p className={styles.secSub}>
        22px border-radius. White paper on cream.{" "}
        <em>Hover lifts 4px + heavier shadow.</em>
      </p>
      <div className={styles.spec}>
        <div className={styles.specHead}>
          <div className={styles.specName}>Standard card</div>
          <div className={styles.specClass}>
            .demo-card · 22px radius · 24px padding
          </div>
        </div>
        <div className={styles.specBody}>
          <div className={styles.demoCard}>
            ...
            <p>
              One or two sentences of supporting text. Hover lifts the whole
              card by 4px.
            </p>
          </div>
        </div>
...
export function FormsSection() {
  ...
  return (
    <section className={styles.sec} id="forms">
      <h2>Forms</h2>
      <p className={styles.secSub}>
        11px label caps in plum · cream input bg · plum focus border.
      </p>
      <div className={styles.spec}>
        <div className={styles.specHead}>
        ...
        >
          <div style={{ width: "100%" }}>
            ...
            <input
              type="email"
              defaultValue="tomas@example.com"
    ...
    <section className={styles.sec} id="status">
      ...
      <div className={styles.spec}>
        ...
        <div className={styles.specBody}>
          ...
          <span
            className={styles.tagSample}
            style={{ color: "var(--ink-60)", background: "rgba(45,27,61,.06)" }}
          >
            Closed
          </span>
        </div>
...
export function NavSection() {
  return (
    <section className={styles.sec} id="nav">
      <h2>Navigation</h2>
      <p className={styles.secSub}>
        Floating glass-pill nav · fixed 18px from top · backdrop-filter
        blur(18px) saturate(1.5) · cream bg at 66% opacity.
      </p>
      <div className={styles.spec}>
        <div className={styles.specHead}>
          <div className={styles.specName}>
          ...
          <div className={styles.specClass}>
            .nav · see live at top of this page
          </div>
        </div>
