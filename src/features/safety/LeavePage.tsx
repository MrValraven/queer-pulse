      ...
      <div className={s.page}>
        {state === "considering" && (
          <div className={`${s.card} ${s.cardWide} ${s.screenIn}`}>
            ...
            <div className={s.sub}>
              We're sorry to see you go. Before you delete your account, we want
              to make sure this is the right choice — and that you have
              everything you need.
            </div>
            ...
            <div className={s.lossCard}>
              ...
              <div className={s.privacyNote}>
                We retain only anonymised, aggregated data. Your personal data
            ...
            <div className={s.altCard}>
              ...
              <div>
                ...
                <div className={s.altDesc}>
                  ...
                  notifications are sent. Everything is exactly as you left it
                  when you come back.
                </div>
            ...
            <div className={s.altCard}>
              ...
              <div>
                ...
                <div className={s.altDesc}>
                  Set your profile to private, mute all notifications, and come
                  back whenever you're ready. No pressure, no timer, no
                  questions.
                </div>
        ...
        {state === "pausing" && (
          <div className={`${s.card} ${s.screenIn}`}>
            ...
            <div className={s.sub} style={{ marginBottom: 22 }}>
              Your profile goes private, you leave search results, and we stop
              sending notifications. Everything is preserved.
            </div>
        ...
        {state === "paused" && (
          <div className={`${s.card} ${s.pausedCard} ${s.screenIn}`}>
            ...
            <p className={s.pausedSub}>
              ...
              notification. Your people, your badges, your history — all of it
              is exactly where you left it. Come back the moment you want to.
            </p>
        ...
        {state === "confirmed" && (
          <div className={`${s.card} ${s.center} ${s.screenIn}`}>
            ...
            <div className={s.sub}>
              Your account will be fully deleted within 30 days. You've been
              signed out and your profile is no longer visible.
            </div>
            ...
            <div className={s.reportNote} style={{ borderTop: "none" }}>
              Changed your mind? You can cancel by signing back in within 30
              days.
              <br />
