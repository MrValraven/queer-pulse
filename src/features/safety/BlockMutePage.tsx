      ...
      <div className={s.page}>
          ...
          <div className={`${s.card} ${s.screenIn}`}>
            ...
            >
              ...
              <div className={s.ocDesc}>
                You won't see her posts or activity. She won't know she's been
                muted. You can unmute at any time.
              </div>
              {chosen === "mute" && (
              ...
              {chosen === "block" && (
                <div className={s.subOpts}>
                  <div className={s.warnBox}>
                    <strong>Note:</strong> If you share communities, Sofia will
                    still appear in member lists — but won't be able to interact
                    with you directly.
                  </div>
                </div>
              )}
            ...
            <div className={s.actions}>
              <Button
                disabled={!chosen}
                onClick={() =>
                  setState(chosen === "mute" ? "muted" : "blocked")
                }
              >
                Continue
              </Button>
        ...
        {state === "muted" && (
          <div className={`${s.card} ${s.center} ${s.screenIn}`}>
            ...
            <div className={s.sub}>
              Her posts and replies are now hidden from your feed. She doesn't
              know.
            </div>
        ...
        {state === "blocked" && (
          <div className={`${s.card} ${s.center} ${s.screenIn}`}>
            <div
              className={s.icon}
              style={{ background: "rgba(45,27,61,.08)" }}
            >
              <svg width={24} height={24} viewBox="0 0 24 24" fill="none">
                <circle
                  cx={12}
