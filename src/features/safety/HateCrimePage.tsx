      ...
      <header className={styles.hero}>
        <div className="wrap">
          ...
          <p className={styles.sub}>
            Step-by-step — from the moment it happens to formal reporting, community support, and
            legal follow-up. Most people don't report because they don't know how. This guide
            removes that barrier.
          </p>
          <div className={styles.important}>
            <p>
              <strong>Your safety comes first.</strong> If you are in immediate danger, call{' '}
              <strong>112</strong> now. This guide is for after you are safe.
            </p>
          </div>
        </div>
      </header>
