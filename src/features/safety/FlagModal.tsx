        ...
        {done ? (
          <div>
            ...
            <p className={styles.sub}>
              Thank you. A moderator will read your report. <b>Three independent flags
              trigger an immediate review and temporary suspension of the badge</b> — your
              report counts toward that. We may contact you for detail, but never the venue.
            </p>
          ...
          <div>
            ...
            <p className={styles.sub}>
              Flags are how we know when a space slips. Tell us what you saw — specifics
              help the review panel. Your name is never shared with the venue.
            </p>

            <div className={styles.label}>What's the concern?</div>
            <div className={styles.opts}>
              {REASONS.map((r) => (
                <label key={r} className={[styles.opt, reason === r && styles.optChecked].filter(Boolean).join(' ')}>
                  <input
                    type="radio"
                    name="flag-reason"
                    value={r}
            ...
            <div className={styles.note}>
              ...
              Reports are confidential. Moderators see your name; the venue never does. In
              an emergency, call <strong>112</strong> first.
            </div>
