...
export const VERIFIED_SPACES: VerifiedSpace[] = [
  {
    status: 'verified', slug: 'purex', cat: 'Bar', typeLabel: 'Bar', name: 'Purex', hood: 'Intendente',
    ...
    tags: ['Gender-neutral bathrooms', 'Accessible', 'Trans-welcoming'], rating: '4.9', reviews: '54 reviews',
    ...
    metaPills: [{ label: 'Open late, Wed–Sun' }, { label: 'Gender-neutral bathrooms', accent: true }, { label: 'Step-free entrance', accent: true }],
    tier: 'Tier 1', reVerified: '2 May 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'Staff intervene, every time.', desc: 'Bar staff are briefed to step in on harassment without waiting to be asked. They will remove a customer before they remove you.' },
      { title: 'Gender-neutral, single-stall bathrooms.', desc: 'No gendered doors, no queue politics, locks that work. Cleaned through the night.' },
      { title: 'Quick exit on request.', desc: 'Ask any bartender for the side door to Rua dos Anjos. They will walk you out and call you a taxi.' },
  ...
  {
    status: 'verified', slug: 'trumps', cat: 'Bar', typeLabel: 'Bar', name: 'Trumps', hood: 'Rato',
    ...
    tags: ['Drag nights', 'Long-standing', 'Stairs noted'], rating: '4.7', reviews: '38 reviews',
    ...
    metaPills: [{ label: 'Drag Fridays' }, { label: 'Stairs to main bar', accent: true }],
    tier: 'Tier 2', reVerified: '11 Apr 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'Welcoming beyond gay men.', desc: 'Lesbian, bi, trans and non-binary people are explicitly welcome — staff and regulars set that tone.' },
      { title: 'Door staff trained on harassment.', desc: 'Security will act on a complaint and bar a repeat offender, not shrug it off.' },
      { title: 'Access limits stated plainly.', desc: 'Stairs down to the main bar; no lift. Step-free street-level area available — ask at the door.' },
  ...
  {
    status: 'verified', slug: 'lux-fragil', cat: 'Club', typeLabel: 'Club', name: 'Lux Frágil', hood: 'Santa Apolónia',
    ...
    tags: ['Queer nights', 'Reviewed security', 'Multiple floors'], rating: '4.6', reviews: '47 reviews',
    ...
    metaPills: [{ label: 'Regular queer nights' }, { label: 'Trained security', accent: true }, { label: 'Multiple floors' }],
    tier: 'Tier 1', reVerified: '28 Mar 2026', verifier: 'Mod team · 3 visits',
    promises: [
      { title: 'Security take complaints seriously.', desc: 'Report someone to any staff member and it is acted on — we tested this twice during verification.' },
      { title: 'Well-lit bathrooms, monitored.', desc: 'Good lighting and regular staff sweeps, which makes a real difference in a club this size.' },
      { title: 'A quiet floor to step away.', desc: 'The upstairs bar is calmer and staffed — a place to land if a night gets too much.' },
  ...
  {
    status: 'verified', slug: 'linha-dagua', cat: 'Cafe', typeLabel: 'Café', name: "Linha d'Água", hood: 'Príncipe Real',
    ...
    tags: ['Queer-owned', 'Sober-friendly', 'Accessible', 'Community board'], rating: '4.9', reviews: '29 reviews',
    ...
    metaPills: [{ label: 'Queer-owned' }, { label: 'Sober-friendly', accent: true }, { label: 'Fully accessible', accent: true }],
    tier: 'Tier 1', reVerified: '6 May 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'Names & pronouns honoured.', desc: 'Show your QueerPulse card and staff use that name on your cup. Legal name never asked.' },
      { title: 'A safe table to wait at.', desc: 'Meeting a stranger from a date or a sale? Tell staff — they keep an eye and will intervene if it goes wrong.' },
      { title: 'Fully step-free + accessible bathroom.', desc: 'Level entrance, wide aisles, a genuine accessible single-stall bathroom.' },
  ...
  {
    status: 'verified', slug: 'checkpointlx', cat: 'Health', typeLabel: 'Healthcare', name: 'CheckpointLx', hood: 'Intendente',
    ...
    tags: ['Trans-experienced staff', 'Free', 'Anonymous'], rating: '4.9', reviews: '84 reviews',
    ...
    metaPills: [{ label: 'Free & anonymous', accent: true }, { label: 'Trans-experienced staff', accent: true }, { label: 'Walk-in & booking' }],
    tier: 'Tier 1', reVerified: '19 May 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'No assumptions about bodies or practices.', desc: 'Intake is designed by and for queer people. You are asked what is relevant, never interrogated.' },
      { title: 'Free and genuinely anonymous.', desc: 'No ID required, no name on file unless you want one. Results given the way you choose.' },
      { title: 'Trans-experienced clinicians.', desc: 'Staff are trained in trans health and will not make your appointment about your gender.' },
  ...
  {
    status: 'verified', slug: 'barbearia-mouraria', cat: 'Services', typeLabel: 'Services', name: 'Barbearia Mouraria', hood: 'Mouraria',
    ...
    tags: ['Trans-welcoming', 'No gendered pricing', 'Walk-in welcome'], rating: '4.8', reviews: '22 reviews',
    ...
    metaPills: [{ label: 'No gendered pricing', accent: true }, { label: 'Walk-in welcome' }, { label: 'Trans-experienced', accent: true }],
    tier: 'Tier 2', reVerified: '24 Apr 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'The cut you ask for, full stop.', desc: 'No "are you sure", no negotiation. Barbers are experienced across all hair types and textures.' },
      { title: 'No gendered pricing.', desc: 'Price is by service, never by gender or hair length.' },
      { title: 'Your visit is not about your identity.', desc: 'Staff will not make small talk into an interrogation. You are a client, not a lesson.' },
  ...
  {
    status: 'verified', slug: 'zdb', cat: 'Arts', typeLabel: 'Arts', name: 'ZDB — Zé dos Bois', hood: 'Bairro Alto',
    ...
    tags: ['Queer programming', 'Community events', 'Accessible'], rating: '4.8', reviews: '41 reviews',
    ...
    metaPills: [{ label: 'Queer programming' }, { label: 'Hosts community events', accent: true }, { label: 'Step-free main hall', accent: true }],
    tier: 'Tier 1', reVerified: '15 Apr 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'Queer events are core, not after-hours.', desc: 'Programming is intersectional on purpose and queer nights are part of the main calendar.' },
      { title: 'Staff trained to hold a room.', desc: 'Front-of-house will step in on harassment and knows the difference between edgy art and an unsafe crowd.' },
      { title: 'Free space for community events.', desc: 'They lend the room to community organisers — several QueerPulse events have run here.' },
    ...
    glance: [
      ...
      { label: 'Open today', value: 'Event nights · check listings', accent: true },
      { label: 'Languages', value: 'PT · EN' },
  ...
  {
    status: 'verified', slug: 'copenhagen-coffee-lab', cat: 'Cafe', typeLabel: 'Café', name: 'Copenhagen Coffee Lab', hood: 'Cais do Sodré',
    ...
    tags: ['Sober-friendly', 'Queer staff', 'Gender-neutral bathroom'], rating: '4.7', reviews: '18 reviews',
    ...
    metaPills: [{ label: 'Queer-staffed' }, { label: 'Sober-friendly', accent: true }, { label: 'Gender-neutral bathroom', accent: true }],
    tier: 'Tier 2', reVerified: '9 May 2026', verifier: 'Mod team · 2 visits',
    promises: [
      { title: 'Respect as standard.', desc: 'Queer staff, correct names, zero second glances. The baseline a lot of cafés still miss.' },
      { title: 'Gender-neutral bathroom.', desc: 'Single-stall, no gendered door, clean.' },
      { title: 'A calm room for a hard meeting.', desc: 'Quiet enough for a first date or a difficult conversation; staff keep an eye if asked.' },
...
export const REMOVED_SPACES: RemovedSpace[] = [
  {
    status: 'removed', slug: 'bar-atlas', cat: 'Bar', typeLabel: 'Bar', name: 'Bar Atlas', hood: 'Santos',
    reason: 'Door staff refused entry to a trans member, then management defended it.',
    removedDate: '8 May 2026', listedSince: 'March 2024', flags: 5,
    reasonLong: [
    ...
    timeline: [
      { date: '18 Apr 2026', event: 'First incident reported by two members independently.' },
      { date: '19 Apr 2026', event: 'Badge suspended pending review (3-flag threshold passed).' },
      { date: '2 May 2026', event: 'Moderators met the owner; no commitment to retrain or apologise.' },
      { date: '8 May 2026', event: 'Listing permanently removed. Owner notified in writing.' },
    ],
    whatNow: 'Bar Atlas is no longer a verified safe space and the venue may not display the badge. If you have a recent experience here — good or bad — you can still file a report; the record stays open in case the venue applies to be re-reviewed in future, which requires demonstrable change.',
  },
  {
    status: 'removed', slug: 'clube-vertigo', cat: 'Club', typeLabel: 'Club', name: 'Clube Vértigo', hood: 'Cais do Sodré',
    reason: 'A pattern of selective, racialised door policy at queer nights.',
    removedDate: '21 Mar 2026', listedSince: 'June 2023', flags: 7,
    reasonLong: [
    ...
    timeline: [
      { date: '6 Jan 2026', event: 'First of seven reports logged over the quarter.' },
      { date: '24 Feb 2026', event: 'Badge suspended after collective flag from the Queer & of Colour community.' },
      { date: '12 Mar 2026', event: 'Review panel reviewed all seven reports and the venue response.' },
      { date: '21 Mar 2026', event: 'Listing permanently removed.' },
    ],
    whatNow: 'Clube Vértigo is delisted. We shared an anonymised summary of the reports with the venue. Re-review would require a published, audited door policy and a clean record over a full season — they have not applied.',
  },
  {
    status: 'removed', slug: 'cafe-norte', cat: 'Cafe', typeLabel: 'Café', name: 'Café Norte', hood: 'Saldanha',
    reason: 'New owners; repeated misgendering and no response to three flags.',
    removedDate: '2 Feb 2026', listedSince: 'September 2022', flags: 3,
    reasonLong: [
    ...
    timeline: [
      { date: 'Nov 2025', event: 'Ownership change flagged; early re-review opened automatically.' },
      { date: 'Dec 2025', event: 'Three member reports of repeated misgendering.' },
      { date: 'Jan 2026', event: 'Two offers of free staff training sent; no response.' },
      { date: '2 Feb 2026', event: 'Listing removed pending engagement from new ownership.' },
    ],
    whatNow: 'This is a soft removal, not a verdict on individuals — it can be reversed. If the new owners take up the training and a fresh round of visits meets the criteria, Café Norte can be re-listed. The door is open; they need to walk through it.',
  },
]
