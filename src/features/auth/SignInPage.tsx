  ...
  return (
    <AuthLayout>
      ...
      <div className={styles.footer}>
        <a href="#" onClick={(e) => { e.preventDefault(); showToast('Password reset link sent', 'info') }}>
          Forgot password?
        </a>
        <a href="#" className="invite" onClick={(e) => { e.preventDefault(); navigate('/invite') }}>
      ...
      <button className={styles.google} onClick={() => showToast('Google sign-in is a demo', 'info')}>
