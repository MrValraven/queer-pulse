...
export const VISIBILITY_OPTIONS = [
  { value: 'open', title: 'Open to connect', desc: 'Anyone in the network can see your profile and say hello' },
  { value: 'network', title: 'Network only', desc: 'Reachable through mutual connections' },
...
export const TOUR_COMMUNITIES = [
  { name: 'Trans & Non-Binary Hub', desc: 'Healthcare, legal guides, peer support, and community.' },
  { name: 'Queer Parent Network', desc: 'For LGBTQ+ parents, co-parents, and people navigating parenthood.' },
  { name: 'Queer & of Colour', desc: "An intersectional space — race and queerness aren't separate." },
  { name: 'Queer Elders (50+)', desc: 'For members 50 and over. Wisdom, memory, community.' },
  { name: 'Queer Youth (18–25)', desc: 'Career, city navigation, peer support for younger members.' },
  { name: 'Disabled Queers', desc: 'Disability, chronic illness, and queerness — both identities belong.' },
  { name: 'Queer Mental Health Peer Support', desc: 'Moderated, confidential. Shared experience, no advice unless asked.' },
  { name: 'Rainbow Arts Collective', desc: 'Visual artists, photographers, makers. Monthly crits + group shows.' },
];
