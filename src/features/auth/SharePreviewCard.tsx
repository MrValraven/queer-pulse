 ...
 */
export function SharePreviewCard({ senderName, description, url }: SharePreviewCardProps) {
  return (
    <div className={styles.previewWrap}>
      ...
      <div className={styles.previewMeta}>
        ...
        <div className={styles.previewTitle}>{senderName} invited you to QueerPulse</div>
