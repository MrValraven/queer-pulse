...
export function Step1({
  ...
  return (
    <div className={styles.pane}>
      <h2>
        How do you want to <em>receive your codes?</em>
      </h2>
      <p className={styles.paneSub}>
        An authenticator app is the most secure. SMS works if you don't have one
        — but is less safe to SIM-swap attacks.
      </p>
      <div className={styles.methodGrid}>
        ...
        >
          ...
          <div className={styles.methodText}>
            ...
            <p>
              Use Google Authenticator, 1Password, Authy, or similar. Works
              offline.
            </p>
          </div>
        </button>
        ...
        >
          <div className={[styles.methodIc, styles.methodIcJade].join(" ")}>
            <svg
              ...
              strokeLinejoin="round"
            >
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 5.15 8.81 19.79 19.79 0 0 1 2.08 4.18 2 2 0 0 1 4.07 2h3a2 2 0 0 1 2 1.72c.09.57.21 1.19.36 1.78" />
            </svg>
          </div>
          <div className={styles.methodText}>
            <h3>
              SMS code<span className={styles.unavailable}>Unavailable</span>
            </h3>
...
export function Step2({
  ...
  return (
    <div className={styles.pane}>
      <h2>
        Scan with your <em>authenticator app.</em>
      </h2>
      <p className={styles.paneSub}>
        Open the app, tap "+", choose "Scan QR code", and point it at this
        image.
      </p>
      <div className={styles.qrGrid}>
        ...
        <div className={styles.qrInfo}>
          <ol>
            ...
            <li>
              Tap <b>Add</b> or <b>+</b>, then <b>Scan QR code</b>.
            </li>
            <li>Point your camera at the code on the left.</li>
            <li>
              Your app will save a QueerPulse entry and start generating
              six-digit codes.
            </li>
          </ol>
          <div className={styles.secretBlock}>
            ...
            <button
              ...
              onClick={onCopy}
              style={
                copyLabel === "Copied" ? { color: "var(--jade)" } : undefined
              }
            >
              {copyLabel}
            </button>
...
export function Step3({
  ...
  return (
    <div className={styles.pane}>
      <h2>
        Verify it's <em>working.</em>
      </h2>
      <p className={styles.paneSub}>
        Enter the six-digit code your app is showing right now.
      </p>
      <div
        className={[styles.codeRow, codeError ? styles.codeRowError : ""]
          .filter(Boolean)
          .join(" ")}
      >
        {digits.map((d, i) => (
      ...
      <div
        className={[
          styles.codeMsg,
          codeMsgOk ? styles.codeMsgOk : "",
          codeError ? styles.codeMsgError : "",
        ]
          .filter(Boolean)
          .join(" ")}
      >
...
export function Step4({
  ...
  return (
    <div className={styles.pane}>
      <h2>
        Save your <em>backup codes.</em>
      </h2>
      <p className={styles.paneSub}>
        If you lose your phone, these are your way back in. Each one works once.
        Print them, screenshot them, drop them in your password manager — but
        don't lose them.
      </p>
      ...
      <div className={styles.bcodeWarn}>
        <b>Heads up:</b> we'll never show these again. Store them somewhere safe
        before continuing.
      </div>
      <div className={styles.bcodeActions}>
        <Button variant="ghost" onClick={onCopyCodes}>
          Copy all
        </Button>
  ...
  return (
    <div className={styles.donePanel}>
      ...
      <h2 className={styles.doneTitle}>
        Two-factor is <em>on.</em>
      </h2>
      <p className={styles.doneSub}>
        From now on, you'll enter a code from your authenticator app each time
        you sign in from a new device.
      </p>
      <div className={styles.doneActions}>
        <Button variant="ghost-dark" onClick={onSecurity}>
          Back to Security
        </Button>
