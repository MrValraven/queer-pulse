...
export function CinemaBrowsePage() {
  ...
  const activeChips = [
    ...[...filters.access].map(
      (a) => ACCESS_FILTERS.find((x) => x.value === a)?.label ?? a,
    ),
    filters.format,
    ...filters.madeBy,
    ...filters.country,
    ...
    <CinemaShell>
      <section className={styles.hero}>
        <div className="wrap">
          ...
          <p>
            142 films, programmed by queer people and paid to queer people.
            Filter by access, format, language, and mood — never by an
            algorithm.
          </p>
        </div>
      </section>
