          ...
          {TIERS.map((tier) => (
            <div key={tier.nameEm} className={[styles.tier, tier.featured && styles.featured].filter(Boolean).join(' ')}>
              ...
              <div className={styles.tierName}>
                {tier.namePre}<em>{tier.nameEm}</em>
              </div>
      ...
      <div className="wrap">
        ...
        <div className={styles.paysGrid}>
          <div className={styles.payCard}>
            ...
            <div className={styles.pcTitle}>Paid to <em>filmmakers</em></div>
          ...
          <div className={styles.payCard}>
            ...
            <div className={styles.pcTitle}>Commissioning <em>fund</em></div>
          ...
          <div className={styles.payCard}>
            ...
            <div className={styles.pcTitle}>Curators &amp; <em>captions</em></div>
