...
export function ComposeThreadModal({ onClose, onPublish }: ComposeThreadModalProps) {
  useScrollLock()
  ...
  return (
    <div className={styles.overlay} onClick={onClose}>
      <div
        className={published ? `${styles.dialog} ${styles.dialogConfirm}` : styles.dialog}
        role="dialog"
        aria-modal="true"
      ...
      >
        {published ? (
          ...
          >
            <h2 id="compose-title" className={styles.dialogTitle}>New post</h2>
            ...
            <div className={styles.dialogActions}>
              ...
              <Button variant="primary" type="submit" disabled={!canPublish}>Publish post</Button>
            </div>
          </form>
        )}
      </div>
