              ...
              {CATS.map((c) => (
                ...
                >
                  ...
                  <span className={styles.catCount}>
                    {c.id === "all" ? allThreads.length : (counts[c.id] ?? 0)}
                  </span>
                </button>
              ))}
                    ...
                    <FadeIn key={t.id} delay={Math.min(idx, 8) * 60}>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className={styles.threadExcerpt}>
                            {t.excerpt}
                          </div>
