...
const THREADS: Thread[] = [
  ...
  { id: 11, cat: 'arts', title: 'Vote: Queer film series — what do we watch in July?', excerpt: "We're doing our first proper screening. Submit and upvote films below. Foreign language films very welcome.", author: { i: MEMBERS.sofia.initials, n: memberName('sofia'), t: '#4A8C6F', tt: '#fff' }, posted: '2 days ago', upvotes: 18, comments: 12, tags: ['film', 'vote'] },
  ...
  { id: 15, cat: 'jobs', title: 'Queer-run bookshop in Anjos — hiring a bookseller', excerpt: "The bookshop we've been building is opening in September. Looking for a part-time bookseller with a love of queer literature.", author: { i: MEMBERS.ines.initials, n: memberName('ines'), t: '#E8775A', tt: '#fff' }, posted: '1 day ago', upvotes: 31, comments: 14, tags: ['jobs', 'bookshop'] },
