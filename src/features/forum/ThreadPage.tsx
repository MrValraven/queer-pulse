        ...
        <div className={styles.layout}>
          <div className={styles.opCard}>
            ...
            <div className={styles.opFooter}>
              ...
              <button
                ...
                onClick={() => setReportingAuthor(thread.author.n)}
              >
                Report
              </button>
            </div>
          ...
          <div className={styles.replyBar}>
            <span className={styles.replyCount}>
              {localReplies.length} repl
              {localReplies.length === 1 ? "y" : "ies"}
            </span>
            ...
            {!loading &&
              replies.map((r, i) => (
                <FadeIn
                  ...
                  className={[
                    styles.reply,
                    r.helpful && styles.replyHighlighted,
                  ]
                    .filter(Boolean)
                    .join(" ")}
                >
                    ...
                    {(() => {
                      ...
                      return (
                        <button
                          ...
                          aria-label={
                            isLiked ? "Unlike this reply" : "Like this reply"
                          }
                          className={[
                            styles.replyReact,
