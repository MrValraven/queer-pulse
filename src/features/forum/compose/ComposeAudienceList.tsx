...
import { AudienceRow } from "./ComposeAudienceRow";
  ...
  return (
    <section className={styles.section} aria-labelledby={headingId}>
      ...
      {/* Cross-posting is meaningless from the town square, so the row only
          ...
          It opens and closes in place so the sections below glide with it. */}
      <Collapse isOpen={communitySlug !== TOWN_SQUARE_SLUG}>
