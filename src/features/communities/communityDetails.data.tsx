...
export const COMMUNITY_DETAILS: Record<string, CommunityDetail> = {
  "queer-social": {
    ...
    about: [
      <>We get queer Lisbon in the same room once a month, somewhere different each time — a bar in Cais do Sodré, a terrace in Graça, a park when the weather behaves. No agenda, no name tags, no "so what do you do?".</>,
      <>It started because the only places to meet other queer people were clubs, and not everyone wants the club. This is the low-stakes version: show up, talk to one new person, leave when you like.</>,
    ],
    whoFor: [
  ...
  "rainbow-arts": {
    ...
    about: [
      <>An open studio collective for queer visual artists and makers. We run monthly crits, share resources and equipment, and put on group shows in borrowed spaces a few times a year.</>,
      <>You don't need a gallery, an agent, or a finished body of work — you need something you're making and a willingness to look at other people's honestly. The collective is the room before the room.</>,
    ],
    whoFor: [
      "Queer visual artists, makers, and designers at any stage",
      "People who want honest crits, not polite ones",
  ...
  "trans-mutual-aid": {
    ...
    about: [
      <>Peer support, resource sharing, and practical help for trans people in Lisbon — run by and for the community. Hormone-supply tips, vetted clinicians, a spare-room board, and people who simply get it.</>,
      <>Mutual aid means it's not charity and it's not a service. It's reciprocal: people give what they can and take what they need, and the ledger is trust, not money.</>,
    ],
    whoFor: [
      "Trans and non-binary people in or arriving to Lisbon",
      "Anyone navigating healthcare, names, or paperwork who wants peers, not professionals",
  ...
  "queer-runners": {
    ...
    about: [
      <>We run together every Sunday morning. Different routes, different paces, same values. Whether you've never run 5K or you're training for a marathon — if you're queer and you're in Lisbon, you belong here.</>,
      <>The community started with six people and a WhatsApp group. Now we meet for coffee after every run. No competitive pressure, no pace anxiety — just movement and company.</>,
    ],
    whoFor: [
      "Queer runners of all paces — from nervous beginners to half-marathon trainers",
      "People who want to meet others while being active, not just at bars",
  ...
  "queer-parents": {
    ...
    about: [
      <>For LGBTQ+ parents, co-parents, and people navigating parenthood — a group that's often an afterthought in queer spaces, and isn't here. Playdates, honest talk, and the logistics no one warns you about.</>,
      <>Some of us came to parenting through adoption, some through co-parenting arrangements, some the old-fashioned ways. What we share is doing it queerly, in a city that doesn't always have a box for our families.</>,
    ],
    whoFor: [
  ...
  "coming-out": {
    ...
    about: [
      <>A private, low-visibility space for people navigating coming out — at work, to family, or to themselves. Additional privacy controls apply: reduced visibility, no public member list, and stricter moderation.</>,
      <>There's no pressure to be "out" to join, and nothing here is visible from your public profile. People move through this space and graduate out of it, and that's exactly the point.</>,
    ],
    whoFor: [
  ...
  "trans-hub": {
    ...
    about: [
      <>Healthcare navigation, legal guides, peer support, and community — a dedicated space for trans and non-binary people, not an afterthought tucked into a broader network.</>,
      <>The Hub keeps the maps everyone needs: who prescribes, who'll do your paperwork, which clinic won't waste your fifteen minutes. Plus the human part — people who've walked it and will walk it with you.</>,
    ],
    whoFor: [
  ...
  "queer-elders": {
    ...
    about: [
      <>For LGBTQ+ members 50 and over — enormous lived wisdom, long memories, and a community that sees and genuinely honours you rather than treating you as history.</>,
      <>We meet in daylight, somewhere with chairs and decent acoustics. Some of us were at the first marches; some came out at sixty. All of us are still here, still queer, still very much in the present tense.</>,
    ],
    whoFor: [
      "LGBTQ+ people aged 50 and over",
      "Elders who want peers, not to be a panel about 'the old days'",
  ...
  "queer-youth": {
    ...
    about: [
      <>Career starting points, city navigation, and peer support for members 18–25 — the community we all needed and mostly didn't have at that age. First jobs, first flats, first time being fully out.</>,
      <>It's run with the under-25s, not at them. Older members drop in to mentor when asked, but the room belongs to the people in it.</>,
    ],
    whoFor: [
    ...
    topicThread: {
      ...
      replies: [
        { initials: "NA", name: "Nuno Alves", tint: "plum", text: "Marvila is still doable and the community out there is growing fast. Arroios is central but climbing." },
        { initials: "FM", name: "Fátima Mendes", tint: "coral", text: "Check the Flatmates board here before the open market — queer-friendly shares come up first." },
      ],
    },
  },
  ...
  "queer-poc": {
    ...
    about: [
      <>An intersectional space for queer people of colour in Lisbon. Race and queerness aren't separate conversations to be held in separate rooms — not here.</>,
      <>We hold space for the specific: the white queer scene that doesn't see you, the family that sees one part and not the other, the city that reads you twice. And we hold the joy, too.</>,
    ],
    whoFor: [
    ...
    topicThread: {
      ...
      replies: [
        { initials: "KL", name: "Kai Larsson", tint: "jade", text: "The shops just off Mouraria have the best spices I've found, and the owners are lovely." },
        { initials: "SC", name: "Sofia Castaño", tint: "coral", text: "Adding a couple of South American spots near Anjos. Let's do a group shop-and-cook." },
      ],
    },
  },
  ...
  "disabled-queers": {
    ...
    about: [
      <>Disability, chronic illness, and queerness intersect in ways most platforms ignore. Both identities belong here fully, not partially — and "access" is the starting point, not the afterthought.</>,
      <>Every gathering is hybrid, seated, low-sensory by default, and carers are always welcome. No inspiration required. Just people who understand spoons, flares, and the specific exhaustion of explaining both halves of yourself.</>,
    ],
    whoFor: [
      "Disabled and chronically ill queer people",
      "People who need access designed in, not bolted on",
    ...
    topicThread: {
      ...
      replies: [
        ...
        { initials: "AK", name: "Anika Kovač", tint: "coral", text: "Adding A Cena in Mouraria. Purpose-built, hearing loop, the lot. Cross-posting to the Accessibility page." },
      ],
    },
  },
};
