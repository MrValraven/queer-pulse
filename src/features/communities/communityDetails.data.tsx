...
export const COMMUNITY_DETAILS: Record<string, CommunityDetail> = {
  ...
  "queer-parents": {
    ...
    about: [
      <>
        ...
        group that's often an afterthought in queer spaces, and isn't here.
  ...
  "trans-hub": {
    ...
    about: [
      <>
        ...
        dedicated space for trans and non-binary people, not an afterthought
        tucked into a broader network.
      </>,
      <>
  ...
  "queer-youth": {
    ...
    about: [
      ...
      <>
        It's run with the under-25s, not at them. Older members drop in to
  ...
  "queer-poc": {
    ...
    about: [
      <>
        ...
        queerness aren't separate conversations to be held in separate rooms —
        not here.
      </>,
      <>
  ...
  "disabled-queers": {
    ...
    about: [
      <>
        ...
        platforms ignore. Both identities belong here fully, not partially — and
        "access" is the starting point, not the afterthought.
      </>,
      <>
