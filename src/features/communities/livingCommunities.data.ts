...
const bySlug: Record<string, Person> = Object.fromEntries(
  POOL.map((p) => [p.slug!, p]),
);
...
const RUNNERS_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("monica"),
        text: "Completely. The slow group walks the hills and nobody minds. You finish with us.",
        time: "2h",
      },
    ],
    time: "5h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("carla"),
        text: "YES Sofia. Watching you build this has been the best part of my year.",
        time: "1h",
      },
    ],
    time: "6h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("diogo"),
        text: "ASICS Gel-Kayano. Pricey but my feet forgave me. Sportzone in Colombo has them.",
        time: "4h",
      },
      {
        author: P("sofia"),
        text: "Brooks Adrenaline. Saved my knees on the Graça hills.",
        time: "3h",
      },
    ],
    time: "1d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("monica"),
        text: "Rita this is so good. Putting it on the events page immediately.",
        time: "20h",
      },
    ],
    time: "2d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("kai"),
        text: "I'm in. I need the accountability more than the training.",
        time: "18h",
      },
    ],
    time: "2d",
...
const RUNNERS_MOMENTS: PulseMoment[] = [
  ...
  },
  {
    id: "run-m3",
    kind: "joined",
    text: "Beatriz joined the community",
    time: "2d",
  },
];
...
const RUNNERS_EVENTS: CommunityEvent[] = [
  communityEventFromGathering("run-e1", "queer-runners-run"),
  {
    ...
    dd: "15",
    mm: "Jun",
    title: "Hill repeats + brunch",
    meta: "Sunday · 8:00 · Monsanto",
    spots: "open to all",
  },
  {
    id: "run-e3",
    dd: "22",
    mm: "Jun",
    title: "Beginners-only 5 km",
    meta: "Sunday · 9:00 · riverside flat",
    spots: "beginners welcome",
  },
  {
    id: "run-e4",
    dd: "1",
    mm: "Jun",
    title: "June Pride 10 km",
    meta: "Sunday · 8:00 · finished",
    past: true,
    recapHref: "#",
  },
];
...
const RUNNERS_RESOURCES: CommunityResource[] = [
  {
    title: "Pace-group guide (5K → half)",
    href: "/resources/running-guide",
    kind: "guide",
    note: "Which group is yours, honestly",
  },
  {
    title: "Step-free Lisbon routes map",
    href: "/resources/accessible-lisbon",
    kind: "doc",
    note: "12 loops, all verified accessible",
  },
  { title: "Post-run coffee spots", href: "/gatherings", kind: "link" },
  {
    title: "What to bring your first time",
    href: "/resources/running-guide",
    kind: "guide",
  },
];
...
const HUB_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("rui"),
        text: "And if you need the name-change paperwork walked through, I do it pro bono. DM me.",
        time: "4h",
      },
    ],
    time: "6h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("kai"),
        text: "This list got me through my first appointment without the fifteen-minutes-of-explaining tax. Thank you.",
        time: "3h",
      },
    ],
    time: "1d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("rita"),
        text: "The first one I went to, I didn't say a word and still left lighter. Recommend even if you just listen.",
        time: "12h",
      },
    ],
    time: "2d",
...
const HUB_MOMENTS: PulseMoment[] = [
  ...
  },
  {
    id: "hub-m3",
    kind: "joined",
    text: "A new member joined the Hub",
    time: "2d",
  },
];
...
const HUB_EVENTS: CommunityEvent[] = [
  ...
  },
  {
    ...
    meta: "Thursday · 19:00 · members only",
    past: true,
    recapHref: "#",
  },
];
...
const HUB_RESOURCES: CommunityResource[] = [
  {
    title: "Vetted clinician list (June)",
    href: "/resources/trans-healthcare",
    kind: "doc",
    note: "47 names, re-checked every 90 days",
  },
  {
    title: "Hormone supply + alternatives guide",
    href: "/resources/trans-healthcare",
    kind: "guide",
  ...
  {
    title: "Healthcare rights one-pager",
    href: "/resources/trans-healthcare",
    kind: "doc",
  },
  {
    title: "ILGA Portugal legal helpline",
...
const ARTS_PULSE: Post[] = [
  {
    ...
    replies: [
      {
        author: P("kai"),
        text: "Bringing a half-finished risograph thing and I'm terrified. See you there.",
        time: "4h",
      },
      {
        author: P("luisa"),
        text: "Half-finished is exactly what a crit is for. That's the brave version.",
        time: "3h",
      },
    ],
    time: "7h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("beatriz"),
        text: "In. I'll use it constantly for zine covers and help maintain it.",
        time: "2h",
      },
      {
  ...
  },
  {
    ...
    replies: [
      {
        author: P("luisa"),
        text: "That coral is going straight into the autumn show. No notes.",
        time: "5h",
      },
    ],
    time: "1d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("rita"),
        text: "The atelier back wall is free most weekday afternoons. Keys are with me.",
        time: "20h",
      },
    ],
    time: "2d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("luisa"),
        text: "This is the best idea posted here all year. Let's do it next month.",
        time: "16h",
      },
    ],
    time: "3d",
...
const ARTS_MOMENTS: PulseMoment[] = [
  ...
  },
  {
    id: "art-m2",
    kind: "joined",
    text: "Nuno joined the collective",
    time: "1d",
  },
  {
    id: "art-m3",
...
const ARTS_EVENTS: CommunityEvent[] = [
  communityEventFromGathering("art-e1", "portfolio-night"),
  {
    ...
    dd: "28",
    mm: "Jun",
    title: "Riso print day (collective use)",
    meta: "Saturday · 13:00 · Atelier Pulso",
    spots: "sign up inside",
  },
  {
    id: "art-e3",
    dd: "24",
...
const ARTS_RESOURCES: CommunityResource[] = [
  ...
  },
  {
    ...
    href: "/resources/shared-equipment",
    kind: "doc",
    note: "Riso, kiln, projector",
  },
  {
  ...
  {
    title: "Group show photo archive",
    href: "/resources/group-show-archive",
    kind: "link",
  },
];
...
const SOCIAL_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("tomas"),
        text: "I'll be in a plum scarf at the lift at 18:50, then we move up together.",
        time: "3h",
      },
    ],
    time: "6h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("tomas"),
        text: "This is exactly why we do it. Thank you, genuinely.",
        time: "3h",
      },
    ],
    time: "1d",
  ...
  },
  {
    ...
    replies: [
      ...
      {
        author: P("nuno"),
        text: "Adding Heim in Arroios. Seated, low music, good coffee.",
        time: "6h",
      },
    ],
    time: "2d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("beatriz"),
        text: "I almost turned around at my first one too. Now I help set up. It gets easy.",
        time: "20h",
      },
    ],
    time: "3d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("rita"),
        text: "Brought three last time, took one home. Perfect format.",
        time: "15h",
      },
    ],
    time: "4d",
...
const SOCIAL_RESOURCES: CommunityResource[] = [
  ...
  },
  {
    ...
    href: "/gatherings",
    kind: "link",
    note: "Step-free and quiet options especially welcome",
  },
];
...
const AID_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("rui"),
        text: "The insurance section was long overdue. Thank you, Anika.",
        time: "3h",
      },
    ],
    time: "5h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("kai"),
        text: "Coming for the first time. Thank you for making it genuinely drop-in.",
        time: "6h",
      },
    ],
    time: "1d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("anika"),
        text: "This is everything the board is for. So glad it worked.",
        time: "10h",
      },
    ],
    time: "3d",
...
const AID_MOMENTS: PulseMoment[] = [
  ...
  },
  {
    id: "aid-m3",
    kind: "joined",
    text: "A new member joined the network",
    time: "2d",
  },
];
...
const AID_EVENTS: CommunityEvent[] = [
  communityEventFromGathering("aid-e1", "trans-mutual-aid"),
  {
    ...
    dd: "20",
    mm: "Jun",
    title: "Name-change clinic with ILGA Portugal",
    meta: "Friday · 18:30 · ILGA office",
    spots: "12 spots left",
  },
  {
    id: "aid-e3",
...
const AID_RESOURCES: CommunityResource[] = [
  {
    ...
    href: "/resources/trans-healthcare",
    kind: "doc",
    note: "49 names, peer-maintained, re-checked every 90 days",
  },
  {
    title: "Hormone supply + pharmacy map",
    href: "/resources/trans-healthcare",
    kind: "guide",
...
const PARENTS_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("tomas"),
        text: "Bringing a lot of food. Please nobody else bring food, I always overcook.",
        time: "5h",
      },
    ],
    time: "8h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("beatriz"),
        text: "DM me. Our adoption story is unusual and worth telling.",
        time: "20h",
      },
    ],
    time: "3d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("fatima"),
        text: "This is genuinely the update I need to hear. Which school?",
        time: "12h",
      },
    ],
    time: "4d",
...
const PARENTS_RESOURCES: CommunityResource[] = [
  {
    ...
    href: "/resources/queer-paediatricians",
    kind: "doc",
...
const COMINGOUT_PULSE: Post[] = [
  {
    ...
    replies: [
      {
        author: P("jonas"),
        text: "If anyone wants to talk one-on-one before or after, I'm here. DM open.",
        time: "3h",
      },
    ],
    time: "4h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("catarina-vaz"),
        text: "You did it. This is yours.",
        time: "2h",
      },
      {
        author: P("jonas"),
        text: "Rooting for you was easy. Thank you for coming back to tell us.",
        time: "1h",
      },
    ],
    time: "2d",
...
const COMINGOUT_MOMENTS: PulseMoment[] = [
  {
    id: "cout-m1",
    kind: "joined",
    text: "A new member joined the space",
    time: "1d",
  },
  {
    id: "cout-m2",
...
const COMINGOUT_RESOURCES: CommunityResource[] = [
  ...
  {
    title: "Mental health support in Portugal",
...
const ELDERS_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("monica"),
        text: "Looking forward to it. Bringing the archive print-outs I mentioned last time.",
        time: "4h",
      },
    ],
    time: "8h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("sofia"),
        text: "These first sessions have been remarkable. History walks in the room and sits down.",
        time: "5h",
      },
    ],
    time: "2d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("rui"),
        text: "We trust you with it completely.",
        time: "3h",
      },
    ],
    time: "3d",
...
const ELDERS_EVENTS: CommunityEvent[] = [
  communityEventFromGathering("eld-e1", "queer-elders-social"),
  {
    ...
    meta: "Wednesday · 14:00 · by invitation",
    spots: "private",
  },
  {
    id: "eld-e3",
...
const ELDERS_RESOURCES: CommunityResource[] = [
  {
    title: "LGBTQ+ aging and healthcare guide (PT)",
    href: "/resources/lgbtq-aging-guide",
    kind: "doc",
  ...
  {
    title: "Accessible venues in Lisbon",
    href: "/resources/accessible-lisbon",
    kind: "link",
...
const YOUTH_PULSE: Post[] = [
  {
    ...
    replies: [
      {
        author: P("nuno"),
        text: "I'll be there early to set up. Bring your laptop and anything you've written so far.",
        time: "5h",
      },
      {
        author: P("kai"),
        text: "Can I bring a freelance portfolio question or is this more 9–5 focused?",
        time: "4h",
      },
      {
        author: P("rita"),
  ...
  },
  {
    ...
    replies: [
      {
        author: P("sofia-castano"),
        text: "Applied for the Marvila one this morning. Thank you.",
        time: "4h",
      },
    ],
    time: "1d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("rita"),
        text: "This is what we built it for. So glad you're here.",
        time: "2h",
      },
    ],
    time: "2d",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("luisa"),
        text: "Almost always the former. 'Portfolio rate' is not a rate. Your quote was right.",
        time: "8h",
      },
      {
        author: P("nuno"),
  ...
  },
  {
    ...
    replies: [
      {
        author: P("kai"),
        text: "Yes please. I've been trying to break in and keep hitting walls.",
        time: "15h",
      },
    ],
    time: "4d",
...
const YOUTH_MOMENTS: PulseMoment[] = [
  ...
  },
  {
    id: "yth-m2",
    kind: "joined",
    text: "Beatriz joined the network",
    time: "2d",
  },
  {
    id: "yth-m3",
    kind: "resource",
    text: "Nuno pinned 3 new job opportunities",
    time: "1d",
  },
];
...
const YOUTH_EVENTS: CommunityEvent[] = [
  communityEventFromGathering("yth-e1", "queer-youth-gathering"),
  {
    ...
    dd: "27",
    mm: "Jun",
    title: "Freelance toolkit night",
    meta: "Friday · 18:00 · invoicing, contracts, rates",
    spots: "open to all",
  },
  {
    id: "yth-e3",
    dd: "30",
    mm: "May",
    title: "Flatmates meetup",
    meta: "Friday · 18:00 · housing & neighbourhoods",
    past: true,
    recapHref: "#",
  },
];
...
const YOUTH_RESOURCES: CommunityResource[] = [
  {
    title: "Queer-friendly employers in Lisbon",
    href: "/work/employer-reviews",
    kind: "doc",
  ...
  {
    title: "First-gen professional toolkit",
...
const POC_PULSE: Post[] = [
  {
    ...
    replies: [
      {
        author: P("tomas"),
        text: "Menu confirmed: four courses, completely ridiculous, you'll leave full. Come hungry.",
        time: "5h",
      },
      {
        author: P("kai"),
        text: "Adding Amara's playlist from last month to the queue. It was perfect.",
        time: "4h",
      },
    ],
    time: "7h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("fatima"),
        text: "This map is one of the best things we've made together.",
        time: "3h",
      },
      {
        author: P("nuno"),
  ...
  },
  {
    ...
    replies: [
      {
        author: P("luisa"),
        text: "The section on cultural institutions is painfully accurate. We've tried.",
        time: "14h",
      },
    ],
    time: "5d",
...
const POC_EVENTS: CommunityEvent[] = [
  communityEventFromGathering("poc-e1", "queer-of-colour-gathering"),
  {
    ...
    dd: "13",
    mm: "Jul",
    title: "Intersectional futures salon",
    meta: "Sunday · 17:00 · open conversation",
    spots: "open to all",
  },
  {
    id: "poc-e3",
...
const POC_RESOURCES: CommunityResource[] = [
  ...
  {
    title: "Queer POC organisations in Portugal",
    href: "/resources/qtipoc-organisations",
    kind: "link",
  },
  {
  ...
  {
    title: "QTIPOC archive project",
    href: "/resources/qtipoc-archive",
    kind: "link",
  },
];
...
const DISABLED_PULSE: Post[] = [
  {
    ...
    replies: [
      ...
      {
        author: P("catarina-vaz"),
        text: "Online link is live in the events tab. Zoom room opens 15 min early for people who want to settle in.",
        time: "5h",
      },
    ],
    time: "7h",
  ...
  },
  {
    ...
    replies: [
      {
        author: P("catarina-vaz"),
        text: "Can confirm A Cena. Added accessible toilet detail and exact entrance location.",
        time: "4h",
      },
    ],
    time: "2d",
  ...
  },
  {
    ...
    replies: [
      ...
      {
        author: P("beatriz"),
        text: "Permission to rest is also training. I had to learn that slowly.",
        time: "8h",
      },
    ],
    time: "3d",
...
const DISABLED_EVENTS: CommunityEvent[] = [
  ...
  },
  {
    ...
    dd: "19",
    mm: "May",
    title: "Accessible Lisbon walkabout",
    meta: "Sunday · 15:00 · Baixa",
    past: true,
    recapHref: "#",
  },
];
...
const DISABLED_RESOURCES: CommunityResource[] = [
  ...
  },
  {
    ...
    href: "/resources/disability-healthcare",
    kind: "guide",
  },
  {
...
const HUB_REQUESTS: ModRequest[] = [
  {
    id: "hub-r1",
    person: P("nuno"),
    note: "Just moved to Lisbon, starting HRT next month and looking for peers who get it.",
    time: "2h",
  },
  {
    id: "hub-r2",
    person: P("luisa"),
    note: "Referred by Catarina. Happy to verify.",
    time: "1d",
  },
