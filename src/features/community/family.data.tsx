...
export const SITUATIONS: { name: string; desc: string; to: string; tab: TabId }[] = [
...
export const TABS: Tab[] = [
  {
    id: 'adoption',
    label: 'Adoption',
    headTitle: <>Adoption in <em>Portugal</em></>,
    headText:
  ...
  },
  {
    ...
    headTitle: <>IVF &amp; <em>Assisted Reproduction</em></>,
    headText:
  ...
  },
  {
    id: 'coparenting',
    label: 'Co-parenting',
    headTitle: <>Co-parenting — <em>together, differently</em></>,
    headText:
  ...
  },
  {
    ...
    headTitle: <>Donor <em>questions</em></>,
    headText:
  ...
  },
  {
    ...
    headTitle: <>Legal <em>parenthood</em></>,
    headText:
