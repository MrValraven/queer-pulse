...
export const FEATURED: Featured[] = [
  {
    nameMain: "André ",
    nameEm: "Quintela",
    discipline: "Analog Photography · Medium Format Film",
    quote:
      "I photograph people who have never liked having their photograph taken. Something always happens.",
    badges: ["commission", "open call"],
  },
  {
    nameMain: "Diogo ",
    nameEm: "Vasques",
    discipline: "Electronic Music · Live Sets · Film Scoring",
    quote:
      "The best show I ever played was to 12 people in a basement. No one was performing anything.",
    badges: ["commission", "live sets"],
  },
  {
    nameMain: "Lena ",
    nameEm: "Ferraz",
    discipline: "Textile Art · Embroidery · Installation",
    quote:
      "I embroider bodies because bodies are the first thing that gets erased.",
...
export const ART_WORKS: ArtWork[] = [
  {
    artist: memberName("ines"),
    initials: MEMBERS.ines!.initials,
    tint: "coral",
    hood: "Príncipe Real",
    medium: "Editorial & Type Design",
...
export const MUSIC_ARTISTS: MusicArtist[] = [
  ...
  },
  {
    ...
    tint: "coral",
    hood: "Arroios",
    genre: "Folk · New Portuguese · Voice",
