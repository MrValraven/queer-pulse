...
export const STORIES_PART_2: ChangemakerStory[] = [
...

  {
    ...
    body: [
      ...
      "He trains queer activists and organisations in the practical stuff: how to lock down an account, how to organise without leaving a trail, how to protect a source or a member who could be outed by a careless screenshot. Not paranoia — hygiene.",
