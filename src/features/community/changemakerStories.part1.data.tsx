...
export const STORIES_PART_1: ChangemakerStory[] = [
...

  {
    ...
    lead: "He decided that the fifteen minutes trans patients spend explaining themselves should be the doctor's job to remove, so the patient no longer has to endure it.",
    body: [
...

  {
    ...
    summary:
      "Programmed the first queer season at a major Lisbon museum and co-founded the Rainbow Arts Collective. Making queer art central to Lisbon's cultural life.",
    impact: [
...

  {
    ...
    body: [
      ...
      "Consistency, in youth work, is the entire intervention. A mentor who disappears does more harm than one who was never there. Miguel understood that from the start, which is why he asks new volunteers to commit for a full school year.",
