    ...
    <article className={styles.gc}>
      <div className={styles.gcBook}>
        ...
        <div className={styles.gcBookInfo}>
          ...
          <span className={styles.gcGenre} style={{ background: GENRE_BG[g.genre], color: GENRE_FG[g.genre] }}>
            {g.genre}
          </span>
        </div>
      </div>
      <div className={styles.gcBody}>
        ...
        <div className={styles.gcMeta}>
          <span className={[styles.gm, g.format === 'irl' ? styles.gmIrl : styles.gmOnline].join(' ')}>
