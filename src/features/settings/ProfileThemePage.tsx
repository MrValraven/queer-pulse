        ...
        <div className={styles.layout}>
          <div className={styles.sidebar}>
            ...
            <div className={styles.coverStyleOpts}>
              {COVER_STYLES.map((cs) => (
                <div key={cs.key} className={`${styles.csOpt} ${coverStyle === cs.key ? styles.csOptSelected : ''}`} onClick={() => setCoverStyle(cs.key)}>
            ...
            <div className={styles.patternGrid}>
              {PATTERNS.map((p) => (
                <div key={p.key} className={`${styles.patSwatch} ${pattern === p.key ? styles.patSwatchSelected : ''}`} style={{ background: p.background }} title={p.title} onClick={() => setPattern(p.key)} />
              ))}
            </div>
            ...
            <select className={styles.badgeSelect}>
