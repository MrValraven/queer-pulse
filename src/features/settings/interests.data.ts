...
export const FREQ_OPTIONS: FreqOption[] = [
  { key: 'daily', title: 'Daily digest', desc: 'One email per day with your top updates' },
  { key: 'weekly', title: 'Weekly roundup', desc: 'A curated weekly summary of what matters' },
  { key: 'important', title: 'Only important', desc: 'Just notifications that need your action' },
]
