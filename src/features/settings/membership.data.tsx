...
export const INVOICES = ["May 2026", "April 2026", "March 2026"].map(
  (period) => ({
    period,
    amount: "€20.00",
  }),
...
export const ACCESS_ITEMS: { label: string; note: string }[] = [
  ...
  {
    label: "Mental health access programme",
    note: "Subsidised therapy referrals",
  },
  { label: "Micro-grant applications", note: "Quarterly — up to €200" },
  {
    label: "Member directory & discovery",
    note: "Find and connect with 247 members",
  },
];
