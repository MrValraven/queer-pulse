          ...
          {!submitted ? (
            <div className={styles.card}>
              ...
              <p className={styles.cardSub}>
                Select the categories you want included. You can request a full
                export or only specific data types. The archive will be
                delivered as a compressed folder to your registered email
                address.
              </p>
              ...
              <div className={styles.dataTypes}>
                {DATA_TYPES.map((dt, i) => (
                  <div
                    ...
                    className={[
                      styles.dtItem,
                      checked[i] && styles.dtItemChecked,
                    ]
                      .filter(Boolean)
                      .join(" ")}
                    role="button"
              ...
              <div className={styles.fmtRow}>
                {(["JSON", "CSV", "Both"] as Format[]).map((f) => (
                  <button
                    ...
                    className={[
                      styles.fmtBtn,
                      format === f && styles.fmtBtnSelected,
                    ]
                      .filter(Boolean)
                      .join(" ")}
                    onClick={() => setFormat(f)}
              ...
              <div className={styles.legalNote}>
                ...
                <p className={styles.legalNoteText}>
                  Under <strong>GDPR Article 20</strong>, we are required to
                  provide your data within <strong>30 days</strong> of a
                  verified request. We typically deliver within 24 hours. The
                  archive is encrypted in transit and the download link is
                  single-use.
                </p>
              </div>
            ...
            >
              ...
              <p className={styles.confirmBody}>
                Check your inbox for a confirmation link. Once verified, your
                archive will be ready within 24 hours.
              </p>
              <p className={styles.confirmResend}>
                Didn't receive it?{" "}
                <button
                  className={styles.confirmResendLink}
                  onClick={() => showToast("Verification email resent", "info")}
                >
                  Resend
                </button>
              </p>
