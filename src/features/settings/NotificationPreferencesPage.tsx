            ...
            <div className={styles.freqCard}>
              <div>
                ...
                <div className={styles.freqSub}>
                  A summary of activity since your last visit. Never
                  promotional.
                </div>
              </div>
            ...
            <div className={styles.channelMatrix}>
              ...
              {matrix.map((row, i) => (
                <div key={row.label} className={styles.cmRow}>
                  ...
                  <div className={styles.cmCheck}>
                    <input
                      type="checkbox"
                      className={styles.cmCheckbox}
                      checked={row.app}
                      onChange={() => toggleMatrix(i, "app")}
                    />
                  </div>
                  <div className={styles.cmCheck}>
                    <input
