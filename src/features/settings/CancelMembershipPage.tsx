      ...
      <div className={styles.page}>
          ...
          <div className={`${styles.pane} ${styles.screenIn}`} key={step}>
            ...
            <div className={styles.altList}>
              ...
              >
                ...
                <div className={styles.altText}>
                  ...
                  <div className={styles.altD}>
                    We freeze your renewal. You keep access. We don't charge
                    until you resume.
                  </div>
                </div>
              ...
              >
                ...
                <div className={styles.altText}>
                  <div className={styles.altT}>
                    Downshift to Member (€36/year)
                  </div>
                  <div className={styles.altD}>
                    Keep all community access. Drop Sustainer-only perks (open
                    studio, ILGA consult, magazine).
                  </div>
                </div>
                <div className={styles.altArrow}>→</div>
              </button>
              ...
              >
                ...
                <div className={styles.altText}>
                  ...
                  <div className={styles.altD}>
                    €12/year, no questions asked. The fund covers the
                    difference. <b>Genuinely.</b>
                  </div>
                </div>
                <div className={styles.altArrow}>→</div>
              </button>
            ...
            <div className={styles.actions}>
              ...
              <Link to={routes.membership}>
                <Button variant="ghost">Keep my Sustainer</Button>
              </Link>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className={`${styles.pane} ${styles.screenIn}`} key={step}>
            ...
            >
              ...
              <b style={{ color: "var(--plum)" }}>6 Jun 2027</b>. No refund —
              but no further charges.
            </p>
            <p
              style={{
                fontSize: 14,
            ...
            <div className={styles.actions}>
              ...
              <div className={styles.actionRight}>
                <Link to={routes.membership}>
                  <Button variant="primary">Keep my Sustainer</Button>
                </Link>
                <Button
                  variant="ghost"
                  disabled={!confirmed}
          ...
          <div className={`${styles.pane} ${styles.screenIn}`} key={step}>
            <div className={styles.farewell}>
              ...
              >
                ...
                <b style={{ color: "var(--plum)", fontWeight: 700 }}>
                  6 Jun 2027
                </b>
                .
              </p>
              ...
              <p
                style={{ fontSize: 13, color: "var(--ink-40)", marginTop: 12 }}
              >
                If this was a mistake, you can resubscribe one-tap from the
                email or your account settings — no penalty.
              </p>
          ...
          <div className={`${styles.pane} ${styles.screenIn}`} key={step}>
            <div className={styles.farewell}>
              ...
              <p className={styles.fwLead}>
                We've frozen your Sustainer renewal for <b>3 months</b>. You
                keep full access the whole time — and we won't charge you a cent
                until you resume.
              </p>
              <p className={styles.fwLead}>
              ...
              <p className={styles.fwNote}>
                Changed your mind? You can resume any time — it picks up right
                where you left off, no penalty.
              </p>
              <div className={styles.farewellBtns}>
        ...
        {step === "downshifted" && (
          <div className={`${styles.pane} ${styles.screenIn}`} key={step}>
            <div className={styles.farewell}>
              <div
                className={`${styles.farewellIc} ${styles.farewellIcAccent}`}
              >
                <FiArrowDown />
              </div>
              <h2
              ...
              <p className={styles.fwLead}>
                ...
                magazine) wind down at the end of your current term. Your next
                charge is <b>€36 on 6 Jun 2027</b>.
              </p>
              <p className={styles.fwNote}>
          ...
          <div className={`${styles.pane} ${styles.screenIn}`} key={step}>
            <div className={styles.farewell}>
              ...
              <p className={styles.fwLead}>
                ...
                <b>every Sustainer perk</b> exactly as it is now. The community
                fund covers the rest.
              </p>
              <p className={styles.fwLead}>
                Your next charge is <b>€12 on 6 Jun 2027</b>. We sent the
                details to <b>{currentUserEmail}</b>.
              </p>
              <p className={styles.fwNote}>
                When things ease up, you can move back to the full rate any time
