...
export const DATA_TYPES: DataType[] = [
  { label: 'Profile & identity', sub: 'Name, pronouns, bio, photo', defaultChecked: true },
  { label: 'Messages', sub: 'All direct & group conversations', defaultChecked: true },
  { label: 'Forum posts', sub: 'All posts, replies, reactions', defaultChecked: true },
  { label: 'Events', sub: 'RSVPs, attendance history', defaultChecked: true },
  { label: 'Connections', sub: 'Members you follow or are connected to', defaultChecked: false },
  { label: 'Activity log', sub: 'Login history, device sessions', defaultChecked: false },
]
