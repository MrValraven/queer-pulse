...
export function AccessibilityPane({ onChange }: { onChange: () => void }) {
  ...
  return (
    <Pane
      title={<>Accessibility <em>preferences.</em></>}
    ...
    >
      ...
      <A11yReadingSection
        ...
        sectionRef={noRef}
      />
      <A11yInteractionSection prefs={prefs} onToggle={toggle} sectionRef={noRef} />

      <div className={a11yStyles.section}>
        <div className={a11yStyles.resetCard}>
          <Button variant="ghost" onClick={resetAll} style={{ margin: '0 auto' }}>
