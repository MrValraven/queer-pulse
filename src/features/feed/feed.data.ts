...
export const FEED_POST: FeedPost = {
  ...
  body:
    "Anyone have recommendations for a queer-friendly GP in Lisbon? Preferably someone familiar with trans healthcare — I'm tired of having to explain myself from scratch every visit. Grateful for any leads, DM or reply here.",
  likeCount: 12,
  replies: [
    { id: 'r1', author: 'Joana P.', body: 'Dr. Marta Reis at Clínica Arco — genuinely lovely and experienced.' },
    { id: 'r2', author: 'Sam R.', body: 'Sending you a DM with two more options now.' },
    { id: 'r3', author: 'Téo M.', body: 'The CheckpointLX team can also point you to affirming GPs.' },
    { id: 'r4', author: 'Iris L.', body: 'Following — looking for the same near Almada.' },
  ],
}
