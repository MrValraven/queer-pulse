...
export const BRING: BringItem[] = [
  {
    title: "Trainers you can already run in",
    note: "Whatever you own is fine for your first time — don't buy anything special. If the cobbles start hurting your ankles, ask the group; we have strong opinions about Lisbon-proof shoes.",
  },
  {
    title: "Layers you can lose",
    note: "Mornings start cool and warm up fast. Something you can tie round your waist beats a single heavy top.",
  },
  {
    title: "Water for after",
    note: "We finish near coffee, so you don't need to carry much — a small bottle is plenty for the loop.",
  },
  {
    title: "Nothing to prove",
    note: "You don't need a running history, a certain body, or a goal. Showing up is the whole entry requirement. Come for the coffee and walk the loop if that's today's version.",
  },
];
