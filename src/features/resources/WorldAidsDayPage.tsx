...
const UNDO: { n: React.ReactNode; h: React.ReactNode; body: React.ReactNode }[] = [
  { n: <>0<em>1</em></>, h: <>Free, anonymous, in-community <em>testing</em></>, body: <>The SNS test is free but mandates ID. CheckpointLX is the gold standard but its hours and locations leave gaps. <strong>We want one walk-in, anonymous, member-supported testing slot per Lisbon neighbourhood, monthly.</strong> Café Beirão already volunteered the back room. <em>We are waiting on funding sign-off.</em></> },
...
const TESTED: { tag: string; free?: boolean; name: React.ReactNode; d: React.ReactNode; metaL: string; metaR: string }[] = [
  ...
  { tag: "Free · partly anonymous", free: true, name: <>CheckpointLX · <em>Mouraria</em></>, d: <>The gold-standard community testing centre · R. da Mouraria 1A. <b>Mon–Sat</b>, walk in, peer counsellors. Counsel + test + result in ~45 min.</>, metaL: "Partner since 2024", metaR: "5 days/week" },
  { tag: "Free · SNS · with health card", name: <>USF Sé · <em>Dr. Hugo Marques</em></>, d: <>Public-system, somewhat slower, but <b>genuinely affirming and complete</b> — covers full STI panel + PrEP eligibility in one visit. Book ahead, 2-3 week wait typical.</>, metaL: "Vetted by 12 members", metaR: "By appointment" },
];
      ...
      <div className={styles.page}>
        <section className={styles.hero}>
          <div className={styles.heroInner}>
            <div className={styles.eyebrow}>1 December · World AIDS Day · Lisbon</div>
            <h1 className={styles.h1}>
              Forty <em>years.</em> Still here. <em>Still working.</em>
            </h1>
            <p className={styles.dek}>
              Today is not about a ribbon. It is about <em>what changed,</em> what
              didn't, and what we owe the people who carried this through forty years
              of public neglect. <b>Treatment is prevention.</b> Testing is free. The
              clinic is open. And the names we read aloud at the Memorial tonight are{" "}
          ...
          <div className={styles.ledeInner}>
            ...
            <div className={styles.ledeExplain}>
              <p>
                ...
                <strong>you cannot transmit the virus through sex.</strong> This has
                been established beyond doubt for nearly a decade. It is not in dispute
                among clinicians.
              </p>
              <p>
                It is, however, <em>still routinely contradicted</em> by parents, by
                ex-partners, by HR departments, by border officials, by some doctors.
                So we say it again, in the largest type we have:
              </p>
            </div>
          </div>
        </section>
        ...
        <Reveal as="section" className={styles.undoSection}>
          <div className={styles.undoInner}>
            ...
            <p className={styles.undoLead}>
              Concrete. Specific. We have been asking for these for two years. We will
              keep asking next year.
            </p>
        ...
        <Reveal as="section" className={styles.tested}>
          <div className={styles.testedInner}>
            ...
            <p className={styles.sub}>
              Three vetted places, three different formats. Pick whichever fits the
              day.
            </p>
        ...
        <Reveal as="section" className={styles.memory}>
          <div className={styles.memoryInner}>
            ...
            <p>
              Lisbon's quiet annual reading. <b>Forty minutes long</b>, in a small
              square, with the names of community members who died — of AIDS-related
              causes, of overdoses through the long emergency, of being denied care.
              Read out, twice, in Portuguese and English. <em>No speeches afterwards.</em>
            </p>
            <p>
              If you're new to the community and don't know names, that's okay — you
              can come and listen. People do.
            </p>
        ...
        <div className={styles.ptNote}>
          ...
          <br />
          Sources: DGS · CheckpointLX · UNAIDS Portugal country profile · ILGA Portugal
          Anti-Discrimination Report 2025
        </div>
      </div>
    </PageShell>
  );
