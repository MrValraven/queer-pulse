        ...
        <>
          <div className={styles.body}>
            <p className={styles.sub}>
              Start an alcohol-free meet-up, or join an existing peer meeting. Either way,
            ...
            <div className={styles.options}>
              ...
              >
                <span className={styles.optIcon}><FiPlusCircle /></span>
                <span className={styles.optName}>Host a meeting</span>
                <span className={styles.optDesc}>Propose a new alcohol-free gathering.</span>
              </button>
              <button
                type="button"
              ...
              >
                <span className={styles.optIcon}><FiUsers /></span>
                <span className={styles.optName}>Attend a meeting</span>
                <span className={styles.optDesc}>Ask to join a peer support meeting.</span>
              </button>
            </div>
            ...
            <input
              ...
              placeholder={mode === 'host' ? 'e.g. Mariana L.' : 'First name or chosen name'}
            />

            <span className={styles.label}>
              {mode === 'host' ? 'What and where' : 'Which meeting (and anything to flag)'}
            </span>
            <textarea
