  ...
  return (
    <PageShell>
      <ResourceHero
        ...
        title={<>Aging on <em>your own terms.</em></>}
      ...
      <section className={`${styles.section} ${styles.sectionPaper}`} id="topics">
        <div className="wrap">
          <Reveal as="h2">The <em>essentials</em></Reveal>
      ...
      <section className={`${styles.section} ${styles.sectionCream}`} id="links">
        <div className="wrap">
          <Reveal as="h2">Useful <em>links</em></Reveal>
          <div className={styles.grid}>
            {LINKS.map((l, i) => (
              <Reveal
                as="a"
                ...
                delay={i * 55}
              >
                <div className={styles.cardName} style={{ fontSize: 19, display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <Outro
        title={<>Later life, <em>well held.</em></>}
