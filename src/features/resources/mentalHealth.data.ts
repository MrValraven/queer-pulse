...
export const THERAPISTS: Therapist[] = [
  {
    ...
    approach: ['Trauma-informed', 'EMDR', 'Relational psychotherapy', 'Affirmative practice'],
    training: [
  ...
  },
  {
    ...
    photo: 'https://images.unsplash.com/photo-1544168190-79c17527004f?q=80&w=600&auto=format&fit=crop',
    ...
    approach: ['Integrative psychotherapy', 'CBT', 'Mindfulness-based', 'Cross-cultural'],
    training: [
  ...
  },
  {
    ...
    approach: ['Person-centred', 'Systemic / family', 'Affirmative practice', 'Narrative therapy'],
    training: [
  ...
  },
  {
    ...
    photo: 'https://images.unsplash.com/photo-1638727295415-286409421143?q=80&w=600&auto=format&fit=crop',
    ...
    approach: ['Trauma-focused', 'Intersectional', 'Liberation psychology', 'EMDR'],
    training: [
  ...
  },
  {
    ...
    approach: ['Functional analytic', 'Couples therapy', 'Trans-affirming', 'Gestalt'],
    training: [
