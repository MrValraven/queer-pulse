  ...
  return (
    <PageShell>
      <ResourceHero
        ...
        title={<>Your story is <em>worth keeping.</em></>}
      ...
      <section className={`${styles.section} ${styles.sectionPaper}`} id="about">
        <div className="wrap">
          <Reveal as="h2">About the <em>project</em></Reveal>
          {ABOUT.map((p) => (
      ...
      <section className={`${styles.section} ${styles.sectionCream}`} id="how">
        <div className="wrap">
          <Reveal as="h2">How to <em>take part</em></Reveal>
          <Reveal as="p" className={styles.leadP}>Four steps, and you keep control of every one.</Reveal>
          ...
          <Reveal style={{ marginTop: 28 }}>
            <Button
              variant="jade"
              size="lg"
              onClick={() => showToast('Thank you — Sofia will reach out gently to talk it through. No commitment.')}
            >
      ...
      <section className={`${styles.section} ${styles.sectionPaper}`} id="voices">
        <div className="wrap">
          <Reveal as="h2">In their <em>words</em></Reveal>
          <div>
            {VOICES.map((v) => (
      ...
      <Outro
        title={<>History, <em>kept honest.</em></>}
