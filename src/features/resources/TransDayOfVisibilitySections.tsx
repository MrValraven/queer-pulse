    ...
    >
      ...
      <div className={styles.profileBody}>
        ...
        <div
          style={{
            paddingTop: 14,
            borderTop: "1px solid rgba(45,27,61,.08)",
            marginTop: 14,
            display: "flex",
  ...
  return (
    <Reveal as="section" className={styles.allies}>
      <div className={styles.alliesInner}>
        <div className={styles.alliesKicker}>
          If you are a cis member · today
        </div>
        <h2>
          Three things that <em>actually help.</em>
        </h2>
        <p className={styles.alliesSub}>
          Not <em>celebrate</em>, not <em>amplify</em>. Concrete. Tangible. Done
          by tomorrow.
        </p>
