...
export const USES: Use[] = [
  { title: 'Hybrid by default', body: 'Every gathering has an online option so a low-spoon day never means missing out. Online is never second class — it is just another door into the same room.' },
  { title: 'Drop-in, no penalty', body: "RSVP yes and not make it? Completely fine. We plan for it. The spoons you protect by staying home are yours to protect." },
  { title: '"I\'m low on spoons today" is a full sentence', body: 'Nobody here will ask you to justify it. You can say it when you RSVP, when you arrive, or when you need to leave early, and it will simply be honoured.' },
]

export const RSVP_TIPS = [
