...
const STEPS: { title: string; text: string }[] = [
  {
    title: "Propose",
    text: "Send a message saying what you’d trade and why the swap works for you.",
  },
  {
    title: "Agree",
    text: "You shape the swap together — scope, timing, format. No money changes hands.",
  },
  {
    title: "Exchange",
    text: "You each deliver. Meet up in Lisbon or go remote, whatever suits.",
  },
  {
    title: "Vouch",
    text: "Afterwards, leave a vouch so the next person knows it went well.",
  },
];
            ...
            <div className={styles.provider}>
              ...
              <div>
                ...
                <div className={styles.provRole}>
                  {info.hood ? `${info.hood} · Lisbon` : "Lisbon"}
                </div>
              </div>
