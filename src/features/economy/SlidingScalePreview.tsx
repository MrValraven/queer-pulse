...
export function SlidingScalePreview({ scale, makerName }: SlidingScalePreviewProps) {
  return (
    <DocPreview>
      ...
      <p className={styles.docOutro}>
        <FiHeart className={styles.outroIcon} aria-hidden /> Pay the tier that&apos;s honest for
        you. Choosing higher keeps this work open to everyone.
      </p>
