...
export const COMPANIES: Company[] = [
  {
    ...
    quote: '"Generally good. The team is fine — leadership is still catching up. They have an ERG but it needs more budget and teeth."',
    meta: ['14 reviews', 'Last updated 2 weeks ago'],
    reviews: [
      { text: '"My manager used my pronouns from day one and corrected a client who didn\'t. That mattered more than any policy doc."', meta: ['Engineering', '2 weeks ago'] },
      { text: '"The ERG is real but under-resourced — it runs on volunteers. Trans healthcare in the plan is decent though."', meta: ['Design', '1 month ago'] },
      { text: '"Came out at the offsite and it was a non-event in the best way. Leadership still defaults to assumptions in all-hands."', meta: ['Product', '6 weeks ago'] },
    ],
  },
  {
    av: 'NV',
    ...
    quote: '"Pride month branding. Zero follow-through. I was out for two years and not once did a manager acknowledge it in any way that felt real."',
    meta: ['8 reviews', 'Last updated 1 month ago'],
    reviews: [
      { text: '"HR meant well but had no idea how to handle a name change. I had to walk them through it myself."', meta: ['Operations', '1 month ago'] },
      { text: '"The rainbow logo goes up in June and comes down in July. Read the room before you accept an offer here."', meta: ['Finance', '2 months ago'] },
      { text: '"One supportive director kept me there a year longer than I should have stayed. Culture below them is rough."', meta: ['Analyst', '3 months ago'] },
    ],
  },
  {
    av: 'MC',
    ...
    quote: '"Genuinely queer-led culture. My pronouns were on my contract. No one made a big deal of it — it was just how it worked there."',
    meta: ['6 reviews', 'Last updated 3 weeks ago'],
    reviews: [
      { text: '"Founder is trans and it shows in every policy — gender-neutral facilities, real healthcare, flexible time for appointments."', meta: ['Creative', '3 weeks ago'] },
