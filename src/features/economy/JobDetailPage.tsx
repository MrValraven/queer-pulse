...
export function JobDetailPage() {
  ...
  function toggleSave() {
    setSaved((s) => {
      showToast(s ? 'Listing removed from saved.' : 'Listing saved to your profile.', 'info')
      return !s
    })
  }
        ...
        <div className={styles.layout}>
          ...
          <aside className={styles.sidebar}>
            <div className={styles.card}>
              <div className={styles.logoFallback} style={{ background: job.logoBg, color: job.logoText }}>
                {job.logo}
              </div>
