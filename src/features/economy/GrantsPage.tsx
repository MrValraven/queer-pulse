          ...
          <div className={styles.layout}>
                        ...
                        {items.map((grant, i) => (
                          ...
                          >
                            ...
                            <div className={styles.gcFoot}>
                              ...
                              <div className={styles.gcRight}>
                                <span
                                  className={`${styles.gcStatus} ${STATUS_CLASS[grant.status]}`}
                                >
            ...
            <aside className={styles.sidebar}>
              <div className={styles.sideCard}>
                ...
                <p>
                  QueerPulse runs its own micro grant programme (€200–€2,000)
                  for community projects in Lisbon. Faster and simpler than most
                  external grants.
                </p>
              ...
              <div className={styles.sideCard}>
                ...
                <p>
                  If you need support but grants feel too formal, the barter
                  board connects members who can swap skills — no money
                  involved.
                </p>
              ...
              >
                ...
                <p>
                  Members with grant-writing experience offer workshops and
                  one-to-one support via the skills exchange.
                </p>
