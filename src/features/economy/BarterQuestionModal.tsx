...
export function BarterQuestionModal({
  ...
  return (
    <ModalShell onClose={onClose} success={done}>
      {done ? (
        <SuccessPanel title="Question" em="sent." onClose={onClose} closeLabel="Done">
          Your question is on its way to <strong>{name}</strong>. No swap is agreed until you both say
          yes — this is just a chat to see if it could work. You'll get a notification here when they
          reply.
        </SuccessPanel>
      ) : (
        <>
          ...
          <p className={styles.sub}>
            Not ready to propose a swap yet? Ask what you need to know first — timing, what they're
            after, how it'd work. Friendly and low-pressure.
          </p>
