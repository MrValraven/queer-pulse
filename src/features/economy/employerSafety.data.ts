...
export const EMPLOYER_SAFETY: Record<string, SafetySignals> = {
  'Atelier Pulso': { verifiedSafe: true, transFriendly: true, safeToBeOut: 9.4 },
  'ILGA Portugal': { verifiedSafe: true, transFriendly: true, safeToBeOut: 9.6 },
  'A Lisbon Fintech': { verifiedSafe: false, transFriendly: false, safeToBeOut: 5.2 },
  'Rainbow Arts Collective': { verifiedSafe: true, transFriendly: true, safeToBeOut: 9.0 },
  'Opus Diversus': { verifiedSafe: true, transFriendly: false, safeToBeOut: 7.8 },
  'Livraria Devagar': { verifiedSafe: true, transFriendly: true, safeToBeOut: 8.6 },
  QueerPulse: { verifiedSafe: true, transFriendly: true, safeToBeOut: 9.8 },
  'Lisbon Tech Hub': { verifiedSafe: true, transFriendly: false, safeToBeOut: 8.2 },
  'Nova Ventures': { verifiedSafe: false, transFriendly: false, safeToBeOut: 4.0 },
  'Marvila Creative': { verifiedSafe: true, transFriendly: true, safeToBeOut: 9.4 },
}
