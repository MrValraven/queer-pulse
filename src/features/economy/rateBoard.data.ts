...
export const newRateId = () =>
  'rb_' + Date.now().toString(36) + '_' + Math.random().toString(36).slice(2, 8)

/** ~8 realistic anonymous entries so the distribution reads well on first view. */
export const SEED: RateEntry[] = [
  { id: 'rb_seed_1', role: 'Designer', experience: 'mid', dayRate: 320, type: 'freelance' },
  { id: 'rb_seed_2', role: 'Designer', experience: 'senior', dayRate: 480, type: 'freelance' },
  { id: 'rb_seed_3', role: 'Software Engineer', experience: 'senior', dayRate: 560, type: 'freelance' },
  { id: 'rb_seed_4', role: 'Software Engineer', experience: 'lead', dayRate: 700, type: 'employed' },
  { id: 'rb_seed_5', role: 'Writer', experience: 'mid', dayRate: 240, type: 'freelance' },
  { id: 'rb_seed_6', role: 'Photographer', experience: 'senior', dayRate: 420, type: 'freelance' },
  { id: 'rb_seed_7', role: 'Consultant', experience: 'lead', dayRate: 850, type: 'freelance' },
  { id: 'rb_seed_8', role: 'Designer', experience: 'junior', dayRate: 180, type: 'employed' },
]
