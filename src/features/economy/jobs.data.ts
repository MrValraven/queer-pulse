...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      aboutCompany:
        "We are a long-established national LGBTI+ rights organisation, founded in 2004. Based in Lisbon, we run advocacy, legal support, and community programmes nationwide.",
      reviewerNote:
