...
export const EMPLOYERS = [
  { logo: 'AP', bg: 'rgba(var(--accent-rgb),.12)', text: 'var(--accent-ink)', name: 'Atelier Pulso', type: 'Design studio · Príncipe Real', qr: true, badge: 'Queer-run', badgeBg: 'rgba(var(--accent-rgb),.1)', badgeText: 'var(--accent-ink)' },
  { logo: 'QP', bg: 'rgba(var(--jade-rgb),.12)', text: 'var(--jade)', name: 'QueerPulse', type: 'Community platform · Lisbon', qr: true, badge: 'Queer-run', badgeBg: 'rgba(var(--jade-rgb),.1)', badgeText: 'var(--jade)' },
  { logo: 'IL', bg: 'rgba(var(--violet-rgb),.1)', text: 'var(--violet)', name: 'ILGA Portugal', type: 'NGO · Intendente', qr: true, badge: 'Queer-led', badgeBg: 'rgba(var(--violet-rgb),.08)', badgeText: 'var(--violet)' },
  { logo: 'OD', bg: 'rgba(var(--plum-rgb),.08)', text: 'var(--plum)', name: 'Opus Diversus', type: 'Mental health · Lisbon', qr: false, badge: 'Community org', badgeBg: 'rgba(var(--plum-rgb),.06)', badgeText: 'var(--plum)' },
  { logo: 'LB', bg: 'rgba(var(--accent-rgb),.1)', text: 'var(--accent-ink)', name: 'Livraria Devagar', type: 'Bookshop · Anjos', qr: true, badge: 'Queer-friendly', badgeBg: 'rgba(var(--accent-rgb),.1)', badgeText: 'var(--accent-ink)' },
]
