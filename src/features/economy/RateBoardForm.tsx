...
export function RateBoardForm({ onAdd, compareRate, onCompareChange }: RateBoardFormProps) {
  ...
  function handleAdd() {
    if (!valid) return
    onAdd({ id: newRateId(), role, experience, dayRate: Math.round(rateNum), type })
    setDayRate('')
    ...
    <div className={styles.form}>
      ...
      <div className={styles.compare}>
        ...
        <input
          ...
          onChange={(e) => onCompareChange(Math.max(0, Number(e.target.value) || 0))}
        />
