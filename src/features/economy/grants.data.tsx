...
export const GRANTS: Grant[] = [
  {
    ...
    description: "Community-funded micro grants for queer projects in Lisbon. Open to members and non-members. Decisions made by a rotating community panel, not a board.",
  ...
  },
  {
    ...
    description: "Annual residency and creation support for individual artists. Frame your work in terms of cultural value, not identity.",
    tags: ["arts", "residency"],
    to: "/work/grants",
  },
  {
