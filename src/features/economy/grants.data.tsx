...
export const GRANTS: Grant[] = [
  {
    ...
    org: "QueerPulse Community Fund",
    amount: "€200–€2,000",
    status: "open",
    cats: ["individual", "org", "community"],
    desc: "Community-funded micro grants for queer projects in Lisbon. Open to members and non-members. Decisions made by a rotating community panel, not a board.",
    tags: ["Lisbon", "community", "rolling"],
    to: "/work/grants",
  },
  {
    sec: "pt",
    name: "ILGA Portugal Project Fund",
    org: "ILGA Portugal",
    amount: "€500–€5,000",
    status: "open",
    cats: ["org", "community"],
    desc: "Annual grants for LGBTQ+ advocacy, community building, and awareness projects in Portugal. Priority to regional projects outside Lisbon.",
    tags: ["advocacy", "community", "Portugal"],
    to: "/work/grants",
  },
  {
    sec: "pt",
    name: "Gulbenkian — Social Programme",
    org: "Fundação Gulbenkian",
    amount: "€5,000–€50,000",
    status: "rolling",
    cats: ["org", "community", "arts"],
    desc: "Gulbenkian's social cohesion programme funds community organisations working with marginalised groups. An inclusion-framed application is needed.",
  ...
  },
  {
    ...
    status: "rolling",
    cats: ["org", "community"],
    desc: "Civil society strengthening grants via the EEA mechanism. LGBTQ+ groups have been funded under previous rounds.",
  ...
  },
  {
    ...
    desc: "Annual residency and creation support for individual artists. Frame your work in terms of cultural value, not identity.",
    tags: ["arts", "residency"],
    to: "/work/grants",
  },
  {
    ...
    status: "rolling",
    cats: ["org", "eu"],
    desc: "The EU's main civil society and equality programme. The LGBTIQ Equality strand funds work across Europe. Requires EU-wide partnerships.",
    tags: ["EU", "large grant", "transnational"],
    to: "/work/grants",
  },
  {
    sec: "eu",
    name: "ILGA-Europe Emergency Fund",
    org: "ILGA-Europe",
    amount: "up to €5,000",
    status: "rolling",
    cats: ["org", "individual", "eu"],
    desc: "Rapid-response emergency grants for LGBTIQ organisations or individuals facing urgent threats — legal, financial, safety-related.",
    tags: ["emergency", "EU", "rapid response"],
    to: "/work/grants",
  },
  {
    sec: "eu",
    name: "Arcus Foundation — LGBTQ Programme",
    org: "Arcus Foundation",
    amount: "$50,000–$300,000",
    status: "rolling",
    cats: ["org", "eu"],
    desc: "US-based foundation with a major LGBTQ programme in Europe. Focuses on movement-building, legal advocacy, and trans rights.",
  ...
  },
  {
    ...
    status: "rolling",
    cats: ["individual", "eu"],
    desc: "Direct financial assistance for LGBTQI+ people in dangerous situations, including help leaving unsafe situations. For individuals only.",
