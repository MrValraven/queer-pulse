      ...
      <div className={styles.hero}>
        <div className="wrap">
          ...
          <p className={styles.heroSub}>
            A queer-specific flatmate board. Community-based, member-only —
            browse real profiles, reach out directly, find someone you can
            actually be yourself around.
          </p>
        ...
        <div className="wrap">
          <div className={styles.hsStripInner}>
            <div className={styles.hsStripText}>
              ...
              <p>
                Full tenancy resources, legal guidance, landlord
                recommendations, sublets and room shares — everything you need
                to find and secure a home in Lisbon.
              </p>
            </div>
