...
export const LANDLORDS: Landlord[] = [
  {
    ...
    tint: "plum",
    photo:
      "https://images.unsplash.com/photo-1758612897972-dba54225048a?q=80&w=400&h=400&auto=format&fit=crop&crop=faces",
    hood: "Arroios · Rooms + flats",
    stars: 5,
    ...
    areas: [
      ...
      "One- and two-bed flats · Arroios / Anjos",
  ...
  },
  {
    ...
    tint: "coral",
    photo:
      "https://images.unsplash.com/photo-1692801439915-ef9194bf0951?q=80&w=400&h=400&auto=format&fit=crop&crop=faces",
    hood: "Mouraria · Studio flats",
    stars: 5,
    ...
    areas: [
      "Studio flats · Mouraria",
      "Occasionally one-beds · Intendente",
      "Short and long term",
    ],
    stats: [
  ...
  },
  {
    ...
    tint: "plum",
    photo:
      "https://images.unsplash.com/photo-1763573676689-bf2d7b474208?q=80&w=400&h=400&auto=format&fit=crop&crop=faces",
    hood: "Graça · Flats",
    stars: 4,
  ...
  },
  {
    ...
    tint: "jade",
    photo:
      "https://images.unsplash.com/photo-1592234789031-94bf65f630ed?q=80&w=400&h=400&auto=format&fit=crop&crop=faces",
    hood: "Cais do Sodré · Rooms",
    stars: 5,
    ...
    areas: [
      ...
      "Vets housemates for fit and safety",
      "Short and long term",
    ],
    stats: [
