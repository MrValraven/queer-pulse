  ...
  return (
    <>
      <header className={styles.head}>
        <SkeletonLine width="100%" height="auto" style={{ aspectRatio: '4 / 5', borderRadius: 18 }} />
        <div>
          ...
          <div className={styles.cta}>
            <SkeletonLine width={220} height={42} style={{ borderRadius: 999 }} />
            <SkeletonLine width={170} height={42} style={{ borderRadius: 999 }} />
          </div>
        </div>
      </header>
      ...
      <div className={styles.grid}>
        <main>
          {[0, 1, 2, 3].map((s) => (
            <section key={s} className={styles.sec}>
              <SkeletonLine width="45%" height={24} style={{ marginBottom: 14 }} />
        ...
        <aside className={styles.side}>
          <div className={styles.sideCard}>
            <SkeletonLine width="50%" height={20} style={{ marginBottom: 16 }} />
            {[0, 1, 2, 3].map((i) => (
            ...
            <div className={styles.sideBtnWrap}>
              <SkeletonLine width="100%" height={42} style={{ borderRadius: 999 }} />
            </div>
          </div>
        </aside>
      </div>
