...
export const WORKSHOPS: Workshop[] = [
    ...
    sessions: [
      {
        ...
        description:
          "Tour, machine demo, your first single-colour print. You leave with five A4 sheets of your own.",
        date: "Tue 24 Jun",
        length: "3 hr",
      },
      {
        ...
        description:
          "The unique way riso treats colour. You separate a 2-colour image and pull a 30-print edition by hand.",
        date: "Tue 1 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "InDesign / Figma to riso. Half-tones, line weight, white space. You'll throw out your first attempt.",
        date: "Tue 8 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "You arrive with your draft. We critique, edit, and you re-export. Print your first cover.",
        date: "Tue 15 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "The longest night. We split into two stations and pull editions in parallel. Bring snacks.",
        date: "Tue 22 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "Saddle-stitch by hand, trim to size, the math of distribution. Closing party at the community café.",
        date: "Tue 29 Jul",
        length: "3+ hr",
      },
    ],
  ...
  },
  {
    ...
    sessions: [
      {
        ...
        description:
          "Compression, water discipline, and how to add height without thinning the base to nothing.",
        date: "Thu 26 Jun",
        length: "3 hr",
      },
      {
        ...
        description:
          "Getting weight out of the wall and turning a clean foot ring on the leather-hard pot.",
        date: "Thu 3 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "The parts that separate a mug from a mistake. Pulling handles, cutting spouts, throwing lids to size.",
        date: "Thu 10 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "How glazes actually behave. Layering, wax resist, and mixing two studio glazes into something yours.",
        date: "Thu 17 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "We glaze the whole cohort's work, load together, and talk about what to expect from the firing.",
        date: "Thu 24 Jul",
        length: "3 hr",
      },
    ],
    needs: [
      {
        label: "Clay",
        detail: "Stoneware for the whole course: throw as much as you can use.",
        included: true,
        tag: "included",
      },
      {
    ...
    sessions: [
      {
        ...
        description:
          "Pick the one idea. Build it into a full arrangement with an intro, a turn, and an ending.",
        date: "Mon 30 Jun",
        length: "3 hr",
      },
      {
        ...
        description:
          "Making the back half of the track earn its place. Variation, tension, and knowing when it's enough.",
        date: "Mon 7 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "A practical mix that sounds right on phone speakers and headphones. Gain-staging, EQ, the essentials.",
        date: "Mon 14 Jul",
        length: "3 hr",
      },
      {
        ...
        description:
          "A gentle master, export, and we release together on the night. Then we play every track, start to finish.",
        date: "Mon 21 Jul",
        length: "3 hr",
      },
    ],
