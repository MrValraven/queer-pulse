...
export const SKILLS: Skill[] = [
  {
    ...
    description:
      "How to build a brand identity that lasts: from strategy to type to colour. One-to-one, monthly, in the studio.",
  ...
  },
  {
    ...
    description:
      "Works in progress, honest feedback. Junior and mid-level designers welcome. One Friday a month in Príncipe Real.",
  ...
  },
  {
    ...
    description:
      "One hour a month, no structure. Career, architecture, surviving a bad sprint. Backend-focused but open.",
  ...
  },
  {
    ...
    description:
      "Monthly workshop in the Graça studio. Beginners welcome. You'll make something, you'll get it wrong, you'll learn.",
  ...
  },
  {
    ...
    description:
      "Practical session: choosing a camera, loading film, developing your first roll. In the studio in Cais do Sodré.",
  ...
  },
  {
    ...
    description:
      "Introduction to production: what DAW, what workflow, how to finish a track. For complete beginners.",
  ...
  },
  {
    ...
    description:
      "Looking to understand how to secure funding for a community-focused initiative: grants, community shares, sponsorship.",
  ...
  },
  {
    ...
    description:
      "Specifically: how to brief a composer, how to communicate emotional intent, how to work with music you didn't make.",
  ...
  },
  {
    ...
    description:
      "I cook well but I price badly. Looking for someone with hospitality business experience to help me work it out.",
