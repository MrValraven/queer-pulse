...
function CheckGrid({ options }: { options: string[] }) {
  ...
  return (
    <div className={styles.mmCheckGrid}>
      {options.map((o) => (
        <label key={o} className={[styles.mmCheck, checked.has(o) && styles.mmCheckActive].filter(Boolean).join(' ')}>
          <input
            type="checkbox"
...
export function MentorMatchModal({ mode, onClose }: { mode: Mode; onClose: () => void }) {
  useScrollLock()
  ...
  return (
    ...
    >
      <div className={styles.modal}>
        ...
        <div className={styles.mmLabel}>{done ? 'Done!' : `Step ${step} of ${total}`}</div>
          ...
          <>
            {step === 1 && (
              <>
                ...
                <p className={styles.mmDesc}>
                  Pick the areas where you'd most benefit from guidance. We'll match you with someone
                  who has direct experience there.
                </p>
            ...
            {step === 3 && (
              <>
                ...
                <p className={styles.mmDesc}>
                  We'll review your request and suggest a match within 2 weeks. You'll get an email
                  introduction and can take it from there.
                </p>
                <div className={styles.mmNav}>
          ...
          <>
            {step === 1 && (
              <>
                ...
                <p className={styles.mmDesc}>
                  You don't need to be an expert. You need to have navigated something that someone
                  else is currently navigating.
                </p>
