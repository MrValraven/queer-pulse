    ...
    <ModalShell onClose={onClose} success={done}>
      {done ? (
        <SuccessPanel
          ...
          closeLabel="Done"
        >
          Thanks for sharing <strong>{title}</strong>. A moderator checks every
          listing before it goes live — usually within a day — so the board
          stays trustworthy for everyone looking for a safe place to land.
        </SuccessPanel>
      ) : (
        <>
          ...
          <p className={styles.sub}>
            Open your place to a verified member of the community. A few details
            now — you can add photos once it's approved.
          </p>
          ...
          <p className={styles.note}>
            Listings are reviewed before they appear. Never ask for a deposit
            before someone has viewed the place in person.
          </p>
