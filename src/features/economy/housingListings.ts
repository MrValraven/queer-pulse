...
export const HOUSING_LISTINGS: HousingListing[] = [
  {
    ...
    features: ['Fully furnished', 'Great light', 'Garden-square view', 'Fast wifi', 'Washing machine', 'Quiet at night'],
    facts: [
    ...
    idealFor: ['Someone here for the summer who wants their own calm space', 'A remote worker who needs good light and quiet', 'Anyone who would treat a much-loved flat with care'],
  },
  {
    ...
    features: ['Ensuite bathroom', 'Double bed', 'Desk', 'Fast wifi', 'Shared kitchen', 'Long-term'],
    facts: [
    ...
    idealFor: ['Someone settling in Lisbon for the long term', 'A quiet, considerate flatmate who still wants community', 'People who work regular hours and value a calm home'],
  },
  {
    ...
    features: ['Well-designed', 'Kitchenette', 'Rooftop access', 'Wifi', 'Central Graça', 'Self-check-in'],
    facts: [
    ...
    idealFor: ['Someone newly arrived who needs a soft landing', 'People between flats who want a calm base', 'Short stays where having your own space matters'],
  },
  {
    ...
    features: ['High ceilings', 'Huge windows', 'Studio space', 'Sound system', 'Big communal area', 'Bike storage'],
    facts: [
    ...
    idealFor: ['A creative who wants space to make things', 'Someone sociable but self-sufficient', 'People who would use a shared sound system more than complain about it'],
  },
  {
    ...
    features: ['Whole flat', 'Lots of books', 'Great light', 'Proper kitchen', 'Very central', 'Quiet bedroom'],
    facts: [
    ...
    idealFor: ['Someone who wants a real home, not a holiday let', 'LGBTQ+ tenants (priority)', 'People who treat books and plants as housemates'],
  },
  {
    ...
    features: ['Two bedrooms', 'Recently renovated', 'Balcony', 'Tiled hallway', 'Very central', 'Furnished'],
    facts: [
    ...
    idealFor: ['A couple or two friends sharing for the summer', 'Anyone who wants to be in the heart of Mouraria', 'People who want a local to point them to the good stuff'],
  },
]

export function getListing(slug: string | undefined): HousingListing | undefined {
