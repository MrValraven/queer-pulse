 ...
 *
 * "Places you run" drops out while the owner is editing: a listing is edited on
 * its own owner surface, not in this form, so its cards and their edit/delete
 * actions would only lead out of the editor past unsaved changes.
 *
...
export function ProfileBelowHeroSections({
  ...
  selfView: boolean;
  previewing: boolean;
  /** `selfView && isEditing` — the owner is in the inline profile editor. */
