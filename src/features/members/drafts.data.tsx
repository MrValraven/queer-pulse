...
export const DRAFTS: Draft[] = [
  {
    ...
    kind: 'JOB',
    kindVariant: 'job',
    title: <>Application · <em>Communications Manager</em></>,
    desc: <>For <em>Clube das Letras</em> · Hybrid, Lisbon · €32–38k</>,
    meta: [
      { label: <>Started <b>2 days ago</b></> },
      { label: <>Last edited <b>this morning</b></> },
      { label: 'Closes 18 Jun · 9 days', variant: 'deadline' },
    ],
    progress: 60,
    actions: [{ label: 'Resume', variant: 'primary' }, { label: 'Delete', variant: 'danger', deletes: true }],
  },
  {
    id: 'd2',
    kind: 'PITCH',
    kindVariant: 'pitch',
    title: <>Pitch · <em>"The pharmacist who fills every prescription"</em></>,
    desc: 'For QueerPulse Magazine · Issue 10 · 1,200-word profile · talked with Rui yesterday',
    meta: [{ label: <>Started <b>last week</b></> }, { label: 'Saved 2 min ago', variant: 'pulse' }],
    progress: 85,
    actions: [{ label: 'Resume', variant: 'primary' }, { label: 'Delete', variant: 'danger', deletes: true }],
  },
  {
    ...
    meta: [{ label: <>Started <b>3 days ago</b></> }, { label: <>Last edited <b>yesterday</b></> }],
    progress: 100,
    ready: true,
  ...
  },
  {
    ...
    kind: 'REPLY',
    kindVariant: 'post',
    title: <>Reply to <em>Anika Kovač's post about queer-friendly GPs</em></>,
    ...
    meta: [{ label: <>Started <b>2 hours ago</b></> }, { label: 'Saved just now', variant: 'pulse' }],
    progress: 92,
  ...
  },
  {
    ...
    kind: 'PITCH',
    kindVariant: 'pitch',
    title: <>Pitch · <em>"Six months on a four-day week — the sequel"</em></>,
    desc: 'Follow-up to my Issue 05 piece · sent to editorial in March, never finished revision',
    meta: [
      { label: <>Started <b>87 days ago</b></> },
  ...
  },
  {
    ...
    kind: 'JOB',
    kindVariant: 'job',
    title: <>Application · <em>Editorial Lead, Magazine</em></>,
    desc: <>For Equip Editions · barely started · saved by accident? <em>Probably delete.</em></>,
    meta: [{ label: <>Started <b>5 days ago</b></> }, { label: <>Last edited <b>5 days ago</b></> }],
    progress: 8,
    actions: [{ label: 'Resume', variant: 'primary' }, { label: 'Delete', variant: 'danger', deletes: true }],
  },
]
