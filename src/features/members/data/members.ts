...
const ENTRIES: Record<string, Omit<Member, "id">> = {
  ...
  "sofia-rodrigues": {
    ...
    role: "UX Designer",
    hood: "Arroios",
    tags: ["Accessibility", "Civic tech", "Design systems", "Research", "Mentoring"],
    visibility: "open",
    initials: "SR",
    tint: "jade",
    ...
    openTo: ["Mentoring junior designers", "Accessibility audits", "Coffee in the garden"],
    work: [
      { category: "Product", title: "Acessível — public-form toolkit", year: "2025" },
      { category: "Talk", title: "Designing for the people the design forgot", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Free portfolio reviews for queer designers", slug: "portfolio-reviews-sr" },
      { kind: "looking", title: "Researcher for a clinic-access study", slug: "research-partner" },
    ],
    vouchers: ["ines", "jordan"],
    voucherNames: "Inês & Jordan",
    related: ["rui", "maria", "tomas-mendes"],
    shapings: {
      film: { title: "Happy Together", note: "Watched it alone at 22 and finally understood that leaving could be its own kind of love." },
      book: { title: "Design Justice", note: "It put words to why I'd always felt the 'average user' was a lie." },
      song: { title: "This Must Be the Place — Talking Heads", note: "My grounding song; I play it before every difficult meeting." },
      moment: { title: "First clinic launch", note: "Watching a stranger book their own appointment without asking for help — I cried in the waiting room." },
    },
    skills: [
    ...
    activity: [
      { icon: FiEdit3, title: "Posted 'The form is the policy'", sub: "Magazine essay on civic UX", to: routes.magazine },
      { icon: FiMessageCircle, title: "Answered 'Where to start with a11y?'", sub: "Forum thread", to: routes.forum },
    ],
  },
  "tomas-mendes": {
    slug: "tomas-mendes",
    ...
    work: [
      { category: "Project", title: "Armazém 7 — collective workspace conversion", year: "2025" },
      { category: "Project", title: "Casa Comum co-housing study", year: "2024" },
      { category: "Exhibition", title: "Who Stays — housing & belonging", year: "2023" },
    ],
    board: [
      { kind: "offering", title: "Pro-bono feasibility sketches for collectives", slug: "feasibility-sketches" },
    ],
    vouchers: ["beatriz", "sofia-rodrigues", "ines"],
    voucherNames: "Beatriz, Sofia & Inês",
    related: ["beatriz", "carla", "kai"],
    shapings: {
      film: { title: "Koyaanisqatsi", note: "It rewired how I see cities — as something breathing, not something built." },
      book: { title: "The Death and Life of Great American Cities", note: "Jacobs taught me to trust the sidewalk over the master plan." },
      song: { title: "Águas de Março — Elis & Tom", note: "The song I hum on every site at the moment the light is right." },
      moment: { title: "Handing over the keys to Armazém 7", note: "Six collectives moved in the same weekend; the building felt alive within a day." },
    },
    skills: [
      { name: "Space feasibility sketch", meta: "Trade · for a home-cooked meal" },
    ...
    activity: [
      { icon: FiCalendar, title: "Hosting 'Cook & co-design'", sub: "Open studio dinner in Marvila", to: routes.event },
      { icon: FiCamera, title: "Shared Armazém 7 before/after", sub: "Culture gallery", to: routes.culture },
    ],
  },
  anika: {
    slug: "anika",
    ...
    openTo: ["Bilingual reading series", "Translation swaps", "Coffee in the garden"],
    work: [
      { category: "Chapbook", title: "Border Tongues", year: "2025" },
      { category: "Translation", title: "Selected poems of Svetlana V. (sl→pt)", year: "2024" },
    ],
    board: [
      { kind: "looking", title: "Co-host for a bilingual reading night", slug: "bilingual-reading" },
      { kind: "offering", title: "Translation help for queer migrant orgs", slug: "translation-help" },
    ],
    vouchers: ["ines"],
    voucherNames: "Inês",
    related: ["jordan", "kai", "sofia"],
    shapings: {
      film: { title: "The Edge of Heaven", note: "Akın made grief and migration feel like the same ache, and I needed that." },
      book: { title: "Bluets", note: "Maggie Nelson showed me a single colour could hold a whole heartbreak." },
      song: { title: "Plovi Plovi — Severina (slow version)", note: "A song from home I only learned to love once I'd left it." },
      moment: { title: "Reading in three languages", note: "The first night an audience laughed at the same line in two tongues — I felt unsplit." },
    },
    skills: [
    ...
    activity: [
      { icon: FiBookOpen, title: "Started a reading group", sub: "Queer migrant poetry, monthly", to: routes.readingGroups },
      { icon: FiEdit3, title: "Published 'Three words for home'", sub: "Magazine poem", to: routes.magazine },
    ],
  },
  jordan: {
    slug: "jordan",
    ...
    openTo: ["Mentoring", "Facilitating tricky meetings", "Coffee in the garden"],
    work: [
      { category: "Programme", title: "First Year — onboarding for new organisers", year: "2025" },
      { category: "Workshop", title: "Holding conflict in queer groups", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Free facilitation for grassroots groups", slug: "facilitation-jp" },
      { kind: "offering", title: "1:1 mentoring for new organisers", slug: "mentoring-jp" },
    ],
    vouchers: ["maria", "ines", "andre"],
    voucherNames: "Maria, Inês & André",
    related: ["maria", "sofia-rodrigues", "anika"],
    shapings: {
      film: { title: "Pride", note: "It's the politics I believe in — unlikely solidarity that actually changes a vote." },
      book: { title: "Emergent Strategy", note: "adrienne maree brown gave me permission to organise like a garden, not a machine." },
      song: { title: "Ella's Song — Sweet Honey in the Rock", note: "'We who believe in freedom cannot rest' — my whole ethic in one line." },
      moment: { title: "Mediating a near-split collective", note: "Two hours of held silence, and the group chose to stay together. Best work I've done." },
    },
    skills: [
    ...
    activity: [
      { icon: FiCalendar, title: "Opened the Facilitation Lab", sub: "Six-week cohort, free", to: routes.event },
      { icon: FiMessageCircle, title: "Replied in 'Avoiding burnout'", sub: "Forum thread", to: routes.forum },
    ],
  },
  maria: {
    slug: "maria",
    ...
    openTo: ["New clients", "Supervising retraining psychologists", "Collaborations"],
    work: [
      { category: "Practice", title: "Consultório Cedofeita — affirming therapy", year: "2022" },
      { category: "Course", title: "Foundations of trans-affirming care", year: "2025" },
    ],
    board: [
      { kind: "offering", title: "Sliding-scale therapy slots", slug: "therapy-slots-mf" },
      { kind: "offering", title: "Supervision for affirming-care trainees", slug: "supervision-mf" },
    ],
    vouchers: ["monica", "jordan"],
    voucherNames: "Mónica & Jordan",
    related: ["monica", "jordan", "beatriz"],
    shapings: {
      film: { title: "A Fantastic Woman", note: "Marina's dignity under so much cruelty taught me what my clients carry daily." },
      book: { title: "Trauma and Recovery", note: "Judith Herman is the spine of how I hold a session." },
      song: { title: "Both Sides Now — Joni Mitchell", note: "I put it on after a heavy day to remember the same thing can be seen many ways." },
      moment: { title: "A client's first euphoric session", note: "They came in to grieve and left talking about a future. That shift is why I do this." },
    },
    skills: [
    ...
    activity: [
      { icon: FiFileText, title: "Wrote 'What affirming actually means'", sub: "Magazine feature", to: routes.magazine },
      { icon: FiMessageCircle, title: "Answered 'Finding a therapist up north'", sub: "Forum thread", to: routes.forum },
    ],
  },
  kai: {
    slug: "kai",
    ...
    work: [
      ...
      { category: "Short", title: "Smoke Room — Malmö queer techno", year: "2024" },
    ],
    board: [
      { kind: "looking", title: "Interviewees from Lisbon's club scene", slug: "doc-interviewees" },
      { kind: "looking", title: "Porto fixer for a weekend shoot", slug: "porto-fixer" },
    ],
    vouchers: ["sofia", "tomas-mendes"],
    voucherNames: "Sofia & Tomás",
    related: ["anika", "tomas-mendes", "sofia"],
    shapings: {
      film: { title: "Beau Travail", note: "Denis taught me that bodies moving in a room can carry an entire story." },
      book: { title: "Cruising Utopia", note: "Muñoz made me believe nightlife is a rehearsal for a better world." },
      song: { title: "Mestre — DJ Marfox", note: "The first track that made me understand Lisbon has its own dancefloor language." },
      moment: { title: "Filming the last night of a club", note: "Everyone knew it was closing; the whole room danced like a goodbye. I barely held the camera steady." },
    },
    skills: [
    ...
    activity: [
      { icon: FiCamera, title: "Posted a call for interviewees", sub: "Queer nightlife documentary", to: routes.culture },
      { icon: FiMusic, title: "Shared a field-recording reel", sub: "Cais do Sodré, 4am", to: routes.culture },
    ],
  },
  monica: {
    slug: "monica",
    ...
    work: [
      { category: "Practice", title: "Estrela Bodywork — affirming physio", year: "2023" },
      { category: "Workshop", title: "Consent-led touch for practitioners", year: "2025" },
    ],
    board: [
      { kind: "offering", title: "Post-op rehab consultations", slug: "rehab-mr" },
    ],
    vouchers: ["maria"],
    voucherNames: "Maria",
    related: ["maria", "sofia-rodrigues", "jordan"],
    shapings: {
      film: { title: "The Diving Bell and the Butterfly", note: "It taught me the body is never just an obstacle — it's a whole inner world." },
      book: { title: "Care Work", note: "Leah Lakshmi Piepzna-Samarasinha reframed care as something we build together, not buy." },
      song: { title: "Lovely Day — Bill Withers", note: "I play it low during sessions; shoulders drop the moment it starts." },
      moment: { title: "A client's first pain-free morning", note: "After months of slow work they texted me a sunrise. I kept the photo on my wall." },
    },
    skills: [
      { name: "Post-op rehab", meta: "Available · by referral" },
      { name: "Chronic pain coaching", meta: "Trade · for movement classes" },
      { name: "Consent-led touch training", meta: "Free · for queer practitioners" },
    ],
    groups: [
    ...
    activity: [
      { icon: FiCalendar, title: "Opening a post-surgery movement class", sub: "Small group, Estrela", to: routes.event },
      { icon: FiFileText, title: "Wrote 'Touch you can trust'", sub: "Magazine guide", to: routes.magazine },
    ],
  },
  fatima: {
    slug: "fatima",
    ...
    hood: "Arroios",
    tags: ["Peer support", "Migrant justice", "Crisis referral", "Arabic & Portuguese"],
    visibility: "network",
    initials: "FM",
    tint: "coral",
    ...
    openTo: ["Interpreters for Arabic and Farsi", "Lawyers who do pro-bono asylum work", "A bigger drop-in space in Arroios"],
    work: [
      { category: "Organising", title: "Welcome Desk — weekly drop-in for new arrivals", year: "2023" },
      { category: "Writing", title: "Know Your Rights pocket guide (4 languages)", year: "2024" },
    ],
    board: [
      { kind: "looking", title: "Volunteer interpreters, evenings", slug: "interpreters-eve" },
      { kind: "offering", title: "Peer-support training for new volunteers", slug: "ps-training" },
    ],
    vouchers: ["jonas", "carla"],
    voucherNames: "Jonas & Carla",
    related: ["catarina-vaz", "jonas", "bilal-kaya"],
    shapings: {
      film: { title: "Capernaum", note: "I watched it alone and cried for a child who could have been any of the kids who come to my desk." },
      book: { title: "The Beekeeper of Aleppo", note: "It put words to the kind of grief people carry in silently from the waiting room." },
      song: { title: "Ya Rayah — Rachid Taha", note: "My father sang it; now it's what plays when the drop-in finally empties out and I tidy up." },
      moment: { title: "First asylum case I saw approved", note: "We hugged in the hallway of SEF and I understood why I do this." },
    },
    skills: [
      { name: "Trauma-informed peer support", meta: "Available · for collectives" },
      { name: "Asylum-process navigation", meta: "Free · for new arrivals" },
      { name: "Arabic ↔ Portuguese interpreting", meta: "Trade · for translation favours" },
    ],
    groups: [
    ...
    activity: [
      { icon: FiCalendar, title: "Hosted the Arroios drop-in", sub: "Tuesday · 14 people", to: routes.event },
      { icon: FiFileText, title: "Updated the Know Your Rights guide", sub: "Added Ukrainian translation", to: routes.magazine },
      { icon: FiMessageCircle, title: "Answered in the support forum", sub: "Thread: housing for trans asylum-seekers", to: routes.forum },
    ],
  },
  "catarina-vaz": {
    slug: "catarina-vaz",
    ...
    initials: "CV",
    tint: "plum",
    photo: "https://images.unsplash.com/photo-1521252659862-eec69941b071?q=80&w=800&auto=format&fit=crop",
    verified: true,
    since: "2021",
    ...
    openTo: ["People who've run co-ops before", "A lawyer for cooperative law", "Anyone facing eviction who wants backup"],
    work: [
      { category: "Organising", title: "Marvila Tenants' Union — co-founder", year: "2021" },
      { category: "Campaign", title: "Stop the Renovação evictions, Graça", year: "2023" },
    ],
    board: [
      { kind: "looking", title: "Co-op members ready to commit", slug: "coop-members" },
    ],
    vouchers: ["fatima", "rui"],
    voucherNames: "Fátima & Rui",
    related: ["fatima", "nuno", "mariana-costa"],
    shapings: {
      film: { title: "Sorry We Missed You", note: "Ken Loach made me furious in exactly the way that keeps me organising." },
      book: { title: "The Death and Life of Great American Cities", note: "Jane Jacobs taught me to defend the messy, lived-in street against the developers." },
      song: { title: "Grândola, Vila Morena — Zeca Afonso", note: "We sang it on a balcony the night we stopped an eviction; it still gives me chills." },
      moment: { title: "The morning forty neighbours showed up uninvited", note: "The bailiffs turned around and I learned what solidarity actually looks like." },
    },
    skills: [
      { name: "Tenant rights & eviction defence", meta: "Free · for tenants in trouble" },
      { name: "Co-op governance & bylaws", meta: "Available · for new co-ops" },
      { name: "Door-knocking & base-building", meta: "Trade · I'll teach, you organise" },
    ],
    groups: [
    ...
    activity: [
      { icon: FiCalendar, title: "Ran a tenants' assembly", sub: "Graça · standing room only", to: routes.event },
      { icon: FiMessageCircle, title: "Posted an eviction alert", sub: "Need bodies Thursday 7am", to: routes.forum },
      { icon: FiEdit3, title: "Wrote up the co-op proposal", sub: "Draft v3 — feedback welcome", to: routes.magazine },
    ],
  },
  jonas: {
    slug: "jonas",
    ...
    initials: "JF",
    tint: "jade",
    photo: "https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?q=80&w=800&auto=format&fit=crop",
    verified: true,
    since: "2020",
    ...
    openTo: ["Volunteers comfortable with late nights", "A nurse or two for the testing nights", "Donations of safer-use supplies"],
    work: [
      { category: "Health", title: "Street outreach — Cais do Sodré", year: "2020" },
      { category: "Programme", title: "PrEP navigation peer line", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Free rapid HIV testing, Fridays", slug: "rapid-test" },
      { kind: "looking", title: "Late-night outreach volunteers", slug: "night-outreach" },
    ],
    vouchers: ["fatima", "beatriz"],
    voucherNames: "Fátima & Beatriz",
    related: ["fatima", "sofia-castano", "daniel-oliveira"],
    shapings: {
      film: { title: "120 BPM", note: "It showed me activism as love and rage in the same breath — that's how the work feels." },
      book: { title: "How to Survive a Plague", note: "David France reminded me that the people who changed everything were ordinary and terrified." },
      song: { title: "Smalltown Boy — Bronski Beat", note: "It plays in my head every time a scared kid finds the testing tent." },
      moment: { title: "Handing someone their first negative result who'd avoided testing for years", note: "He sat down on the curb and just breathed." },
    },
    skills: [
    ...
    groups: [
      { name: "GAT — Grupo de Ativistas em Tratamentos", role: "Outreach worker" },
  ...
  rita: {
    ...
    initials: "RV",
    tint: "plum",
    photo: "https://images.unsplash.com/photo-1499887142886-791eca5918cd?q=80&w=800&auto=format&fit=crop",
    verified: false,
    since: "2023",
    ...
    openTo: ["Writers who want their words illustrated", "A second hand for workshop days", "Trades — prints for almost anything"],
    work: [
      { category: "Comics", title: "Santa Solidão — riso zine, 2-colour", year: "2024" },
      { category: "Teaching", title: "Riso & Bind workshop series, Mouraria", year: "2025" },
    ],
    board: [
      { kind: "offering", title: "Risograph workshop, beginners", slug: "riso-101" },
      { kind: "looking", title: "Co-host for a queer zine fair", slug: "zine-fair" },
    ],
    vouchers: ["sofia-castano", "luisa"],
    voucherNames: "Sofia & Luísa",
    related: ["luisa", "sofia-castano", "catarina-melo"],
    shapings: {
      film: { title: "My Neighbour Totoro", note: "Miyazaki's stillness is the feeling I chase in every panel I draw." },
      book: { title: "Fun Home", note: "Alison Bechdel showed me a comic could hold a whole complicated family and a coming-out at once." },
      song: { title: "Estranha Forma de Vida — Amália Rodrigues", note: "Fado about loving wrongly — it's secretly the soundtrack to my whole comic." },
      moment: { title: "Selling out my first print run at a tiny fair in Anjos", note: "Forty people wanted a piece of my weird brain and I floated home." },
    },
    skills: [
    ...
    activity: [
      { icon: FiEdit3, title: "Posted new comic pages", sub: "Santa Solidão · pages 12–15", to: routes.culture },
      { icon: FiCalendar, title: "Taught a riso workshop", sub: "Mouraria · 8 first-timers", to: routes.event },
      { icon: FiCamera, title: "Shared studio process shots", sub: "Two-colour misregistration magic", to: routes.culture },
    ],
  },
  "sofia-castano": {
    slug: "sofia-castano",
    ...
    initials: "SC",
    tint: "jade",
    photo: "https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?q=80&w=800&auto=format&fit=crop",
    verified: true,
    since: "2022",
    ...
    openTo: ["Venues to document before they close", "A darkroom share", "Subjects who want honest portraits"],
    work: [
      { category: "Photography", title: "Última Pista — nightlife photo essay", year: "2025" },
      { category: "Exhibition", title: "Tender Hours, group show, Marvila", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Portrait sessions, trade or sliding scale", slug: "portraits-trade" },
    ],
    vouchers: ["rita", "jonas"],
    voucherNames: "Rita & Jonas",
    related: ["rita", "luisa", "sara-pinheiro"],
    shapings: {
      film: { title: "Shiva Baby", note: "A whole comedy of queer panic in one room — it taught me how much a single space can hold." },
      book: { title: "On Photography", note: "Sontag made me distrust my own camera in a way that made me a better photographer." },
      song: { title: "Bigmouth Strikes Again — The Smiths", note: "First thing I ever danced to in a queer club; I shoot to find that feeling again." },
      moment: { title: "A drag queen asking me to photograph her without makeup", note: "She trusted me with the in-between and it changed how I work." },
    },
    skills: [
      { name: "Documentary & event photography", meta: "Available · for community events" },
    ...
    activity: [
      { icon: FiCamera, title: "Published a new photo set", sub: "Última Pista · closing night at Trumps", to: routes.culture },
      { icon: FiCalendar, title: "Shot a community fundraiser", sub: "Marvila · donated the prints", to: routes.event },
      { icon: FiMessageCircle, title: "Offered free portraits in the forum", sub: "For folks updating their docs", to: routes.forum },
    ],
  },
  nuno: {
    slug: "nuno",
    ...
    initials: "NA",
    tint: "plum",
    photo: "https://images.unsplash.com/photo-1463453091185-61582044d556?q=80&w=800&auto=format&fit=crop",
    verified: false,
    since: "2023",
    ...
    openTo: ["Nonprofits who need a website that won't break", "A designer to pair with", "Junior devs who want a patient mentor"],
    work: [
      { category: "Tech", title: "Accessible trans-healthcare directory", year: "2025" },
      { category: "Open source", title: "a11y component library for activist sites", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Free websites for queer nonprofits", slug: "free-sites" },
      { kind: "looking", title: "A designer to collaborate with", slug: "design-pair" },
    ],
    vouchers: ["catarina-vaz", "luisa"],
    voucherNames: "Catarina & Luísa",
    related: ["catarina-vaz", "luisa", "daniel-oliveira"],
    shapings: {
      film: { title: "Hackers", note: "Cheesy and beloved — it's the first time I saw a screen as somewhere you could be free." },
      book: { title: "Design Justice", note: "Sasha Costanza-Chock gave me the language for why I build the way I build." },
      song: { title: "Windowlicker — Aphex Twin", note: "Glitchy and tender; it's what's in my headphones at 1am when the code finally compiles." },
      moment: { title: "Watching a blind user navigate something I built, smoothly", note: "I sat there grinning like an idiot — that's the whole point." },
    },
    skills: [
    ...
    activity: [
      { icon: FiFileText, title: "Shipped the healthcare directory", sub: "Now passes WCAG AA", to: routes.magazine },
      { icon: FiMessageCircle, title: "Helped in the tech-help forum", sub: "Thread: making forms screen-reader friendly", to: routes.forum },
      { icon: FiCalendar, title: "Co-ran a beginner code night", sub: "Marvila · 12 learners", to: routes.event },
    ],
  },
  luisa: {
    slug: "luisa",
    ...
    initials: "LG",
    tint: "jade",
    photo: "https://images.unsplash.com/photo-1485893086445-ed75865251e0?q=80&w=800&auto=format&fit=crop",
    verified: true,
    since: "2021",
    ...
    openTo: ["People with old photos, flyers, letters to donate", "Oral-history interviewees", "A grant writer who gets archives"],
    work: [
      { category: "Curation", title: "Antes de Nós — queer ephemera exhibition", year: "2026" },
      { category: "Archive", title: "Arquivo Cor-de-Rosa — founding curator", year: "2021" },
    ],
    board: [
      { kind: "looking", title: "Donations of queer ephemera, any era", slug: "ephemera-donate" },
      { kind: "looking", title: "Volunteers to digitise the archive", slug: "digitise" },
    ],
    vouchers: ["rita", "nuno"],
    voucherNames: "Rita & Nuno",
    related: ["rita", "sofia-castano", "catarina-melo"],
    shapings: {
      film: { title: "The Watermelon Woman", note: "Cheryl Dunye invented an archive because none existed — that's literally my job description." },
      book: { title: "Cruising Utopia", note: "José Muñoz taught me to treat the archive as a place where the future is also kept." },
      song: { title: "It's a Sin — Pet Shop Boys", note: "It belongs to the people whose flyers I file; I play it loud while cataloguing." },
      moment: { title: "An elder handing me a shoebox of photos he'd hidden for forty years", note: "He said, 'Don't let them throw these away,' and I promised I wouldn't." },
    },
    skills: [
    ...
    activity: [
      { icon: FiBookOpen, title: "Opened the ephemera show", sub: "Príncipe Real · packed vernissage", to: routes.culture },
      { icon: FiFileText, title: "Wrote a piece on queer erasure", sub: "Why we keep the flyers", to: routes.magazine },
      { icon: FiCalendar, title: "Hosted an archive reading group", sub: "Estrela · Cruising Utopia", to: routes.readingGroups },
    ],
  },
  "mariana-costa": {
    slug: "mariana-costa",
    ...
    initials: "MC",
    tint: "jade",
    photo: "https://images.unsplash.com/photo-1542596594-649edbc13630?q=80&w=800&auto=format&fit=crop",
    verified: true,
    since: "2023",
    ...
    work: [
      { category: "Investigation", title: "The Eighteen-Month Wait", year: "2025" },
      { category: "Feature", title: "Who Funds the Backlash?", year: "2024" },
    ],
    board: [
      { kind: "looking", title: "Sources inside health administration", slug: "health-sources" },
    ],
    vouchers: ["rui-fernandes", "ines"],
    voucherNames: "Rui & Inês",
    related: ["rui-fernandes", "catarina-melo", "sofia"],
    shapings: {
      film: { title: "The Times of Harvey Milk", note: "I watched it at sixteen and understood that a reporter and an organiser can be telling the same story from two desks." },
      book: { title: "The Journalist and the Murderer", note: "It taught me to distrust my own charm with a source." },
      song: { title: "Quero-te Tanto — Linda Martini", note: "The track I play when a piece finally goes to the editor." },
      moment: { title: "First leaked document", note: "A nurse slid me a memo across a café table in Anjos and my hands shook for an hour." },
    },
    skills: [
    ...
    activity: [
      { icon: FiFileText, title: "Published 'The Eighteen-Month Wait'", sub: "Investigation in the magazine", to: routes.magazine },
      { icon: FiMessageCircle, title: "Hosted a tips clinic", sub: "How to safely talk to a reporter", to: routes.forum },
    ],
  },
  "rui-fernandes": {
    slug: "rui-fernandes",
    ...
    work: [
      ...
      { category: "Pamphlet", title: "Your Documents, Your Rights", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Walk-through: legal gender recognition", slug: "name-change-help" },
      { kind: "looking", title: "Translators for our rights guide", slug: "translators-wanted" },
    ],
    vouchers: ["mariana-costa", "carla"],
    voucherNames: "Mariana & Carla",
    related: ["mariana-costa", "catarina-melo", "andre"],
    shapings: {
      film: { title: "Tangerine", note: "Shot on a phone, full of fury and tenderness — it gave me permission to make rough, honest things." },
      book: { title: "Stone Butch Blues", note: "I read it in one weekend in a Mouraria flat and cried at the union scenes, not the romance." },
      song: { title: "Drone Bomb Me — Anohni", note: "It holds grief and politics in the same breath, which is what I'm always failing to do in essays." },
      moment: { title: "First name-change granted", note: "A friend texted me a photo of their new card and I had to sit down on the kerb." },
    },
    skills: [
    ...
    activity: [
      { icon: FiEdit3, title: "Published 'On Patience and Rage'", sub: "Essay in the magazine", to: routes.magazine },
      { icon: FiCalendar, title: "Ran a documents workshop", sub: "Legal recognition, step by step", to: routes.event },
    ],
  },
  "catarina-melo": {
    slug: "catarina-melo",
    ...
    openTo: ["Volunteer note-takers for hearings", "Lawyers willing to do pro bono"],
    work: [
      { category: "Toolkit", title: "If You Get an Eviction Notice", year: "2025" },
      { category: "Workshop", title: "Reading Your Lease", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Free tenants' rights clinic", slug: "tenant-clinic" },
      { kind: "looking", title: "Spare rooms for emergencies", slug: "emergency-rooms" },
    ],
    vouchers: ["rui-fernandes", "carla"],
    voucherNames: "Rui & Carla",
    related: ["rui-fernandes", "mariana-costa", "beatriz"],
    shapings: {
      film: { title: "Sorry to Bother You", note: "Absurd and furious about who the city is built for — I quote it more than I should." },
      book: { title: "Evicted — Matthew Desmond", note: "It put data under what I already felt at every kitchen table." },
      song: { title: "Vayorken — Capicua", note: "A Porto verse about belonging to a place that keeps trying to price you out." },
      moment: { title: "First hearing we won", note: "An elderly couple kept their flat in Marvila and brought me soup for a month afterwards." },
    },
    skills: [
    ...
    activity: [
      { icon: FiCalendar, title: "Opened a tenants' clinic", sub: "Drop-in legal advice", to: routes.event },
      { icon: FiMessageCircle, title: "Answered housing questions", sub: "Eviction notices thread", to: routes.forum },
    ],
  },
  "sara-pinheiro": {
    slug: "sara-pinheiro",
    ...
    role: "Health & Access",
    hood: "Arroios",
    tags: ["Disability justice", "Healthcare access", "Accessibility audits", "Crip joy"],
    visibility: "open",
    initials: "SP",
    tint: "jade",
    photo: "https://images.unsplash.com/photo-1531123414780-f74242c2b052?q=80&w=800&auto=format&fit=crop",
    verified: false,
    since: "2024",
    ...
    work: [
      { category: "Guide", title: "Can I Get In? A Venue Access Map", year: "2025" },
      { category: "Report", title: "Waiting Rooms Aren't Neutral", year: "2024" },
    ],
    board: [
      { kind: "offering", title: "Accessibility audits for events", slug: "access-audit" },
    ],
    vouchers: ["catarina-melo", "daniel-oliveira"],
    voucherNames: "Catarina & Daniel",
    related: ["catarina-melo", "daniel-oliveira", "beatriz"],
    shapings: {
      film: { title: "Crip Camp", note: "The first time I saw disabled people on screen who were funny, horny and dangerous — not brave." },
      book: { title: "Care Work — Leah Lakshmi Piepzna-Samarasinha", note: "It reframed access as love, not logistics, and I've never recovered." },
      song: { title: "Human — Sevdaliza", note: "A song about bodies and being seen that I play on hard pain days." },
      moment: { title: "First ramp we got built", note: "A café in Arroios put in a ramp after our audit and the owner cried more than I did." },
    },
    skills: [
    ...
    activity: [
      { icon: FiFileText, title: "Published the venue access map", sub: "Honest notes on getting in", to: routes.culture },
      { icon: FiMessageCircle, title: "Started a disability justice thread", sub: "Sharing access wins and fails", to: routes.forum },
    ],
  },
  "bilal-kaya": {
    slug: "bilal-kaya",
    ...
    initials: "BK",
    tint: "jade",
    photo: "https://images.unsplash.com/photo-1508341591423-4347099e1f19?q=80&w=800&auto=format&fit=crop",
    verified: false,
    since: "Jun 2026",
    ...
    work: [
      { category: "Theatre", title: "Sound design for 'Salt Threshold'", year: "2026" },
      { category: "Album", title: "Ferry Crossings — field recordings", year: "2025" },
    ],
    board: [
      { kind: "offering", title: "Soundsystem tuning for parties", slug: "rig-tuning" },
      { kind: "looking", title: "A quiet room to record vocals", slug: "vocal-room" },
    ],
    vouchers: ["ines-fonseca", "tomas"],
    voucherNames: "Inês & Tomás",
    related: ["ines-fonseca", "daniel-oliveira", "tomas"],
    shapings: {
      film: { title: "Berberian Sound Studio", note: "A whole film about a Foley artist losing his mind — it made my obsessive job feel almost glamorous." },
      book: { title: "The Soundscape — R. Murray Schafer", note: "It taught me to listen to a street the way others read a page." },
      song: { title: "Yüce Dağ Başında — Altın Gün", note: "Anatolian psych-folk that sounds like my grandmother's kitchen rewired for a dancefloor." },
      moment: { title: "First room I tuned right", note: "The bass landed clean across a sweaty crowd in Marvila and a stranger hugged me by the desk." },
    },
    skills: [
    ...
    activity: [
      { icon: FiMusic, title: "Joined QueerPulse", sub: "New this week — say hi", to: routes.culture },
      { icon: FiCamera, title: "Shared field recordings", sub: "Ferry crossings at dawn", to: routes.culture },
    ],
  },
  "ines-fonseca": {
    slug: "ines-fonseca",
    ...
    role: "Choreographer",
    hood: "Estrela",
    tags: ["Contemporary dance", "Queer performance", "Improvisation", "Devised work"],
    visibility: "network",
    initials: "IF",
    tint: "coral",
    photo: "https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=800&auto=format&fit=crop",
    verified: false,
    since: "Jun 2026",
    ...
    openTo: ["Dancers for a new devised piece", "Cross-disciplinary collaborators"],
    work: [
      { category: "Performance", title: "Soft Animals", year: "2025" },
      { category: "Residency", title: "Floorwork: a queer practice", year: "2024" },
    ],
    board: [
      { kind: "looking", title: "Movers for an open rehearsal", slug: "open-rehearsal" },
    ],
    vouchers: ["bilal-kaya", "beatriz"],
    voucherNames: "Bilal & Beatriz",
    related: ["bilal-kaya", "tomas", "beatriz"],
    shapings: {
      film: { title: "Pina", note: "Wenders filming Bausch's dancers in the rain rewired what I thought a body could say." },
      book: { title: "The Argonauts — Maggie Nelson", note: "It reads like choreography — bodies, theory and love all moving at once." },
      song: { title: "Fado de Cada Um — Júlio Resende", note: "A piano fado I warm up to; it makes my spine honest." },
      moment: { title: "First solo, empty house", note: "I danced to four people in an Estrela studio and one of them was weeping and that was enough." },
    },
    skills: [
    ...
    activity: [
      { icon: FiCalendar, title: "Joined QueerPulse", sub: "New this week — say hi", to: routes.event },
      { icon: FiCamera, title: "Posted rehearsal footage", sub: "Floorwork from 'Soft Animals'", to: routes.culture },
    ],
  },
  "daniel-oliveira": {
    ...
    initials: "DO",
    tint: "plum",
    photo: "https://images.unsplash.com/photo-1521119989659-a83eee488004?q=80&w=800&auto=format&fit=crop",
    verified: true,
    since: "May 2026",
    ...
    work: [
      ...
      { category: "Guide", title: "Looking After Each Other Till Dawn", year: "2025" },
    ],
    board: [
      { kind: "offering", title: "Peer first-aid training", slug: "first-aid-training" },
      { kind: "looking", title: "Quiet recovery space at parties", slug: "chill-space" },
    ],
    vouchers: ["sara-pinheiro", "bilal-kaya"],
    voucherNames: "Sara & Bilal",
    related: ["sara-pinheiro", "bilal-kaya", "ines-fonseca"],
    shapings: {
      film: { title: "Beats", note: "A rave film that gets why the dancefloor matters and why someone has to keep everyone safe on it." },
      book: { title: "How to Survive a Plague", note: "It showed me that care and activism in a crisis are the same muscle." },
      song: { title: "Downtown — Honey Dijon", note: "The track that means the floor is happy and my night is going well." },
      moment: { title: "First time the naloxone worked", note: "A stranger breathed again under the strobes and I shook for the rest of the set." },
    },
    skills: [
    ...
    activity: [
      { icon: FiCalendar, title: "Joined QueerPulse", sub: "New this week — say hi", to: routes.event },
      { icon: FiMessageCircle, title: "Started a harm-reduction thread", sub: "Naloxone, earplugs, looking out", to: routes.forum },
    ],
  },
  ...
  tiago: {
    ...
    skills: [
      ...
      { name: "API design & development", meta: "Trade · backend & infrastructure" },
    ...
    activity: [
      { icon: FiBookOpen, title: "Published in the Ofélia books", sub: "Four poems · 2024", to: routes.magazine },
      { icon: FiMusic, title: "DJ set as Hot Mess Express", sub: "Queer party · with Camila", to: routes.event },
      { icon: FiCalendar, title: "Organised a community gathering", sub: "Queer + non-monogamy meetup", to: routes.event },
    ],
    shapings: {
      film: {
        title: "Star Wars",
