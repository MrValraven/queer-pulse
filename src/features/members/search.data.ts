...
export const SEARCH_DATA: SearchItem[] = [
  ...
  { t: 'gathering', name: 'Founders & Builders Breakfast', sub: 'Marvila · 2 Jul', href: '/gathering/founders-breakfast', kw: 'founders tech breakfast networking' },
  { t: 'community', name: 'Queer Social Lisbon', sub: 'Social · 340 members · Monthly', href: '/community/queer-social', kw: 'social casual meetup monthly' },
  { t: 'community', name: 'Rainbow Arts Collective', sub: 'Arts · 128 members · Monthly', href: '/community/rainbow-arts', kw: 'arts visual collective studio' },
  { t: 'community', name: 'Trans Mutual Aid Network', sub: 'Support · 89 members · Ongoing', href: '/community/trans-mutual-aid', kw: 'trans support mutual aid peer' },
  { t: 'community', name: 'Queer Runners Lisboa', sub: 'Sports · 214 members · Weekly', href: '/community/queer-runners', kw: 'running sports outdoors weekly' },
  { t: 'community', name: 'Trans & Non-Binary Hub', sub: 'Support · 147 members · Ongoing', href: '/community/trans-hub', kw: 'trans nonbinary healthcare legal peer support' },
  { t: 'community', name: 'Queer Youth Network', sub: 'Youth 18–25 · 93 members · Monthly', href: '/community/queer-youth', kw: 'youth young career peer mentorship' },
  { t: 'community', name: 'Queer & of Colour', sub: 'Activism · 76 members · Monthly', href: '/community/queer-poc', kw: 'poc colour intersectional race activism' },
