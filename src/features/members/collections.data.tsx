...
export const RECENT_SAVES: RecentSave[] = [
  { id: 'r1', kind: 'THE', kindVariant: 'therapist', title: 'Dr. Inês Pereira · therapist', saved: 'Saved 12 minutes ago' },
  { id: 'r2', kind: 'ART', kindVariant: 'article', title: '"Five things I learned navigating Lisbon\'s trans health system"', saved: 'Saved yesterday' },
  { id: 'r3', kind: 'BIZ', kindVariant: 'business', title: 'Café Beirão · pastelaria + community room', saved: 'Saved 3 days ago' },
]
