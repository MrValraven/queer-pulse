...
export const PUBLIC_MEMBER = {
  ...
  pronouns: "he/him",
  tagline:
    "Designer, writer, and the back-room bartender at Café Beirão one night a month.",
  bio: (
    <>
      I write occasionally for QueerPulse Magazine and host monthly portfolio
      nights at Café Beirão. <em>Mostly here to host other people's events.</em>{" "}
      If we've met at a gathering, you can find me on Bluesky too.
    </>
  ),
  location: "Alfama",
  ...
  vouchedBy: "4 members",
  ctaNote:
    "Tomás's full profile, posts, and direct-message access open up once you're a member.",
};
