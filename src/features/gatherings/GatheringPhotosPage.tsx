...
type Tint = "tintA" | "tintB" | "tintC" | "tintD";
type Span = "" | "wide" | "tall";
interface Pic {
  label: string;
  tint: Tint;
      ...
      <div className={styles.controls}>
        <div className={styles.controlsInner}>
          ...
          <div className={styles.right}>
            ...
            <button type="button" className={styles.action} onClick={() => showToast("Slideshow opening", "info")}>
              ▶ Slideshow
            </button>
          </div>
        </div>
      ...
      <div className={styles.mosaic}>
        {PICS.map((p, i) => (
          <button
            ...
            onClick={() => showToast("Opening photo…", "info")}
          >
            {p.tag && (
