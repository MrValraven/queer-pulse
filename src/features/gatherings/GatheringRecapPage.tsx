          ...
          <div className={styles.layout}>
            <div>
              ...
              <p className={styles.writeup}>
                We took over the terrace at A Cevicheria on a warm Saturday
                morning, and for three hours it became ours — a little corner of
                Príncipe Real that felt genuinely, unmistakably queer.
                Thirty-eight people came. Some knew each other; most didn't, at
                least not yet. By noon, you wouldn't have known the difference.
              </p>
              <p className={styles.writeup}>
                There was a long table of food that kept getting replenished.
                There were conversations that started with "how do you know the
                host?" and turned into something else entirely — plans,
                collaborations, phone numbers exchanged. Two people who'd been
                connected on QueerPulse for months finally met in person.
              </p>
              <p className={styles.writeup}>
                These gatherings don't have agendas. They're just time — held,
                deliberately, for people like us to be in a room together. This
                one was a good one. We'll do it again in July.
              </p>
                  ...
                  {loading
                    ...
                    : ATTENDEES.map((person, i) => (
                        ...
                        >
                          ...
                          <div className={styles.whoPronouns}>
                            {person.pronouns}
                          </div>
                        </FadeIn>
                      ))}
