...
export const RECAP_WRITEUP: string[] = [
  "We took over the terrace at A Cevicheria on a warm Sunday morning, and for three hours it became ours: a little corner of Príncipe Real that felt genuinely, unmistakably queer. Thirty-eight people came. Some knew each other; most didn't, at least not yet. By noon, you wouldn't have known the difference.",
