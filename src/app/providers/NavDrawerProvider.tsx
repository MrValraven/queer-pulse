 ...
 * call `closeDrawerForNavigation` to say "already consumed, do not pop".
 *
...
export function NavDrawerProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (!drawerOpen || historyEntryPushedRef.current) return;
  ...
  const value = useMemo(
    () => ({ drawerOpen, openDrawer, closeDrawer, closeDrawerForNavigation }),
    [drawerOpen, openDrawer, closeDrawer, closeDrawerForNavigation],
  );
